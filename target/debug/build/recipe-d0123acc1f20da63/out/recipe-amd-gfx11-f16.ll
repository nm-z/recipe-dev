...
%method.store = call i1 @contraction_matrix_store_lane(i1 %lane.store, i32 %lid)
...
load.ready:
call void @llvm.amdgcn.s.barrier()
call void @contraction_matrix_accumulate(ptr addrspace(5) %sums, i1 %lane.active, i1 %method.store, i32 %lid, i32 %lane.k, i32 %k.lanes, i32 %output.lane, i32 %lanes, i32 %output.m.base, i32 %output.n.base, i32 %m.count, i32 %n.count, i32 %k.count, i32 %tile.m, i32 %tile.n, i32 %tile.k)
...
store.test: %store.output.m.raw = call i32 @contraction_matrix_output_m(i32 %lid, i32 %store.register, i32 %m.lanes) %store.output.n.raw = call i32 @contraction_matrix_output_n(i32 %lid, i32 %store.register, i32 %m.lanes) %store.register.valid = call i1 @contraction_output_register_valid(i32 %store.register)
...
%gradient.method.store = call i1 @contraction_matrix_store_lane(i1 %gradient.lane.store, i32 %lid)
...
%previous.method.store = call i1 @contraction_matrix_store_lane(i1 %previous.lane.store, i32 %lid)
...
previous.store.test: %previous.store.output.m.raw = call i32 @contraction_matrix_output_m(i32 %lid, i32 %previous.store.register, i32 %previous.m.lanes) %previous.store.output.n.raw = call i32 @contraction_matrix_output_n(i32 %lid, i32 %previous.store.register, i32 %previous.m.lanes) %previous.store.register.valid = call i1 @contraction_output_register_valid(i32 %previous.store.register)
