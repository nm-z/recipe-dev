...
declare void @llvm.trap() @contraction_tile_int8 = internal thread_local global [65536 x i8] zeroinitializer, align 16
...
%index = add i32 %row.base, %local %ptr = getelementptr inbounds i8, ptr %input, i32 %index
%value = load i8, ptr %ptr, align 1 ret i8 %value }
define internal i8 @contraction_delta(ptr %delta, ptr %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds i8, ptr %delta, i32 %index
%delta.value = load i8, ptr %delta.ptr, align 1
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds i8, ptr %output, i32 %index
%output.value = load i8, ptr %output.ptr, align 1
...
define internal <16 x i8> @contraction_delta_vector16(ptr %delta, ptr %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds i8, ptr %delta, i32 %index
%delta.value = load <16 x i8>, ptr %delta.ptr, align 1
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds i8, ptr %output, i32 %index
%output.value = load <16 x i8>, ptr %output.ptr, align 1
...
%target.ptr = getelementptr inbounds i8, ptr %target, i32 %target.index
%source.first.index = add i32 %source.offset, %parameter
%source.first.ptr = getelementptr inbounds i8, ptr %source, i32 %source.first.index
%source.first = load i8, ptr %source.first.ptr, align 1
br label %row.loop
row.loop:
...
%source.ptr = getelementptr inbounds i8, ptr %source, i32 %source.index
%source.value = load i8, ptr %source.ptr, align 1
%sum.next = call i8 @recipe.add(i8 %sum, i8 %source.value)
%row.next = add i32 %row, 1
br label %row.loop
store:
store i8 %sum, ptr %target.ptr, align 1
...
%ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %index
...
%ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_M x i8>, ptr %ptr, align 1
...
%index = add i32 %base, %local
%ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_N x i8>, ptr %ptr, align 1
...
%target = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %index
store i8 %value, ptr %target, align 1
...
%publish.target = getelementptr float, ptr @contraction_tile_int8, i32 %publish.target.index
...
%fold.source = getelementptr float, ptr @contraction_tile_int8, i32 %fold.source.index
...
%ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %index
%raw = load i8, ptr %ptr, align 1 %value = call float @recipe.decode(i8 %raw) %sum.next = call float @recipe.state.add(float %sum, float %value)
...
%bias.ptr = getelementptr inbounds i8, ptr %destination, i32 %bias.index
%bias = call i8 @recipe.encode(float %sum) store i8 %bias, ptr %bias.ptr, align 1 br label %channel.done
channel.done:
...
%matrix.a.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.a.index
%matrix.a.loaded = load <16 x i8>, ptr %matrix.a.ptr, align 16
...
%matrix.b.first.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.b.first.index
%matrix.b.first.loaded = load <16 x i8>, ptr %matrix.b.first.ptr, align 16
...
%matrix.b.second.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.b.second.index
%matrix.b.second.loaded = load <16 x i8>, ptr %matrix.b.second.ptr, align 16
...
%matrix.b.third.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.b.third.index
%matrix.b.third.loaded = load <16 x i8>, ptr %matrix.b.third.ptr, align 16
...
%matrix.b.fourth.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.b.fourth.index
%matrix.b.fourth.loaded = load <16 x i8>, ptr %matrix.b.fourth.ptr, align 16
...
%a.vector.source = getelementptr inbounds i8, ptr %input, i32 %a.vector.index
%a.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr %a.vector.source, align 1
...
load.b.vector:
%b.vector.source = getelementptr inbounds i8, ptr %weights, i32 %b.index
%b.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr %b.vector.source, align 1
...
br label %load.advance
load.b.scalar:
%b.ptr = getelementptr inbounds i8, ptr %weights, i32 %b.index
%b.value = load i8, ptr %b.ptr, align 1
br label %load.store
load.store: %load.value = phi i8 [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %load.tile.index store i8 %load.value, ptr %load.tile.ptr, align 1
br label %load.advance
load.advance:
...
%input.ptr = getelementptr inbounds i8, ptr %input, i32 %index
%value = load i8, ptr %input.ptr, align 1 %greater = call i1 @recipe.ogt(i8 %value, i8 %maximum)
...
%output.ptr = getelementptr inbounds i8, ptr %output, i32 %p
%context.ptr = getelementptr inbounds i64, ptr %context, i32 %p
%maximum.index.wide = zext i32 %maximum.index to i64
store i8 %maximum, ptr %output.ptr, align 1
store i64 %maximum.index.wide, ptr %context.ptr, align 1 ret void }
...
%left.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %left.index
%left.value = load i8, ptr %left.ptr, align 1
%right.row = mul i32 %right, %width
%right.local = add i32 %right.row, %channel
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %right.index
%right.value = load i8, ptr %right.ptr, align 1
...
%delta.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %delta.index
...
%output.ptr = getelementptr inbounds i8, ptr %output, i32 %output.index
%output.value = load i8, ptr %output.ptr, align 1
...
%product.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %product.index
store i8 %sum, ptr %product.ptr, align 1
...
%maximum.ptr = getelementptr inbounds i8, ptr %context, i32 %statistics.index
%maximum = load i8, ptr %maximum.ptr, align 1
%denominator.index = add i32 %statistics.denominator.base, %statistics.index
%denominator.ptr = getelementptr inbounds i8, ptr %context, i32 %denominator.index
%denominator = load i8, ptr %denominator.ptr, align 1
...
%product.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %product.index
%product = load i8, ptr %product.ptr, align 1
...
%probability.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %probability.index
store i8 %probability.value, ptr %probability.ptr, align 1
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %derivative.index
store i8 %derivative.value, ptr %derivative.ptr, align 1
...
%query.input.ptr = getelementptr inbounds i8, ptr %input, i32 %query.input.index
%query.value = load i8, ptr %query.input.ptr, align 1
%query.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %query.p
store i8 %query.value, ptr %query.shared.ptr, align 1
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %accumulator.index
store i8 0, ptr %accumulator.ptr, align 1
...
%maximum.ptr.init = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %maximum.index.init
store i8 128, ptr %maximum.ptr.init, align 1
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %denominator.index.init
store i8 0, ptr %denominator.ptr.init, align 1
...
%key.input.ptr = getelementptr inbounds i8, ptr %input, i32 %key.input.index
%key.value = load i8, ptr %key.input.ptr, align 1
%key.shared.index = add i32 %key.base.shared, %key.p
%key.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %key.shared.index
store i8 %key.value, ptr %key.shared.ptr, align 1
%value.plane = mul i32 %from, 2
%value.row = add i32 %row.base, %value.plane
%value.input.index = add i32 %value.row, %key.input.local
%value.input.ptr = getelementptr inbounds i8, ptr %input, i32 %value.input.index
%value.value = load i8, ptr %value.input.ptr, align 1
%value.shared.index = add i32 %value.base.shared, %key.p
%value.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %value.shared.index
store i8 %value.value, ptr %value.shared.ptr, align 1
...
%score.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %score.shared.index
store i8 %score.value, ptr %score.shared.ptr, align 1
...
%maximum.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %maximum.index
%maximum.old = load i8, ptr %maximum.ptr, align 1
...
%maximum.score.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %maximum.score.index
%maximum.score = load i8, ptr %maximum.score.ptr, align 1
...
%denominator.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %denominator.index
%denominator.old = load i8, ptr %denominator.ptr, align 1
...
%probability.score.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %probability.score.index
%probability.score = load i8, ptr %probability.score.ptr, align 1
...
br label %probability.loop
softmax.store:
store i8 %maximum.value, ptr %maximum.ptr, align 1
store i8 %denominator.value, ptr %denominator.ptr, align 1
%rescale.index = add i32 %rescale.base.shared, %softmax.query
%rescale.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %rescale.index
store i8 %old.rescale, ptr %rescale.ptr, align 1
...
%accumulate.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %accumulate.index
%accumulate.old = load i8, ptr %accumulate.ptr, align 1
%accumulate.rescale.index = add i32 %rescale.base.shared, %accumulate.query
%accumulate.rescale.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %accumulate.rescale.index
%accumulate.rescale = load i8, ptr %accumulate.rescale.ptr, align 1
...
%accumulate.probability.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %accumulate.probability.index
%accumulate.probability = load i8, ptr %accumulate.probability.ptr, align 1
...
%accumulate.value.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %accumulate.value.index
%accumulate.v = load i8, ptr %accumulate.value.ptr, align 1
...
br label %accumulate.key.loop
accumulate.store:
store i8 %accumulate.value, ptr %accumulate.ptr, align 1
...
%output.accumulator.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %output.accumulator.index
%output.accumulator = load i8, ptr %output.accumulator.ptr, align 1
%output.denominator.index = add i32 %denominator.base.shared, %output.query.local
%output.denominator.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %output.denominator.index
%output.denominator = load i8, ptr %output.denominator.ptr, align 1
...
%output.maximum.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %output.maximum.index
%output.maximum = load i8, ptr %output.maximum.ptr, align 1
...
%output.statistics.maximum.ptr = getelementptr inbounds i8, ptr %context, i32 %output.statistics.index
store i8 %output.maximum, ptr %output.statistics.maximum.ptr, align 1
%output.statistics.denominator.index = add i32 %statistics.plane, %output.statistics.index
%output.statistics.denominator.ptr = getelementptr inbounds i8, ptr %context, i32 %output.statistics.denominator.index
store i8 %output.denominator, ptr %output.statistics.denominator.ptr, align 1
...
%output.ptr = getelementptr inbounds i8, ptr %output, i32 %output.index
store i8 %attention, ptr %output.ptr, align 1
...
%stage.vector.ptr = getelementptr inbounds i8, ptr %input, i32 %stage.vector.index
%stage.vector.value = load <16 x i8>, ptr %stage.vector.ptr, align 1
...
%stage.scalar.ptr = getelementptr inbounds i8, ptr %input, i32 %stage.scalar.index
%stage.scalar.value = load i8, ptr %stage.scalar.ptr, align 1
...
%stage.scalar.ptr.shared = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %stage.scalar.index.shared
store i8 %stage.scalar.value, ptr %stage.scalar.ptr.shared, align 1
...
%matrix.q.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.q.index
%matrix.q.fragment = load <16 x i8>, ptr %matrix.q.ptr, align 2
...
%matrix.k.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.k.index
%matrix.k.fragment = load <16 x i8>, ptr %matrix.k.ptr, align 2
...
%matrix.p.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.p.index
store i8 %matrix.score, ptr %matrix.p.ptr, align 1
...
%maximum.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %maximum.index
%maximum.score = load i8, ptr %maximum.ptr, align 1
...
%probability.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %probability.index
%probability.score = load i8, ptr %probability.ptr, align 1
...
%normalize.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %normalize.index
%normalize.value = load i8, ptr %normalize.ptr, align 1
%normalized = call i8 @recipe.div(i8 %normalize.value, i8 %denominator)
store i8 %normalized, ptr %normalize.ptr, align 1
...
%maximum.context.ptr = getelementptr inbounds i8, ptr %context, i32 %statistics.index
store i8 %maximum, ptr %maximum.context.ptr, align 1
%denominator.index = add i32 %statistics.rows, %statistics.index
%denominator.ptr = getelementptr inbounds i8, ptr %context, i32 %denominator.index
store i8 %denominator, ptr %denominator.ptr, align 1
%softmax.query.next = add i32 %softmax.query, %block
br label %attention.forward.matrix.softmax.loop
attention.forward.matrix.softmax.done:

call void @attention_matrix_product(ptr %output, i32 3, i32 %p.base, i32 %v.base, i32 %output.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
...
%left.index = add i32 %left.base, %left.local
%left.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %left.index
%left.loaded = load i8, ptr %left.ptr, align 1
%right.row = mul i32 %term.safe, %head.width
%right.local = add i32 %right.row, %n.safe
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %right.index
%right.loaded = load i8, ptr %right.ptr, align 1
...
%output.index = add i32 %output.row, %output.local
%output.ptr = getelementptr inbounds i8, ptr %previous, i32 %output.index
store i8 %output.value, ptr %output.ptr, align 1
...
%stage.vector.input.ptr = getelementptr inbounds i8, ptr %input, i32 %stage.vector.input.index
%stage.vector.input.value = load <16 x i8>, ptr %stage.vector.input.ptr, align 1
...
%stage.vector.delta.ptr = getelementptr inbounds i8, ptr %delta, i32 %stage.vector.delta.index
%stage.vector.delta.value = load <16 x i8>, ptr %stage.vector.delta.ptr, align 1
br label %attention.matrix.stage.vector.store
...
%stage.scalar.input.ptr = getelementptr inbounds i8, ptr %input, i32 %stage.scalar.input.index
%stage.scalar.input.value = load i8, ptr %stage.scalar.input.ptr, align 1
...
%stage.scalar.delta.ptr = getelementptr inbounds i8, ptr %delta, i32 %stage.scalar.delta.index
%stage.scalar.delta.value = load i8, ptr %stage.scalar.delta.ptr, align 1
br label %attention.matrix.stage.scalar.store
...
%d.do.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %d.do.index
%d.do = load i8, ptr %d.do.ptr, align 1
...
%d.output.ptr = getelementptr inbounds i8, ptr %output, i32 %d.output.index
%d.output = load i8, ptr %d.output.ptr, align 1
...
%d.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %d.index
store i8 %d.sum, ptr %d.ptr, align 1
...
%matrix.do.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x i8>, ptr %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.v.index
%matrix.v.fragment = load <16 x i8>, ptr %matrix.v.ptr, align 2
...
%matrix.maximum.ptr = getelementptr inbounds i8, ptr %context, i32 %matrix.statistics.index
%matrix.maximum = load i8, ptr %matrix.maximum.ptr, align 1
%matrix.denominator.index = add i32 %statistics.rows, %matrix.statistics.index
%matrix.denominator.ptr = getelementptr inbounds i8, ptr %context, i32 %matrix.denominator.index
%matrix.denominator = load i8, ptr %matrix.denominator.ptr, align 1
...
%matrix.d.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.d.index
%matrix.d = load i8, ptr %matrix.d.ptr, align 1
...
%matrix.p.index = add i32 %p.base, %matrix.pair.local
%matrix.p.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.p.index
store i8 %matrix.probability, ptr %matrix.p.ptr, align 1
%matrix.ds.index = add i32 %ds.base, %matrix.pair.local
%matrix.ds.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %matrix.ds.index
store i8 %matrix.derivative, ptr %matrix.ds.ptr, align 1
...
call void @attention_matrix_product(ptr %previous, i32 0, i32 %ds.base, i32 %k.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr %previous, i32 1, i32 %ds.base, i32 %q.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr %previous, i32 2, i32 %p.base, i32 %do.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
...
%dq.input.ptr = getelementptr inbounds i8, ptr %input, i32 %dq.input.index
%dq.query.value = load i8, ptr %dq.input.ptr, align 1
%dq.query.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.query.p
store i8 %dq.query.value, ptr %dq.query.shared.ptr, align 1
%dq.delta.index = add i32 %dq.output.row, %dq.local
%dq.delta.ptr = getelementptr inbounds i8, ptr %delta, i32 %dq.delta.index
%dq.delta.value = load i8, ptr %dq.delta.ptr, align 1
%dq.delta.shared.index = add i32 %dq.delta.base.shared, %dq.query.p
%dq.delta.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.delta.shared.index
store i8 %dq.delta.value, ptr %dq.delta.shared.ptr, align 1
%dq.gradient.shared.index = add i32 %dq.gradient.base.shared, %dq.query.p
%dq.gradient.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.gradient.shared.index
store i8 0, ptr %dq.gradient.shared.ptr, align 1
...
%dq.key.input.ptr = getelementptr inbounds i8, ptr %input, i32 %dq.key.input.index
%dq.key.value = load i8, ptr %dq.key.input.ptr, align 1
%dq.key.shared.index = add i32 %dq.key.base.shared, %dq.key.p
%dq.key.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.key.shared.index
store i8 %dq.key.value, ptr %dq.key.shared.ptr, align 1
...
%dq.value.input.ptr = getelementptr inbounds i8, ptr %input, i32 %dq.value.input.index
%dq.value.value = load i8, ptr %dq.value.input.ptr, align 1
%dq.value.shared.index = add i32 %dq.value.base.shared, %dq.key.p
%dq.value.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.value.shared.index
store i8 %dq.value.value, ptr %dq.value.shared.ptr, align 1
...
%dq.accumulate.gradient.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.accumulate.gradient.index
%dq.accumulate.initial = load i8, ptr %dq.accumulate.gradient.ptr, align 1
...
%dq.accumulate.pair.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.accumulate.pair.index
%dq.accumulate.ds = load i8, ptr %dq.accumulate.pair.ptr, align 1
...
%dq.accumulate.key.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.accumulate.key.index
%dq.accumulate.key.value = load i8, ptr %dq.accumulate.key.ptr, align 1
...
br label %dq.accumulate.key.loop
dq.accumulate.store:
store i8 %dq.accumulate.value, ptr %dq.accumulate.gradient.ptr, align 1
...
%dq.store.ptr = getelementptr inbounds i8, ptr %previous, i32 %dq.store.index
%dq.store.shared.index = add i32 %dq.gradient.base.shared, %dq.store.p
%dq.store.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dq.store.shared.index
%dq.store.value = load i8, ptr %dq.store.shared.ptr, align 1
store i8 %dq.store.value, ptr %dq.store.ptr, align 1
...
%dkv.key.input.ptr = getelementptr inbounds i8, ptr %input, i32 %dkv.key.input.index
%dkv.key.value = load i8, ptr %dkv.key.input.ptr, align 1
%dkv.key.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.key.p
store i8 %dkv.key.value, ptr %dkv.key.shared.ptr, align 1
...
%dkv.value.input.ptr = getelementptr inbounds i8, ptr %input, i32 %dkv.value.input.index
%dkv.value.value = load i8, ptr %dkv.value.input.ptr, align 1
%dkv.value.shared.index = add i32 %dkv.value.base.shared, %dkv.key.p
%dkv.value.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.value.shared.index
store i8 %dkv.value.value, ptr %dkv.value.shared.ptr, align 1
%dkv.key.gradient.index = add i32 %dkv.key.gradient.base.shared, %dkv.key.p
%dkv.key.gradient.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.key.gradient.index
store i8 0, ptr %dkv.key.gradient.ptr, align 1
%dkv.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.key.p
%dkv.value.gradient.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.value.gradient.index
store i8 0, ptr %dkv.value.gradient.ptr, align 1
...
%dkv.query.input.ptr = getelementptr inbounds i8, ptr %input, i32 %dkv.query.input.index
%dkv.query.value = load i8, ptr %dkv.query.input.ptr, align 1
%dkv.query.shared.index = add i32 %dkv.query.base.shared, %dkv.query.p
%dkv.query.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.query.shared.index
store i8 %dkv.query.value, ptr %dkv.query.shared.ptr, align 1
%dkv.delta.input.index = add i32 %dkv.output.row, %dkv.query.input.local
%dkv.delta.input.ptr = getelementptr inbounds i8, ptr %delta, i32 %dkv.delta.input.index
%dkv.delta.value = load i8, ptr %dkv.delta.input.ptr, align 1
%dkv.delta.shared.index = add i32 %dkv.delta.base.shared, %dkv.query.p
%dkv.delta.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.delta.shared.index
store i8 %dkv.delta.value, ptr %dkv.delta.shared.ptr, align 1
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.accumulate.key.gradient.index
%dkv.accumulate.key.initial = load i8, ptr %dkv.accumulate.key.gradient.ptr, align 1
%dkv.accumulate.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.accumulate.p
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.accumulate.value.gradient.index
%dkv.accumulate.value.initial = load i8, ptr %dkv.accumulate.value.gradient.ptr, align 1
...
%dkv.accumulate.probability.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.accumulate.probability.index
%dkv.accumulate.probability = load i8, ptr %dkv.accumulate.probability.ptr, align 1
%dkv.accumulate.derivative.index = add i32 %dkv.derivative.base.shared, %dkv.accumulate.pair.local
%dkv.accumulate.derivative.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.accumulate.derivative.index
%dkv.accumulate.derivative = load i8, ptr %dkv.accumulate.derivative.ptr, align 1
...
%dkv.accumulate.query.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.accumulate.query.index
%dkv.accumulate.query.value = load i8, ptr %dkv.accumulate.query.ptr, align 1
%dkv.accumulate.delta.index = add i32 %dkv.delta.base.shared, %dkv.accumulate.query.local
%dkv.accumulate.delta.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.accumulate.delta.index
%dkv.accumulate.delta = load i8, ptr %dkv.accumulate.delta.ptr, align 1
...
store i8 %dkv.accumulate.key.value, ptr %dkv.accumulate.key.gradient.ptr, align 1
store i8 %dkv.accumulate.value.value, ptr %dkv.accumulate.value.gradient.ptr, align 1
...
%dkv.store.key.ptr = getelementptr inbounds i8, ptr %previous, i32 %dkv.store.key.index
%dkv.store.key.shared.index = add i32 %dkv.key.gradient.base.shared, %dkv.store.p
%dkv.store.key.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.store.key.shared.index
%dkv.store.key.value = load i8, ptr %dkv.store.key.shared.ptr, align 1
store i8 %dkv.store.key.value, ptr %dkv.store.key.ptr, align 1
...
%dkv.store.value.ptr = getelementptr inbounds i8, ptr %previous, i32 %dkv.store.value.index
%dkv.store.value.shared.index = add i32 %dkv.value.gradient.base.shared, %dkv.store.p
%dkv.store.value.shared.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %dkv.store.value.shared.index
%dkv.store.value.value = load i8, ptr %dkv.store.value.shared.ptr, align 1
store i8 %dkv.store.value.value, ptr %dkv.store.value.ptr, align 1
...
%precompute.weights = getelementptr inbounds i8, ptr %weights, i32 %precompute.weight.offset
%precompute.context.offset = mul i32 %precompute.gate, %gate.batch
%precompute.context = getelementptr inbounds i8, ptr %context, i32 %precompute.context.offset
...
%input.ptr = getelementptr inbounds i8, ptr %context, i32 %input.index
%input.sum = load i8, ptr %input.ptr, align 1 br label %state.sum.loop state.sum.loop:
...
%previous.ptr = getelementptr inbounds i8, ptr %output, i32 %previous.index
%previous.loaded = load i8, ptr %previous.ptr, align 1
...
%reset.ptr = getelementptr inbounds i8, ptr %context, i32 %reset.base
%reset = load i8, ptr %reset.ptr, align 1 %reset.state = call i8 @recipe.mul(i8 %reset, i8 %previous)
...
%state.weight.ptr = getelementptr inbounds i8, ptr %weights, i32 %state.weight.index
%state.weight = load i8, ptr %state.weight.ptr, align 1
...
%bias.ptr = getelementptr inbounds i8, ptr %weights, i32 %bias.index
%bias = load i8, ptr %bias.ptr, align 1 %linear = call i8 @recipe.add(i8 %state.sum, i8 %bias)
...
%gate.ptr = getelementptr inbounds i8, ptr %context, i32 %gate.index
store i8 %gate.value, ptr %gate.ptr, align 1 %hidden.next = add nuw i32 %hidden, 1
...
%output.index = add i32 %output.row.base, %output.local
%gate0.ptr = getelementptr inbounds i8, ptr %context, i32 %output.index
%gate0 = load i8, ptr %gate0.ptr, align 1
...
%gate1.ptr = getelementptr inbounds i8, ptr %context, i32 %gate1.index
%gate1 = load i8, ptr %gate1.ptr, align 1 %gate2.base = mul i32 %gate.batch, 2
...
%gate2.ptr = getelementptr inbounds i8, ptr %context, i32 %gate2.index
%gate2 = load i8, ptr %gate2.ptr, align 1 %gate3.base = mul i32 %gate.batch, 3
%gate3.raw = add i32 %gate3.base, %output.index %gate3.index = select i1 %is.lstm, i32 %gate3.raw, i32 %output.index
%gate3.ptr = getelementptr inbounds i8, ptr %context, i32 %gate3.index
%gate3 = load i8, ptr %gate3.ptr, align 1 %output.previous.time = sub i32 %time, 1
...
%output.previous.ptr = getelementptr inbounds i8, ptr %output, i32 %output.previous.index
%output.previous.loaded = load i8, ptr %output.previous.ptr, align 1
...
%cell.previous.ptr = getelementptr inbounds i8, ptr %context, i32 %cell.previous.index
%cell.previous.loaded = load i8, ptr %cell.previous.ptr, align 1
...
%cell.ptr = getelementptr inbounds i8, ptr %context, i32 %cell.index
store i8 %cell, ptr %cell.ptr, align 1 %cell.tanh = call i8 @recipe.tanh(i8 %cell)
...
%output.ptr = getelementptr inbounds i8, ptr %output, i32 %output.index
store i8 %output.value, ptr %output.ptr, align 1 %output.next = add nuw i32 %output.hidden, 1
...
%gradient.scratch = getelementptr inbounds i8, ptr %gradient, i32 RECIPE_GRADIENT_SCRATCH_BASE
...
%gradient.a.vector.source = getelementptr inbounds i8, ptr %input, i32 %gradient.a.vector.index
%gradient.a.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr %gradient.a.vector.source, align 1
...
%gradient.a.value = call i8 @contraction_input( ptr %input, i32 %gradient.a.row.base, i32 %gradient.a.position, i32 %gradient.a.term, i32 %span, i32 %in.length, i1 %is.conv )
...
%gradient.b.vector.value = call <RECIPE_FRAGMENT_K x i8> @contraction_delta_vector16(ptr %delta, ptr %output, i32 %gradient.b.index, i1 %relu)
...
%gradient.b.value = call i8 @contraction_delta(ptr %delta, ptr %output, i32 %gradient.b.index, i1 %relu)
br label %gradient.load.store
...
%gradient.load.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %gradient.load.index store i8 %gradient.load.value, ptr %gradient.load.ptr, align 1
br label %gradient.load.advance
...
%gradient.store.ptr = getelementptr inbounds i8, ptr %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load float, ptr %gradient.store.sum.ptr, align 4 %gradient.store.sum = call i8 @recipe.encode(float %gradient.store.sum.wide) store i8 %gradient.store.sum, ptr %gradient.store.ptr, align 1
...
%previous.a.vector.delta = getelementptr inbounds i8, ptr %delta, i32 %previous.a.index
%previous.a.vector.output = getelementptr inbounds i8, ptr %output, i32 %previous.a.index
%previous.a.vector.delta.value = load <RECIPE_FRAGMENT_K x i8>, ptr %previous.a.vector.delta, align 1
%previous.a.vector.output.value = load <RECIPE_FRAGMENT_K x i8>, ptr %previous.a.vector.output, align 1
...
%previous.a.raw = call i8 @contraction_delta(ptr %delta, ptr %output, i32 %previous.a.index, i1 %relu)
...
%previous.b.vector.source = getelementptr inbounds i8, ptr %weights, i32 %previous.b.index
%previous.b.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr %previous.b.vector.source, align 1
...
%previous.b.ptr = getelementptr inbounds i8, ptr %weights, i32 %previous.b.index
%previous.b.value = load i8, ptr %previous.b.ptr, align 1
br label %previous.load.store
...
%previous.load.ptr = getelementptr [0 x i8], ptr @contraction_tile_int8, i32 0, i32 %previous.load.index store i8 %previous.load.value, ptr %previous.load.ptr, align 1
br label %previous.load.advance
...
%clear.ptr = getelementptr inbounds i8, ptr %context, i32 %clear.index
store i8 0, ptr %clear.ptr, align 1 %clear.next = add nuw i32 %clear.p, 1
...
%clear.dh.ptr = getelementptr inbounds i8, ptr %context, i32 %clear.dh.index
%clear.dc.ptr = getelementptr inbounds i8, ptr %context, i32 %clear.dc.index
store i8 0, ptr %clear.dh.ptr, align 1 store i8 0, ptr %clear.dc.ptr, align 1
...
%rnn.future.ptr = getelementptr inbounds i8, ptr %context, i32 %rnn.future.index
%rnn.gate.ptr = getelementptr inbounds i8, ptr %context, i32 %rnn.index
%rnn.dy = load i8, ptr %rnn.dy.ptr, align 1
%rnn.future = load i8, ptr %rnn.future.ptr, align 1
%rnn.gate = load i8, ptr %rnn.gate.ptr, align 1 %rnn.dh = call i8 @recipe.add(i8 %rnn.dy, i8 %rnn.future)
...
%rnn.delta.ptr = getelementptr inbounds i8, ptr %context, i32 %rnn.delta.index
store i8 %rnn.delta, ptr %rnn.delta.ptr, align 1 %rnn.next = add i32 %rnn.hidden, 1
...
%gru.dy.ptr = getelementptr inbounds i8, ptr %delta, i32 %gru.index
%gru.future.index = add i32 %dh.start, %gru.hidden
%gru.future.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.future.index
%gru.previous.ptr = getelementptr inbounds i8, ptr %output, i32 %gru.previous.index
%gru.z.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.index
%gru.n.index = add i32 %gru.index, %gate2.batch
%gru.n.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.n.index
%gru.dy = load i8, ptr %gru.dy.ptr, align 1
%gru.future = load i8, ptr %gru.future.ptr, align 1
%gru.previous.loaded = load i8, ptr %gru.previous.ptr, align 1
%gru.previous = select i1 %previous.exists, i8 %gru.previous.loaded, i8 0
%gru.z = load i8, ptr %gru.z.ptr, align 1
%gru.n = load i8, ptr %gru.n.ptr, align 1 %gru.dh = call i8 @recipe.add(i8 %gru.dy, i8 %gru.future)
...
%gru.dz.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.dz.index
%gru.dn.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.dn.index
store i8 %gru.dz, ptr %gru.dz.ptr, align 1
store i8 %gru.dn, ptr %gru.dn.ptr, align 1 %gru.next = add i32 %gru.hidden, 1
...
%gru.weight.ptr = getelementptr inbounds i8, ptr %weights, i32 %gru.weight.index
...
%gru.target.delta.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.target.delta.index
%gru.weight = load i8, ptr %gru.weight.ptr, align 1
%gru.target.delta = load i8, ptr %gru.target.delta.ptr, align 1
...
%gru.source.previous.ptr = getelementptr inbounds i8, ptr %output, i32 %gru.source.previous.index
%gru.r.index = add i32 %batch, %gru.source.index
%gru.r.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.r.index
%gru.source.previous.loaded = load i8, ptr %gru.source.previous.ptr, align 1
%gru.source.previous = select i1 %previous.exists, i8 %gru.source.previous.loaded, i8 0
%gru.r = load i8, ptr %gru.r.ptr, align 1
...
%gru.dr.ptr = getelementptr inbounds i8, ptr %context, i32 %gru.dr.index
store i8 %gru.dr.1, ptr %gru.dr.ptr, align 1 %gru.source.next = add i32 %gru.source, 1
...
%dy.ptr = getelementptr inbounds i8, ptr %delta, i32 %index %dh.index = add i32 %dh.start, %hidden
%dc.index = add i32 %dc.start, %hidden %dh.ptr = getelementptr inbounds i8, ptr %context, i32 %dh.index
%dc.ptr = getelementptr inbounds i8, ptr %context, i32 %dc.index
%cell.ptr = getelementptr inbounds i8, ptr %context, i32 %cell.index
%cell.previous.ptr = getelementptr inbounds i8, ptr %context, i32 %cell.previous.index
%dy = load i8, ptr %dy.ptr, align 1 %dh.future = load i8, ptr %dh.ptr, align 1
%dc.future = load i8, ptr %dc.ptr, align 1 %cell = load i8, ptr %cell.ptr, align 1
%cell.previous.loaded = load i8, ptr %cell.previous.ptr, align 1
%cell.previous = select i1 %previous.exists, i8 %cell.previous.loaded, i8 0
%i.ptr = getelementptr inbounds i8, ptr %context, i32 %index %f.index = add i32 %batch, %index
%o.index = add i32 %f.index, %batch %g.index = add i32 %o.index, %batch
%f.ptr = getelementptr inbounds i8, ptr %context, i32 %f.index
%o.ptr = getelementptr inbounds i8, ptr %context, i32 %o.index
%g.ptr = getelementptr inbounds i8, ptr %context, i32 %g.index
%i = load i8, ptr %i.ptr, align 1 %f = load i8, ptr %f.ptr, align 1
%o = load i8, ptr %o.ptr, align 1 %g = load i8, ptr %g.ptr, align 1
...
store i8 %dc.previous, ptr %dc.ptr, align 1 %delta0.index = add i32 %delta.base, %index
%delta1.index = add i32 %delta0.index, %batch %delta2.index = add i32 %delta1.index, %batch
%delta3.index = add i32 %delta2.index, %batch
%delta0.ptr = getelementptr inbounds i8, ptr %context, i32 %delta0.index
%delta1.ptr = getelementptr inbounds i8, ptr %context, i32 %delta1.index
%delta2.ptr = getelementptr inbounds i8, ptr %context, i32 %delta2.index
%delta3.ptr = getelementptr inbounds i8, ptr %context, i32 %delta3.index
store i8 %di, ptr %delta0.ptr, align 1 store i8 %df, ptr %delta1.ptr, align 1
store i8 %do, ptr %delta2.ptr, align 1 store i8 %dg, ptr %delta3.ptr, align 1
...
%gate.delta.ptr = getelementptr inbounds i8, ptr %context, i32 %delta.index
%gate.delta = load i8, ptr %gate.delta.ptr, align 1
...
%state.ptr = getelementptr inbounds i8, ptr %output, i32 %state.index.value
%state.loaded = load i8, ptr %state.ptr, align 1
...
%parameter.reset.ptr = getelementptr inbounds i8, ptr %context, i32 %parameter.reset.index
%parameter.reset = load i8, ptr %parameter.reset.ptr, align 1
...
%row.gradient.ptr = getelementptr inbounds i8, ptr %context, i32 %row.gradient.index
%row.gradient.old = load i8, ptr %row.gradient.ptr, align 1
%row.gradient.new = call i8 @recipe.add(i8 %row.gradient.old, i8 %contribution)
store i8 %row.gradient.new, ptr %row.gradient.ptr, align 1
...
%state.delta.ptr = getelementptr inbounds i8, ptr %context, i32 %state.delta.index
%state.weight.value = load i8, ptr %state.weight.ptr, align 1
%state.delta.value = load i8, ptr %state.delta.ptr, align 1
...
%state.reset.ptr = getelementptr inbounds i8, ptr %context, i32 %state.reset.index
%state.reset = load i8, ptr %state.reset.ptr, align 1
...
%state.dh.ptr = getelementptr inbounds i8, ptr %context, i32 %state.dh.index
...
%state.direct.delta.ptr = getelementptr inbounds i8, ptr %delta, i32 %state.direct.index
%state.direct.z.ptr = getelementptr inbounds i8, ptr %context, i32 %state.direct.index
%state.direct.dy = load i8, ptr %state.direct.delta.ptr, align 1
%state.direct.future = load i8, ptr %state.dh.ptr, align 1
%state.direct.z = load i8, ptr %state.direct.z.ptr, align 1
...
store i8 %state.total, ptr %state.dh.ptr, align 1 %state.channel.next = add nuw i32 %state.channel, 1
...
%projection.weights = getelementptr inbounds i8, ptr %weights, i32 %projection.weight.offset
%projection.delta.gate = mul i32 %projection.gate, %batch
%projection.delta.offset = add i32 %delta.base, %projection.delta.gate
%projection.delta = getelementptr inbounds i8, ptr %context, i32 %projection.delta.offset
...
@recipe.cpu.barrier.context = internal thread_local global ptr null, align 1
@recipe.cpu.barrier.wait = internal thread_local global ptr null, align 1
define  void @recipe_model_thread(i32 %thread, ptr %context, ptr %wait) #0 { entry: store i32 %thread, ptr @recipe.cpu.thread, align 4 store ptr %context, ptr @recipe.cpu.barrier.context, align 1 store ptr %wait, ptr @recipe.cpu.barrier.wait, align 1 ret void }
define internal i32 @recipe.cpu.thread.id() #1 { entry: %thread = load i32, ptr @recipe.cpu.thread, align 4 ret i32 %thread }
define internal void @recipe.cpu.barrier() #1 { entry: %context = load ptr, ptr @recipe.cpu.barrier.context, align 1 %wait = load ptr, ptr @recipe.cpu.barrier.wait, align 1 call void %wait(ptr %context) ret void }