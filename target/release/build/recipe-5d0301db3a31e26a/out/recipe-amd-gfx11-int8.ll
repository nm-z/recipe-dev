...
define internal float @recipe.decode(i8 %value) #1 { entry: %wide = zext i8 %value to i32 %masked = and i32 %wide, 255 %shifted = shl i32 %masked, 24 %signed = ashr i32 %shifted, 24 %result = sitofp i32 %signed to float ret float %result }
define internal i8 @recipe.encode(float %value) #1 { entry: %nan = fcmp uno float %value, %value %rounded = call float @llvm.roundeven.f32(float %value) %below = fcmp olt float %rounded, -128.0 %above = fcmp ogt float %rounded, 127.0 %lowered = select i1 %below, float -128.0, float %rounded %clamped = select i1 %above, float 127.0, float %lowered %finite = select i1 %nan, float 0.0, float %clamped %integer = fptosi float %finite to i32 %masked = and i32 %integer, 255 %result = trunc i32 %masked to i8 ret i8 %result }
...
define internal i8 @recipe.add(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %wide = fadd float %left.wide, %right.wide %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.sub(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %wide = fsub float %left.wide, %right.wide %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.mul(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %wide = fmul float %left.wide, %right.wide %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.div(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %wide = fdiv float %left.wide, %right.wide %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.madd(i8 %sum, i8 %left, i8 %right) #1 { entry: %sum.wide = call float @recipe.decode(i8 %sum) %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %wide = call float @llvm.fma.f32(float %left.wide, float %right.wide, float %sum.wide) %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal <RECIPE_REGISTER_M x i8> @recipe.madd.vector(<RECIPE_REGISTER_M x i8> %sum, <RECIPE_REGISTER_M x i8> %left, <RECIPE_REGISTER_M x i8> %right) #1 {
entry:
br label %loop
loop:
%p = phi i32 [ 0, %entry ], [ %p.next, %step ]
%result = phi <RECIPE_REGISTER_M x i8> [ poison, %entry ], [ %next, %step ]
%more = icmp ult i32 %p, RECIPE_REGISTER_M
br i1 %more, label %step, label %done
step:
%sum.value = extractelement <RECIPE_REGISTER_M x i8> %sum, i32 %p
%left.value = extractelement <RECIPE_REGISTER_M x i8> %left, i32 %p
%right.value = extractelement <RECIPE_REGISTER_M x i8> %right, i32 %p
%value = call i8 @recipe.madd(i8 %sum.value, i8 %left.value, i8 %right.value)
%next = insertelement <RECIPE_REGISTER_M x i8> %result, i8 %value, i32 %p
%p.next = add i32 %p, 1
br label %loop
done:
ret <RECIPE_REGISTER_M x i8> %result
}
define internal i8 @recipe.neg(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %negative = fneg float %wide %result = call i8 @recipe.encode(float %negative) ret i8 %result }
define internal i1 @recipe.oeq(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp oeq float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.oge(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp oge float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ogt(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp ogt float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ole(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp ole float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.olt(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp olt float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.one(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp one float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ord(i8 %left, i8 %right) #1 { entry: %left.wide = call float @recipe.decode(i8 %left) %right.wide = call float @recipe.decode(i8 %right) %result = fcmp ord float %left.wide, %right.wide ret i1 %result }
define internal i8 @recipe.from.u1(i1 %value) #1 { entry: %wide = uitofp i1 %value to float %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.from.u32(i32 %value) #1 { entry: %wide = uitofp i32 %value to float %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.from.s32(i32 %value) #1 { entry: %wide = sitofp i32 %value to float %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i32 @recipe.to.u32(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %result = fptoui float %wide to i32 ret i32 %result }
define internal i32 @recipe.to.s32(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %result = fptosi float %wide to i32 ret i32 %result }
define internal i8 @recipe.from.f32(float %value) #1 { entry: %wide = fadd float %value, 0.0 %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal i8 @recipe.from.f16(half %value) #1 { entry: %wide = fpext half %value to float %result = call i8 @recipe.encode(float %wide) ret i8 %result }
define internal half @recipe.to.f16(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %result = fptrunc float %wide to half ret half %result }
define internal i8 @recipe.abs(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @llvm.fabs.f32(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.floor(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @llvm.floor.f32(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.sqrt(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @llvm.sqrt.f32(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.exp(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @recipe.math.exp(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.tanh(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @recipe.math.tanh(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.cos(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @recipe.math.cos(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.sin(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @recipe.math.sin(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.log(i8 %value) #1 { entry: %wide = call float @recipe.decode(i8 %value) %computed = call float @recipe.math.log(float %wide) %result = call i8 @recipe.encode(float %computed) ret i8 %result }
define internal i8 @recipe.sigmoid(i8 %value) #1 { entry: %negative = call i8 @recipe.neg(i8 %value) %exponential = call i8 @recipe.exp(i8 %negative) %one = call i8 @recipe.from.u1(i1 true) %denominator = call i8 @recipe.add(i8 %exponential, i8 %one) %result = call i8 @recipe.div(i8 %one, i8 %denominator) ret i8 %result }
...
define internal float @recipe.state.from.model(i8 %value) #1 { entry: %result = call float @recipe.decode(i8 %value) ret float %result }
define internal i8 @recipe.model.from.state(float %value) #1 { entry: %result = call i8 @recipe.encode(float %value) ret i8 %result }
; NUMERIC END
declare i32 @llvm.amdgcn.workitem.id.x()
declare void @llvm.amdgcn.s.barrier() declare i64 @__ockl_steadyctr_u64()
declare void @llvm.trap() @contraction_tile_int8 = external addrspace(3) global [0 x i8], align 16
define internal i8 @contraction_input(
...
%index = add i32 %row.base, %local %ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %index
%value = load i8, ptr addrspace(1) %ptr, align 1 ret i8 %value }
define internal i8 @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %index
%delta.value = load i8, ptr addrspace(1) %delta.ptr, align 1
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %index
%output.value = load i8, ptr addrspace(1) %output.ptr, align 1
%positive = call i1 @recipe.ogt(i8 %output.value, i8 0)
%activated = select i1 %positive, i8 %delta.value, i8 0
br label %done
done:
%value = phi i8 [ %delta.value, %entry ], [ %activated, %activation ]
ret i8 %value
}
define internal <16 x i8> @contraction_delta_vector16(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %index
%delta.value = load <16 x i8>, ptr addrspace(1) %delta.ptr, align 1
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %index
%output.value = load <16 x i8>, ptr addrspace(1) %output.ptr, align 1
br label %activation.loop
activation.loop:
%activation.index = phi i32 [ 0, %activation ], [ %activation.next, %activation.step ]
%activation.values = phi <16 x i8> [ zeroinitializer, %activation ], [ %activation.values.next, %activation.step ]
%activation.more = icmp ult i32 %activation.index, 16
br i1 %activation.more, label %activation.step, label %done
activation.step:
%activation.output = extractelement <16 x i8> %output.value, i32 %activation.index
%activation.delta = extractelement <16 x i8> %delta.value, i32 %activation.index
%activation.positive = call i1 @recipe.ogt(i8 %activation.output, i8 0)
%activation.value = select i1 %activation.positive, i8 %activation.delta, i8 0
%activation.values.next = insertelement <16 x i8> %activation.values, i8 %activation.value, i32 %activation.index
%activation.next = add i32 %activation.index, 1
br label %activation.loop
done:
%value = phi <16 x i8> [ %delta.value, %entry ], [ %activation.values, %activation.loop ]
ret <16 x i8> %value
}
...
%target.ptr = getelementptr inbounds i8, ptr addrspace(1) %target, i32 %target.index
%source.first.index = add i32 %source.offset, %parameter
%source.first.ptr = getelementptr inbounds i8, ptr addrspace(1) %source, i32 %source.first.index
%source.first = load i8, ptr addrspace(1) %source.first.ptr, align 1
br label %row.loop
row.loop:
%row = phi i32 [ 1, %seed.load ], [ %row.next, %row.step ]
%sum = phi i8 [ %source.first, %seed.load ], [ %sum.next, %row.step ]
...
%source.ptr = getelementptr inbounds i8, ptr addrspace(1) %source, i32 %source.index
%source.value = load i8, ptr addrspace(1) %source.ptr, align 1
%sum.next = call i8 @recipe.add(i8 %sum, i8 %source.value)
%row.next = add i32 %row, 1
br label %row.loop
store:
store i8 %sum, ptr addrspace(1) %target.ptr, align 1
...
define internal void @contraction_stage_column16(<16 x i8> %values, i32 %base, i32 %r, i32 %column, i32 %stride) #1 {
entry:
br label %loop
loop:
...
br i1 %more, label %step, label %done
step:
%value = extractelement <16 x i8> %values, i32 %j
%row.local = add i32 %r, %j
%row = mul i32 %row.local, %stride
%local = add i32 %row, %column
%index = add i32 %base, %local
%ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
store i8 %value, ptr addrspace(3) %ptr, align 1
%j.next = add i32 %j, 1
br label %loop
done:
ret void
...
%ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
store i8 0, ptr addrspace(3) %ptr, align 1
%next = add i32 %p, %block
br label %loop
exit:
ret void
}
define internal <RECIPE_REGISTER_M x i8> @contraction_a_fragment(i32 %k, i32 %output.m.base, i32 %tile.m, i32 %tile.k) #1 {
entry:
%index = call i32 @contraction_matrix_a_index(i32 %k, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_M x i8>, ptr addrspace(3) %ptr, align 1
ret <RECIPE_REGISTER_M x i8> %fragment
}
define internal <RECIPE_REGISTER_N x i8> @contraction_b_fragment(i32 %k, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
%local = call i32 @contraction_matrix_b_index(i32 %k, i32 %output.n.base, i32 %tile.n, i32 %tile.k)
%index = add i32 %base, %local
%ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_N x i8>, ptr addrspace(3) %ptr, align 1
ret <RECIPE_REGISTER_N x i8> %fragment
}
define internal void @contraction_stage_a_fragment(<RECIPE_FRAGMENT_K x i8> %fragment, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
...
%value = extractelement <RECIPE_FRAGMENT_K x i8> %fragment, i32 %element
%target = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
store i8 %value, ptr addrspace(3) %target, align 1
%next = add i32 %element, 1
br label %loop
exit:
ret void
}
define internal void @contraction_stage_a_columns(<RECIPE_FRAGMENT_K x i8> %fragment, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
%element = phi i32 [ 0, %entry ], [ %next, %step ]
...
define internal void @contraction_stage_b_terms(<RECIPE_FRAGMENT_K x i8> %fragment, i32 %k, i32 %n, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
br label %loop
loop:
...
define internal void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x i8> %fragment, i32 %k, i32 %n, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
br label %loop
loop:
...
define internal void @contraction_stage_delta_a_fragment(<RECIPE_FRAGMENT_K x i8> %delta, <RECIPE_FRAGMENT_K x i8> %output, i1 %relu, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
%element = phi i32 [ 0, %entry ], [ %next, %step ]
...
br i1 %more, label %step, label %exit
step:
%delta.value = extractelement <RECIPE_FRAGMENT_K x i8> %delta, i32 %element
%output.value = extractelement <RECIPE_FRAGMENT_K x i8> %output, i32 %element
%positive = call i1 @recipe.ogt(i8 %output.value, i8 0)
%active = select i1 %positive, i8 %delta.value, i8 0
%value = select i1 %relu, i8 %active, i8 %delta.value
%local.k = add i32 %k, %element
%index = call i32 @contraction_matrix_a_index(i32 %local.k, i32 %m, i32 %tile.m, i32 %tile.k)
%target = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
store i8 %value, ptr addrspace(3) %target, align 1
...
%local.a.initial = call <RECIPE_REGISTER_M x i8> @contraction_a_fragment(i32 0, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%local.b.initial = call <RECIPE_REGISTER_N x i8> @contraction_b_fragment(i32 0, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
...
%local.a.fragment = phi <RECIPE_REGISTER_M x i8> [ %local.a.initial, %local.k.begin ], [ %local.a.next, %local.product.done ]
%local.b.fragment = phi <RECIPE_REGISTER_N x i8> [ %local.b.initial, %local.k.begin ], [ %local.b.next, %local.product.done ]
...
%local.a.next = call <RECIPE_REGISTER_M x i8> @contraction_a_fragment(i32 %local.k.prefetch, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%local.b.next = call <RECIPE_REGISTER_N x i8> @contraction_b_fragment(i32 %local.k.prefetch, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
%local.a.wide = call <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x i8> %local.a.fragment)
...
%local.b = extractelement <RECIPE_REGISTER_N x i8> %local.b.fragment, i32 %local.b.index
%local.b.wide = call float @recipe.decode(i8 %local.b)
...
%a.initial = call <RECIPE_REGISTER_M x i8> @contraction_a_fragment(i32 %k.first, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%b.initial = call <RECIPE_REGISTER_N x i8> @contraction_b_fragment(i32 %k.first, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
br label %k.loop
k.loop:
%k = phi i32 [ %k.first, %k.begin ], [ %k.next, %register.done ]
%a.fragment = phi <RECIPE_REGISTER_M x i8> [ %a.initial, %k.begin ], [ %a.next, %register.done ]
%b.fragment = phi <RECIPE_REGISTER_N x i8> [ %b.initial, %k.begin ], [ %b.next, %register.done ]
%k.next = add i32 %k, 1
%k.more = icmp ult i32 %k.next, %k.limit
%k.prefetch = select i1 %k.more, i32 %k.next, i32 %k
%a.next = call <RECIPE_REGISTER_M x i8> @contraction_a_fragment(i32 %k.prefetch, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%b.next = call <RECIPE_REGISTER_N x i8> @contraction_b_fragment(i32 %k.prefetch, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
%a.wide = call <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x i8> %a.fragment)
...
%b = extractelement <RECIPE_REGISTER_N x i8> %b.fragment, i32 %register.n
%b.wide = call float @recipe.decode(i8 %b)
...
%publish.target = getelementptr float, ptr addrspace(3) @contraction_tile_int8, i32 %publish.target.index
...
%fold.source = getelementptr float, ptr addrspace(3) @contraction_tile_int8, i32 %fold.source.index
...
%ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %index
%raw = load i8, ptr addrspace(3) %ptr, align 1 %value = call float @recipe.decode(i8 %raw) %sum.next = call float @recipe.state.add(float %sum, float %value)
...
%bias.ptr = getelementptr inbounds i8, ptr addrspace(1) %destination, i32 %bias.index
%bias = call i8 @recipe.encode(float %sum) store i8 %bias, ptr addrspace(1) %bias.ptr, align 1 br label %channel.done
channel.done:
...
define internal <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x i8> %source) #1 {
entry:
br label %loop
loop:
%p = phi i32 [ 0, %entry ], [ %p.next, %step ]
...
br i1 %more, label %step, label %done
step:
%value = extractelement <RECIPE_REGISTER_M x i8> %source, i32 %p
%wide = call float @recipe.decode(i8 %value)
...
%matrix.a.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.a.index
%matrix.a.loaded = load <16 x i8>, ptr addrspace(3) %matrix.a.ptr, align 16
%matrix.a.full = select i1 %m.valid, <16 x i8> %matrix.a.loaded, <16 x i8> zeroinitializer
...
%matrix.b.first.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.b.first.index
%matrix.b.first.loaded = load <16 x i8>, ptr addrspace(3) %matrix.b.first.ptr, align 16
%matrix.b.first.full = select i1 %n.first.valid, <16 x i8> %matrix.b.first.loaded, <16 x i8> zeroinitializer
...
%matrix.b.second.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.b.second.index
%matrix.b.second.loaded = load <16 x i8>, ptr addrspace(3) %matrix.b.second.ptr, align 16
%matrix.b.second.full = select i1 %n.second.valid, <16 x i8> %matrix.b.second.loaded, <16 x i8> zeroinitializer
...
%matrix.b.third.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.b.third.index
%matrix.b.third.loaded = load <16 x i8>, ptr addrspace(3) %matrix.b.third.ptr, align 16
%matrix.b.third.full = select i1 %n.third.valid, <16 x i8> %matrix.b.third.loaded, <16 x i8> zeroinitializer
...
%matrix.b.fourth.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.b.fourth.index
%matrix.b.fourth.loaded = load <16 x i8>, ptr addrspace(3) %matrix.b.fourth.ptr, align 16
%matrix.b.fourth.full = select i1 %n.fourth.valid, <16 x i8> %matrix.b.fourth.loaded, <16 x i8> zeroinitializer
%matrix.first.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.a.full, <16 x i8> %matrix.b.first.full, <8 x float> %matrix.first)
%matrix.second.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.a.full, <16 x i8> %matrix.b.second.full, <8 x float> %matrix.second)
%matrix.third.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.a.full, <16 x i8> %matrix.b.third.full, <8 x float> %matrix.third)
%matrix.fourth.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.a.full, <16 x i8> %matrix.b.fourth.full, <8 x float> %matrix.fourth)
...
%a.vector.source = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %a.vector.index
%a.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr addrspace(1) %a.vector.source, align 1
call void @contraction_stage_a_fragment(<RECIPE_FRAGMENT_K x i8> %a.vector.value, i32 %a.k, i32 %a.m, i32 %tile.m, i32 %tile.k)
br label %load.advance
load.a.scalar:
%a.loaded = call i8 @contraction_input( ptr addrspace(1) %input, i32 %a.row.base, i32 %a.position, i32 %a.term, i32 %span, i32 %in.length, i1 %is.conv )
br i1 %a.gate, label %load.a.activation, label %load.a.ready
load.a.activation:
%a.activation.channel = mul i32 %a.term, %in.length %a.activation.local = add i32 %a.activation.channel, %a.position %a.activation.index = add i32 %a.row.base, %a.activation.local %a.activation.ptr = getelementptr inbounds i8, ptr addrspace(1) %activation, i32 %a.activation.index %a.activation.value = load i8, ptr addrspace(1) %a.activation.ptr, align 2 %a.activation.positive = call i1 @recipe.ogt(i8 %a.activation.value, i8 0) %a.gated = select i1 %a.activation.positive, i8 %a.loaded, i8 0
br label %load.a.ready
load.a.ready:
%a.value = phi i8 [ %a.loaded, %load.a.scalar ], [ %a.gated, %load.a.activation ]
br label %load.store
...
load.b.vector:
%b.vector.source = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %b.index
%b.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr addrspace(1) %b.vector.source, align 1
call void @contraction_stage_b_terms(<RECIPE_FRAGMENT_K x i8> %b.vector.value, i32 %b.k, i32 %b.n, i32 %tile.m, i32 %tile.n, i32 %tile.k)
br label %load.advance
load.b.scalar:
%b.ptr = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %b.index
%b.value = load i8, ptr addrspace(1) %b.ptr, align 1
br label %load.store
load.store: %load.value = phi i8 [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %load.tile.index store i8 %load.value, ptr addrspace(3) %load.tile.ptr, align 1
br label %load.advance
load.advance:
...
%store.output.channel.base = mul i32 %store.channel, %out.length %store.output.local = add i32 %store.output.channel.base, %store.position %store.output.index = add i32 %store.output.row.base, %store.output.local %store.output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %store.output.index
%store.bias.base = mul i32 %out.channels, %terms %store.bias.index = add i32 %store.bias.base, %store.channel %store.bias.ptr = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %store.bias.index %store.bias = load i8, ptr addrspace(1) %store.bias.ptr, align 1 %store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr addrspace(5) %sums, i32 0, i32 %store.register %store.sum.wide = load float, ptr addrspace(5) %store.sum.ptr, align 4 %store.sum = call i8 @recipe.encode(float %store.sum.wide)
%store.biased = call i8 @recipe.add(i8 %store.sum, i8 %store.bias) %store.raw = select i1 %has.bias, i8 %store.biased, i8 %store.sum %store.forward = xor i1 %reverse, true %store.activate = and i1 %relu, %store.forward %store.positive = call i1 @recipe.ogt(i8 %store.raw, i8 0) %store.activated = select i1 %store.positive, i8 %store.raw, i8 0 %store.result = select i1 %store.activate, i8 %store.activated, i8 %store.raw %store.prior = load i8, ptr addrspace(1) %store.output.ptr, align 2 %store.accumulated = call i8 @recipe.add(i8 %store.prior, i8 %store.result) %store.value = select i1 %accumulate, i8 %store.accumulated, i8 %store.result store i8 %store.value, ptr addrspace(1) %store.output.ptr, align 1 br label %store.next
...
%maximum = phi i8 [ 128, %entry ], [ %maximum.next, %step ]
...
%input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %index
%value = load i8, ptr addrspace(1) %input.ptr, align 1 %greater = call i1 @recipe.ogt(i8 %value, i8 %maximum)
%maximum.next = select i1 %greater, i8 %value, i8 %maximum
%maximum.index.next = select i1 %greater, i32 %index, i32 %maximum.index %next = add i32 %i, 1 br label %loop done:
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %p
%context.ptr = getelementptr inbounds i64, ptr addrspace(1) %context, i32 %p
%maximum.index.wide = zext i32 %maximum.index to i64
store i8 %maximum, ptr addrspace(1) %output.ptr, align 1
store i64 %maximum.index.wide, ptr addrspace(1) %context.ptr, align 1 ret void }
define internal i8 @sigmoid(i8 %x) #1 { entry: %negative = call i8 @recipe.neg(i8 %x)
%exponential = call i8 @recipe.exp(i8 %negative) %denominator = call i8 @recipe.add(i8 1, i8 %exponential)
%value = call i8 @recipe.div(i8 1, i8 %denominator) ret i8 %value }
define internal i8 @attention_tile_dot(i32 %left, i32 %right, i32 %width, i32 %left.base, i32 %right.base) #1 { entry:
br label %channel.loop
channel.loop:
%channel = phi i32 [ 0, %entry ], [ %channel.next, %channel.step ]
%sum = phi i8 [ 0, %entry ], [ %sum.next, %channel.step ]
...
%left.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %left.index
%left.value = load i8, ptr addrspace(3) %left.ptr, align 1
%right.row = mul i32 %right, %width
%right.local = add i32 %right.row, %channel
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %right.index
%right.value = load i8, ptr addrspace(3) %right.ptr, align 1
%product = call i8 @recipe.mul(i8 %left.value, i8 %right.value)
%sum.next = call i8 @recipe.add(i8 %sum, i8 %product)
%channel.next = add i32 %channel, 1
br label %channel.loop
done:
ret i8 %sum
}
define internal i8 @attention_tile_score(i32 %query, i32 %key, i32 %width, i32 %key.base, i8 %scale) #1 { entry:
%sum = call i8 @attention_tile_dot(i32 %query, i32 %key, i32 %width, i32 0, i32 %key.base)
%score = call i8 @recipe.div(i8 %sum, i8 %scale)
ret i8 %score
}
...
%sum = phi i8 [ 0, %prepare ], [ %sum.next, %channel.step ]
...
%delta.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %delta.index
%delta = load i8, ptr addrspace(3) %delta.ptr, align 1
...
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %output.index
%output.value = load i8, ptr addrspace(1) %output.ptr, align 1
%term = call i8 @recipe.mul(i8 %delta, i8 %output.value)
%sum.next = call i8 @recipe.add(i8 %sum, i8 %term)
%channel.next = add i32 %channel, 1
br label %channel.loop
store:
%product.index = add i32 %product.base, %query
%product.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %product.index
store i8 %sum, ptr addrspace(3) %product.ptr, align 1
...
i8 %scale, i32 %lid, i32 %block) #1 { entry:
...
complete:
%score.raw = call i8 @attention_tile_dot(i32 %query.local, i32 %key.local, i32 %head.width, i32 %query.shared, i32 %key.shared)
%score = call i8 @recipe.div(i8 %score.raw, i8 %scale)
%dp = call i8 @attention_tile_dot(i32 %query.local, i32 %key.local, i32 %head.width, i32 %delta.shared, i32 %value.shared)
%statistics.base = mul i32 %head.job, %length
%statistics.index = add i32 %statistics.base, %query
%maximum.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %statistics.index
%maximum = load i8, ptr addrspace(1) %maximum.ptr, align 1
%denominator.index = add i32 %statistics.denominator.base, %statistics.index
%denominator.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %denominator.index
%denominator = load i8, ptr addrspace(1) %denominator.ptr, align 1
%centered = call i8 @recipe.sub(i8 %score, i8 %maximum)
%exponential = call i8 @recipe.exp(i8 %centered)
%probability = call i8 @recipe.div(i8 %exponential, i8 %denominator)
%product.index = add i32 %product.shared, %query.local
%product.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %product.index
%product = load i8, ptr addrspace(3) %product.ptr, align 1
%dp.centered = call i8 @recipe.sub(i8 %dp, i8 %product)
%derivative = call i8 @recipe.mul(i8 %probability, i8 %dp.centered)
br label %store
invalid:
br label %store
store:
%probability.value = phi i8 [ %probability, %complete ], [ 0, %invalid ]
%derivative.value = phi i8 [ %derivative, %complete ], [ 0, %invalid ]
...
%probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %probability.index
store i8 %probability.value, ptr addrspace(3) %probability.ptr, align 1
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %derivative.index
store i8 %derivative.value, ptr addrspace(3) %derivative.ptr, align 1
...
%head.width.double = call i8 @recipe.from.u32(i32 %head.width)
%scale = call i8 @recipe.sqrt(i8 %head.width.double)
...
%query.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %query.input.index
%query.value = load i8, ptr addrspace(1) %query.input.ptr, align 1
%query.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %query.p
store i8 %query.value, ptr addrspace(3) %query.shared.ptr, align 1
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %accumulator.index
store i8 0, ptr addrspace(3) %accumulator.ptr, align 1
...
%maximum.ptr.init = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %maximum.index.init
store i8 128, ptr addrspace(3) %maximum.ptr.init, align 1
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %denominator.index.init
store i8 0, ptr addrspace(3) %denominator.ptr.init, align 1
...
%key.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %key.input.index
%key.value = load i8, ptr addrspace(1) %key.input.ptr, align 1
%key.shared.index = add i32 %key.base.shared, %key.p
%key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %key.shared.index
store i8 %key.value, ptr addrspace(3) %key.shared.ptr, align 1
%value.plane = mul i32 %from, 2
%value.row = add i32 %row.base, %value.plane
%value.input.index = add i32 %value.row, %key.input.local
%value.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %value.input.index
%value.value = load i8, ptr addrspace(1) %value.input.ptr, align 1
%value.shared.index = add i32 %value.base.shared, %key.p
%value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %value.shared.index
store i8 %value.value, ptr addrspace(3) %value.shared.ptr, align 1
...
score.complete:
%score.scaled = call i8 @attention_tile_score(i32 %score.query.local, i32 %score.key.local, i32 %head.width, i32 %key.base.shared, i8 %scale)
br label %score.store
score.invalid:
br label %score.store
score.store:
%score.value = phi i8 [ %score.scaled, %score.complete ], [ 128, %score.invalid ]
...
%score.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %score.shared.index
store i8 %score.value, ptr addrspace(3) %score.shared.ptr, align 1
...
%maximum.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %maximum.index
%maximum.old = load i8, ptr addrspace(3) %maximum.ptr, align 1
br label %maximum.loop
maximum.loop:
%maximum.key = phi i32 [ 0, %maximum.load ], [ %maximum.key.next, %maximum.step ]
%maximum.value = phi i8 [ %maximum.old, %maximum.load ], [ %maximum.next, %maximum.step ]
...
%maximum.score.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %maximum.score.index
%maximum.score = load i8, ptr addrspace(3) %maximum.score.ptr, align 1
%maximum.larger = call i1 @recipe.ogt(i8 %maximum.score, i8 %maximum.value)
%maximum.next = select i1 %maximum.larger, i8 %maximum.score, i8 %maximum.value
%maximum.key.next = add i32 %maximum.key, 1
br label %maximum.loop
probability.prepare:
%denominator.index = add i32 %denominator.base.shared, %softmax.query
%denominator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %denominator.index
%denominator.old = load i8, ptr addrspace(3) %denominator.ptr, align 1
%maximum.old.centered = call i8 @recipe.sub(i8 %maximum.old, i8 %maximum.value)
%old.rescale = call i8 @recipe.exp(i8 %maximum.old.centered)
%denominator.rescaled = call i8 @recipe.mul(i8 %denominator.old, i8 %old.rescale)
br label %probability.loop
probability.loop:
%probability.key = phi i32 [ 0, %probability.prepare ], [ %probability.key.next, %probability.step ]
%denominator.value = phi i8 [ %denominator.rescaled, %probability.prepare ], [ %denominator.next, %probability.step ]
...
%probability.score.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %probability.score.index
%probability.score = load i8, ptr addrspace(3) %probability.score.ptr, align 1
%probability.centered = call i8 @recipe.sub(i8 %probability.score, i8 %maximum.value)
%probability.value = call i8 @recipe.exp(i8 %probability.centered)
%probability.index = add i32 %probability.base.shared, %probability.local
%probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %probability.index
store i8 %probability.value, ptr addrspace(3) %probability.ptr, align 1
%denominator.next = call i8 @recipe.add(i8 %denominator.value, i8 %probability.value)
%probability.key.next = add i32 %probability.key, 1
br label %probability.loop
softmax.store:
store i8 %maximum.value, ptr addrspace(3) %maximum.ptr, align 1
store i8 %denominator.value, ptr addrspace(3) %denominator.ptr, align 1
%rescale.index = add i32 %rescale.base.shared, %softmax.query
%rescale.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %rescale.index
store i8 %old.rescale, ptr addrspace(3) %rescale.ptr, align 1
...
%accumulate.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %accumulate.index
%accumulate.old = load i8, ptr addrspace(3) %accumulate.ptr, align 1
%accumulate.rescale.index = add i32 %rescale.base.shared, %accumulate.query
%accumulate.rescale.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %accumulate.rescale.index
%accumulate.rescale = load i8, ptr addrspace(3) %accumulate.rescale.ptr, align 1
%accumulate.initial = call i8 @recipe.mul(i8 %accumulate.old, i8 %accumulate.rescale)
br label %accumulate.key.loop
accumulate.key.loop:
%accumulate.key = phi i32 [ 0, %accumulate.prepare ], [ %accumulate.key.next, %accumulate.key.step ]
%accumulate.value = phi i8 [ %accumulate.initial, %accumulate.prepare ], [ %accumulate.next, %accumulate.key.step ]
...
%accumulate.probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %accumulate.probability.index
%accumulate.probability = load i8, ptr addrspace(3) %accumulate.probability.ptr, align 1
...
%accumulate.value.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %accumulate.value.index
%accumulate.v = load i8, ptr addrspace(3) %accumulate.value.ptr, align 1
%accumulate.weighted = call i8 @recipe.mul(i8 %accumulate.probability, i8 %accumulate.v)
%accumulate.next = call i8 @recipe.add(i8 %accumulate.value, i8 %accumulate.weighted)
%accumulate.key.next = add i32 %accumulate.key, 1
br label %accumulate.key.loop
accumulate.store:
store i8 %accumulate.value, ptr addrspace(3) %accumulate.ptr, align 1
...
%output.accumulator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %output.accumulator.index
%output.accumulator = load i8, ptr addrspace(3) %output.accumulator.ptr, align 1
%output.denominator.index = add i32 %denominator.base.shared, %output.query.local
%output.denominator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %output.denominator.index
%output.denominator = load i8, ptr addrspace(3) %output.denominator.ptr, align 1
%attention = call i8 @recipe.div(i8 %output.accumulator, i8 %output.denominator)
...
%output.maximum.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %output.maximum.index
%output.maximum = load i8, ptr addrspace(3) %output.maximum.ptr, align 1
...
%output.statistics.maximum.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %output.statistics.index
store i8 %output.maximum, ptr addrspace(1) %output.statistics.maximum.ptr, align 1
%output.statistics.denominator.index = add i32 %statistics.plane, %output.statistics.index
%output.statistics.denominator.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %output.statistics.denominator.index
store i8 %output.denominator, ptr addrspace(1) %output.statistics.denominator.ptr, align 1
...
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %output.index
store i8 %attention, ptr addrspace(1) %output.ptr, align 1
...
%length = udiv i32 %from, %channels
%head.width = udiv i32 %channels, %heads
%width.double = call i8 @recipe.from.u32(i32 %head.width)
%scale = call i8 @recipe.sqrt(i8 %width.double)
%head.jobs = mul i32 %rows, %heads
...
%stage.vector.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %stage.vector.index
%stage.vector.value = load <16 x i8>, ptr addrspace(1) %stage.vector.ptr, align 1
call void @contraction_stage_column16(<16 x i8> %stage.vector.value, i32 %stage.shared.base, i32 %stage.position, i32 %stage.channel.local, i32 %head.width)
...
%stage.scalar.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %stage.scalar.index
%stage.scalar.value = load i8, ptr addrspace(1) %stage.scalar.ptr, align 1
...
%stage.scalar.ptr.shared = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %stage.scalar.index.shared
store i8 %stage.scalar.value, ptr addrspace(3) %stage.scalar.ptr.shared, align 1
...
%matrix.q.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.q.index
%matrix.q.fragment = load <16 x i8>, ptr addrspace(3) %matrix.q.ptr, align 2
...
%matrix.k.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.k.index
%matrix.k.fragment = load <16 x i8>, ptr addrspace(3) %matrix.k.ptr, align 2
%matrix.accumulator.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.q.fragment, <16 x i8> %matrix.k.fragment, <8 x float> %matrix.accumulator)
...
%matrix.score.raw = call i8 @recipe.encode(float %matrix.score.wide)
%matrix.score.scaled = call i8 @recipe.div(i8 %matrix.score.raw, i8 %scale)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.score = select i1 %matrix.causal, i8 %matrix.score.scaled, i8 128
...
%matrix.p.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.p.index
store i8 %matrix.score, ptr addrspace(3) %matrix.p.ptr, align 1
...
%maximum = phi i8 [ 128, %attention.forward.matrix.softmax.loop ], [ %maximum.next, %attention.forward.matrix.maximum.step ]
...
%maximum.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %maximum.index
%maximum.score = load i8, ptr addrspace(3) %maximum.ptr, align 1
%maximum.larger = call i1 @recipe.ogt(i8 %maximum.score, i8 %maximum)
%maximum.next = select i1 %maximum.larger, i8 %maximum.score, i8 %maximum
%maximum.key.next = add i32 %maximum.key, 1
...
%denominator = phi i8 [ 0, %attention.forward.matrix.maximum.loop ], [ %denominator.next, %attention.forward.matrix.probability.step ]
...
%probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %probability.index
%probability.score = load i8, ptr addrspace(3) %probability.ptr, align 1
%probability.centered = call i8 @recipe.sub(i8 %probability.score, i8 %maximum)
%probability.value = call i8 @recipe.exp(i8 %probability.centered)
store i8 %probability.value, ptr addrspace(3) %probability.ptr, align 1
%denominator.next = call i8 @recipe.add(i8 %denominator, i8 %probability.value)
%probability.key.next = add i32 %probability.key, 1
...
%normalize.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %normalize.index
%normalize.value = load i8, ptr addrspace(3) %normalize.ptr, align 1
%normalized = call i8 @recipe.div(i8 %normalize.value, i8 %denominator)
store i8 %normalized, ptr addrspace(3) %normalize.ptr, align 1
...
%maximum.context.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %statistics.index
store i8 %maximum, ptr addrspace(1) %maximum.context.ptr, align 1
%denominator.index = add i32 %statistics.rows, %statistics.index
%denominator.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %denominator.index
store i8 %denominator, ptr addrspace(1) %denominator.ptr, align 1
%softmax.query.next = add i32 %softmax.query, %block
br label %attention.forward.matrix.softmax.loop
attention.forward.matrix.softmax.done:
call void @llvm.amdgcn.s.barrier()
call void @attention_matrix_product(ptr addrspace(1) %output, i32 3, i32 %p.base, i32 %v.base, i32 %output.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
call void @llvm.amdgcn.s.barrier()
...
%left.fragment = phi <16 x i8> [ zeroinitializer, %attention.matrix.gradient.k.loop ], [ %left.fragment.next, %attention.matrix.gradient.fragment.step ]
%right.fragment = phi <16 x i8> [ zeroinitializer, %attention.matrix.gradient.k.loop ], [ %right.fragment.next, %attention.matrix.gradient.fragment.step ]
...
%left.index = add i32 %left.base, %left.local
%left.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %left.index
%left.loaded = load i8, ptr addrspace(3) %left.ptr, align 1
%right.row = mul i32 %term.safe, %head.width
%right.local = add i32 %right.row, %n.safe
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %right.index
%right.loaded = load i8, ptr addrspace(3) %right.ptr, align 1
%left.valid = and i1 %m.valid, %term.valid
%right.valid = and i1 %n.valid, %term.valid
%left.value = select i1 %left.valid, i8 %left.loaded, i8 0
%right.value = select i1 %right.valid, i8 %right.loaded, i8 0
%left.fragment.next = insertelement <16 x i8> %left.fragment, i8 %left.value, i32 %fragment
%right.fragment.next = insertelement <16 x i8> %right.fragment, i8 %right.value, i32 %fragment
%fragment.next = add i32 %fragment, 1
br label %attention.matrix.gradient.fragment.loop
attention.matrix.gradient.fragment.done:
%accumulator.next = call <8 x float> @recipe.wmma(<16 x i8> %left.fragment, <16 x i8> %right.fragment, <8 x float> %accumulator)
...
%output.raw = call i8 @recipe.encode(float %output.wide)
%output.scaled = call i8 @recipe.div(i8 %output.raw, i8 %scale)
%output.value = select i1 %unscaled, i8 %output.raw, i8 %output.scaled
...
%output.index = add i32 %output.row, %output.local
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %previous, i32 %output.index
store i8 %output.value, ptr addrspace(1) %output.ptr, align 1
...
%stage.vector.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %stage.vector.input.index
%stage.vector.input.value = load <16 x i8>, ptr addrspace(1) %stage.vector.input.ptr, align 1
...
%stage.vector.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %stage.vector.delta.index
%stage.vector.delta.value = load <16 x i8>, ptr addrspace(1) %stage.vector.delta.ptr, align 1
br label %attention.matrix.stage.vector.store
attention.matrix.stage.vector.store:
%stage.vector.value = phi <16 x i8> [ %stage.vector.input.value, %attention.matrix.stage.vector.input ], [ %stage.vector.delta.value, %attention.matrix.stage.vector.delta ]
call void @contraction_stage_column16(<16 x i8> %stage.vector.value, i32 %stage.shared.base, i32 %stage.position, i32 %stage.channel.local, i32 %head.width)
%stage.vector.position.next = add i32 %stage.position, 16
...
%stage.scalar.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %stage.scalar.input.index
%stage.scalar.input.value = load i8, ptr addrspace(1) %stage.scalar.input.ptr, align 1
...
%stage.scalar.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %stage.scalar.delta.index
%stage.scalar.delta.value = load i8, ptr addrspace(1) %stage.scalar.delta.ptr, align 1
br label %attention.matrix.stage.scalar.store
attention.matrix.stage.scalar.store:
%stage.scalar.value = phi i8 [ %stage.scalar.input.value, %attention.matrix.stage.scalar.input ], [ %stage.scalar.delta.value, %attention.matrix.stage.scalar.delta ]
%stage.scalar.row = mul i32 %stage.position, %head.width
%stage.scalar.local = add i32 %stage.scalar.row, %stage.channel.local
%stage.scalar.index.shared = add i32 %stage.shared.base, %stage.scalar.local
%stage.scalar.ptr.shared = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %stage.scalar.index.shared
...
%d.sum = phi i8 [ 0, %attention.matrix.d.loop ], [ %d.sum.next, %attention.matrix.d.sum.step ]
...
%d.do.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %d.do.index
%d.do = load i8, ptr addrspace(3) %d.do.ptr, align 1
...
%d.output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %d.output.index
%d.output = load i8, ptr addrspace(1) %d.output.ptr, align 1
%d.term = call i8 @recipe.mul(i8 %d.do, i8 %d.output)
%d.sum.next = call i8 @recipe.add(i8 %d.sum, i8 %d.term)
...
%d.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %d.index
store i8 %d.sum, ptr addrspace(3) %d.ptr, align 1
...
%matrix.do.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x i8>, ptr addrspace(3) %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.v.index
%matrix.v.fragment = load <16 x i8>, ptr addrspace(3) %matrix.v.ptr, align 2
%matrix.score.accumulator.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.q.fragment, <16 x i8> %matrix.k.fragment, <8 x float> %matrix.score.accumulator)
%matrix.dp.accumulator.next = call <8 x float> @recipe.wmma(<16 x i8> %matrix.do.fragment, <16 x i8> %matrix.v.fragment, <8 x float> %matrix.dp.accumulator)
%matrix.width.next = add i32 %matrix.width, 16
br label %attention.matrix.score.width.loop
...
%matrix.score.raw = call i8 @recipe.encode(float %matrix.score.wide)
%matrix.score = call i8 @recipe.div(i8 %matrix.score.raw, i8 %scale)
%matrix.dp.wide = extractelement <8 x float> %matrix.dp.accumulator, i32 %matrix.output
%matrix.dp = call i8 @recipe.encode(float %matrix.dp.wide)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.statistics.base = mul i32 %head.job, %length
%matrix.statistics.index = add i32 %matrix.statistics.base, %matrix.query
%matrix.maximum.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %matrix.statistics.index
%matrix.maximum = load i8, ptr addrspace(1) %matrix.maximum.ptr, align 1
%matrix.denominator.index = add i32 %statistics.rows, %matrix.statistics.index
%matrix.denominator.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %matrix.denominator.index
%matrix.denominator = load i8, ptr addrspace(1) %matrix.denominator.ptr, align 1
%matrix.centered = call i8 @recipe.sub(i8 %matrix.score, i8 %matrix.maximum)
%matrix.exponential = call i8 @recipe.exp(i8 %matrix.centered)
%matrix.probability.raw = call i8 @recipe.div(i8 %matrix.exponential, i8 %matrix.denominator)
%matrix.probability = select i1 %matrix.causal, i8 %matrix.probability.raw, i8 0
%matrix.d.index = add i32 %d.base, %matrix.query
%matrix.d.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.d.index
%matrix.d = load i8, ptr addrspace(3) %matrix.d.ptr, align 1
%matrix.dp.centered = call i8 @recipe.sub(i8 %matrix.dp, i8 %matrix.d)
%matrix.derivative = call i8 @recipe.mul(i8 %matrix.probability, i8 %matrix.dp.centered)
%matrix.pair.row = mul i32 %matrix.query, %length
%matrix.pair.local = add i32 %matrix.pair.row, %matrix.k
%matrix.p.index = add i32 %p.base, %matrix.pair.local
%matrix.p.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.p.index
store i8 %matrix.probability, ptr addrspace(3) %matrix.p.ptr, align 1
%matrix.ds.index = add i32 %ds.base, %matrix.pair.local
%matrix.ds.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %matrix.ds.index
store i8 %matrix.derivative, ptr addrspace(3) %matrix.ds.ptr, align 1
...
call void @llvm.amdgcn.s.barrier()
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 0, i32 %ds.base, i32 %k.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 1, i32 %ds.base, i32 %q.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 2, i32 %p.base, i32 %do.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i8 %scale, i32 %lid, i32 %block)
call void @llvm.amdgcn.s.barrier()
...
%dq.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %dq.input.index
%dq.query.value = load i8, ptr addrspace(1) %dq.input.ptr, align 1
%dq.query.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.query.p
store i8 %dq.query.value, ptr addrspace(3) %dq.query.shared.ptr, align 1
%dq.delta.index = add i32 %dq.output.row, %dq.local
%dq.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %dq.delta.index
%dq.delta.value = load i8, ptr addrspace(1) %dq.delta.ptr, align 1
%dq.delta.shared.index = add i32 %dq.delta.base.shared, %dq.query.p
%dq.delta.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.delta.shared.index
store i8 %dq.delta.value, ptr addrspace(3) %dq.delta.shared.ptr, align 1
%dq.gradient.shared.index = add i32 %dq.gradient.base.shared, %dq.query.p
%dq.gradient.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.gradient.shared.index
store i8 0, ptr addrspace(3) %dq.gradient.shared.ptr, align 1
...
%dq.key.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %dq.key.input.index
%dq.key.value = load i8, ptr addrspace(1) %dq.key.input.ptr, align 1
%dq.key.shared.index = add i32 %dq.key.base.shared, %dq.key.p
%dq.key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.key.shared.index
store i8 %dq.key.value, ptr addrspace(3) %dq.key.shared.ptr, align 1
...
%dq.value.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %dq.value.input.index
%dq.value.value = load i8, ptr addrspace(1) %dq.value.input.ptr, align 1
%dq.value.shared.index = add i32 %dq.value.base.shared, %dq.key.p
%dq.value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.value.shared.index
store i8 %dq.value.value, ptr addrspace(3) %dq.value.shared.ptr, align 1
...
%dq.accumulate.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.accumulate.gradient.index
%dq.accumulate.initial = load i8, ptr addrspace(3) %dq.accumulate.gradient.ptr, align 1
...
%dq.accumulate.value = phi i8 [ %dq.accumulate.initial, %dq.accumulate.prepare ], [ %dq.accumulate.next, %dq.accumulate.key.step ]
...
%dq.accumulate.pair.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.accumulate.pair.index
%dq.accumulate.ds = load i8, ptr addrspace(3) %dq.accumulate.pair.ptr, align 1
...
%dq.accumulate.key.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.accumulate.key.index
%dq.accumulate.key.value = load i8, ptr addrspace(3) %dq.accumulate.key.ptr, align 1
%dq.accumulate.raw = call i8 @recipe.mul(i8 %dq.accumulate.ds, i8 %dq.accumulate.key.value)
%dq.accumulate.term = call i8 @recipe.div(i8 %dq.accumulate.raw, i8 %scale)
%dq.accumulate.next = call i8 @recipe.add(i8 %dq.accumulate.value, i8 %dq.accumulate.term)
%dq.accumulate.key.next = add i32 %dq.accumulate.key, 1
br label %dq.accumulate.key.loop
dq.accumulate.store:
store i8 %dq.accumulate.value, ptr addrspace(3) %dq.accumulate.gradient.ptr, align 1
...
%dq.store.ptr = getelementptr inbounds i8, ptr addrspace(1) %previous, i32 %dq.store.index
%dq.store.shared.index = add i32 %dq.gradient.base.shared, %dq.store.p
%dq.store.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dq.store.shared.index
%dq.store.value = load i8, ptr addrspace(3) %dq.store.shared.ptr, align 1
store i8 %dq.store.value, ptr addrspace(1) %dq.store.ptr, align 1
...
%dkv.key.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %dkv.key.input.index
%dkv.key.value = load i8, ptr addrspace(1) %dkv.key.input.ptr, align 1
%dkv.key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.key.p
store i8 %dkv.key.value, ptr addrspace(3) %dkv.key.shared.ptr, align 1
...
%dkv.value.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %dkv.value.input.index
%dkv.value.value = load i8, ptr addrspace(1) %dkv.value.input.ptr, align 1
%dkv.value.shared.index = add i32 %dkv.value.base.shared, %dkv.key.p
%dkv.value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.value.shared.index
store i8 %dkv.value.value, ptr addrspace(3) %dkv.value.shared.ptr, align 1
%dkv.key.gradient.index = add i32 %dkv.key.gradient.base.shared, %dkv.key.p
%dkv.key.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.key.gradient.index
store i8 0, ptr addrspace(3) %dkv.key.gradient.ptr, align 1
%dkv.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.key.p
%dkv.value.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.value.gradient.index
store i8 0, ptr addrspace(3) %dkv.value.gradient.ptr, align 1
...
%dkv.query.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %dkv.query.input.index
%dkv.query.value = load i8, ptr addrspace(1) %dkv.query.input.ptr, align 1
%dkv.query.shared.index = add i32 %dkv.query.base.shared, %dkv.query.p
%dkv.query.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.query.shared.index
store i8 %dkv.query.value, ptr addrspace(3) %dkv.query.shared.ptr, align 1
%dkv.delta.input.index = add i32 %dkv.output.row, %dkv.query.input.local
%dkv.delta.input.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %dkv.delta.input.index
%dkv.delta.value = load i8, ptr addrspace(1) %dkv.delta.input.ptr, align 1
%dkv.delta.shared.index = add i32 %dkv.delta.base.shared, %dkv.query.p
%dkv.delta.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.delta.shared.index
store i8 %dkv.delta.value, ptr addrspace(3) %dkv.delta.shared.ptr, align 1
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.accumulate.key.gradient.index
%dkv.accumulate.key.initial = load i8, ptr addrspace(3) %dkv.accumulate.key.gradient.ptr, align 1
%dkv.accumulate.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.accumulate.p
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.accumulate.value.gradient.index
%dkv.accumulate.value.initial = load i8, ptr addrspace(3) %dkv.accumulate.value.gradient.ptr, align 1
...
%dkv.accumulate.key.value = phi i8 [ %dkv.accumulate.key.initial, %dkv.accumulate.prepare ], [ %dkv.accumulate.key.next, %dkv.accumulate.query.step ]
%dkv.accumulate.value.value = phi i8 [ %dkv.accumulate.value.initial, %dkv.accumulate.prepare ], [ %dkv.accumulate.value.next, %dkv.accumulate.query.step ]
...
%dkv.accumulate.probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.accumulate.probability.index
%dkv.accumulate.probability = load i8, ptr addrspace(3) %dkv.accumulate.probability.ptr, align 1
%dkv.accumulate.derivative.index = add i32 %dkv.derivative.base.shared, %dkv.accumulate.pair.local
%dkv.accumulate.derivative.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.accumulate.derivative.index
%dkv.accumulate.derivative = load i8, ptr addrspace(3) %dkv.accumulate.derivative.ptr, align 1
...
%dkv.accumulate.query.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.accumulate.query.index
%dkv.accumulate.query.value = load i8, ptr addrspace(3) %dkv.accumulate.query.ptr, align 1
%dkv.accumulate.delta.index = add i32 %dkv.delta.base.shared, %dkv.accumulate.query.local
%dkv.accumulate.delta.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.accumulate.delta.index
%dkv.accumulate.delta = load i8, ptr addrspace(3) %dkv.accumulate.delta.ptr, align 1
%dkv.accumulate.key.raw = call i8 @recipe.mul(i8 %dkv.accumulate.derivative, i8 %dkv.accumulate.query.value)
%dkv.accumulate.key.term = call i8 @recipe.div(i8 %dkv.accumulate.key.raw, i8 %scale)
%dkv.accumulate.key.next = call i8 @recipe.add(i8 %dkv.accumulate.key.value, i8 %dkv.accumulate.key.term)
%dkv.accumulate.value.term = call i8 @recipe.mul(i8 %dkv.accumulate.probability, i8 %dkv.accumulate.delta)
%dkv.accumulate.value.next = call i8 @recipe.add(i8 %dkv.accumulate.value.value, i8 %dkv.accumulate.value.term)
%dkv.accumulate.query.next = add i32 %dkv.accumulate.query, 1
br label %dkv.accumulate.query.loop
dkv.accumulate.store:
store i8 %dkv.accumulate.key.value, ptr addrspace(3) %dkv.accumulate.key.gradient.ptr, align 1
store i8 %dkv.accumulate.value.value, ptr addrspace(3) %dkv.accumulate.value.gradient.ptr, align 1
...
%dkv.store.key.ptr = getelementptr inbounds i8, ptr addrspace(1) %previous, i32 %dkv.store.key.index
%dkv.store.key.shared.index = add i32 %dkv.key.gradient.base.shared, %dkv.store.p
%dkv.store.key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.store.key.shared.index
%dkv.store.key.value = load i8, ptr addrspace(3) %dkv.store.key.shared.ptr, align 1
store i8 %dkv.store.key.value, ptr addrspace(1) %dkv.store.key.ptr, align 1
...
%dkv.store.value.ptr = getelementptr inbounds i8, ptr addrspace(1) %previous, i32 %dkv.store.value.index
%dkv.store.value.shared.index = add i32 %dkv.value.gradient.base.shared, %dkv.store.p
%dkv.store.value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %dkv.store.value.shared.index
%dkv.store.value.value = load i8, ptr addrspace(3) %dkv.store.value.shared.ptr, align 1
store i8 %dkv.store.value.value, ptr addrspace(1) %dkv.store.value.ptr, align 1
...
%precompute.weights = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %precompute.weight.offset
%precompute.context.offset = mul i32 %precompute.gate, %gate.batch
%precompute.context = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %precompute.context.offset
...
%input.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %input.index
%input.sum = load i8, ptr addrspace(1) %input.ptr, align 1 br label %state.sum.loop state.sum.loop:
%state.channel = phi i32 [ 0, %input.load ], [ %state.next, %state.sum.step ]
%state.sum = phi i8 [ %input.sum, %input.load ], [ %state.sum.next, %state.sum.step ]
...
%previous.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %previous.index
%previous.loaded = load i8, ptr addrspace(1) %previous.ptr, align 1
%previous = select i1 %previous.exists, i8 %previous.loaded, i8 0 %candidate.gate = icmp eq i32 %gate, 2
...
%reset.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %reset.base
%reset = load i8, ptr addrspace(1) %reset.ptr, align 1 %reset.state = call i8 @recipe.mul(i8 %reset, i8 %previous)
%state.value = select i1 %reset.candidate, i8 %reset.state, i8 %previous
...
%state.weight.ptr = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %state.weight.index
%state.weight = load i8, ptr addrspace(1) %state.weight.ptr, align 1
%state.product = call i8 @recipe.mul(i8 %state.value, i8 %state.weight) %state.sum.next = call i8 @recipe.add(i8 %state.sum, i8 %state.product)
...
%bias.ptr = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %bias.index
%bias = load i8, ptr addrspace(1) %bias.ptr, align 1 %linear = call i8 @recipe.add(i8 %state.sum, i8 %bias)
%rnn = icmp eq i32 %gates, 1 %last.gate = sub i32 %gates, 1 %candidate = icmp eq i32 %gate, %last.gate
%use.tanh = or i1 %rnn, %candidate %tanh.value = call i8 @recipe.tanh(i8 %linear)
%sigmoid.value = call i8 @sigmoid(i8 %linear)
%gate.value = select i1 %use.tanh, i8 %tanh.value, i8 %sigmoid.value br label %gate.store gate.store:
...
%gate.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gate.index
store i8 %gate.value, ptr addrspace(1) %gate.ptr, align 1 %hidden.next = add nuw i32 %hidden, 1
...
%output.index = add i32 %output.row.base, %output.local
%gate0.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %output.index
%gate0 = load i8, ptr addrspace(1) %gate0.ptr, align 1
...
%gate1.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gate1.index
%gate1 = load i8, ptr addrspace(1) %gate1.ptr, align 1 %gate2.base = mul i32 %gate.batch, 2
...
%gate2.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gate2.index
%gate2 = load i8, ptr addrspace(1) %gate2.ptr, align 1 %gate3.base = mul i32 %gate.batch, 3
%gate3.raw = add i32 %gate3.base, %output.index %gate3.index = select i1 %is.lstm, i32 %gate3.raw, i32 %output.index
%gate3.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gate3.index
%gate3 = load i8, ptr addrspace(1) %gate3.ptr, align 1 %output.previous.time = sub i32 %time, 1
...
%output.previous.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %output.previous.index
%output.previous.loaded = load i8, ptr addrspace(1) %output.previous.ptr, align 1
%output.previous = select i1 %previous.exists, i8 %output.previous.loaded, i8 0
%one.update = call i8 @recipe.sub(i8 1, i8 %gate0) %gru.old = call i8 @recipe.mul(i8 %gate0, i8 %output.previous)
%gru.new = call i8 @recipe.mul(i8 %one.update, i8 %gate2) %gru.value = call i8 @recipe.add(i8 %gru.old, i8 %gru.new)
...
%cell.previous.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %cell.previous.index
%cell.previous.loaded = load i8, ptr addrspace(1) %cell.previous.ptr, align 1
%cell.previous = select i1 %previous.exists, i8 %cell.previous.loaded, i8 0
%cell.old = call i8 @recipe.mul(i8 %gate1, i8 %cell.previous) %cell.new = call i8 @recipe.mul(i8 %gate0, i8 %gate3)
%cell = call i8 @recipe.add(i8 %cell.old, i8 %cell.new)
%cell.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %cell.index
store i8 %cell, ptr addrspace(1) %cell.ptr, align 1 %cell.tanh = call i8 @recipe.tanh(i8 %cell)
%lstm.value = call i8 @recipe.mul(i8 %gate2, i8 %cell.tanh)
%rnn.or.gru = select i1 %is.gru, i8 %gru.value, i8 %gate0
%output.value = select i1 %is.lstm, i8 %lstm.value, i8 %rnn.or.gru br label %output.store output.store:
%output.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %output.index
store i8 %output.value, ptr addrspace(1) %output.ptr, align 1 %output.next = add nuw i32 %output.hidden, 1
...
%gradient.scratch = getelementptr inbounds i8, ptr addrspace(1) %gradient, i32 RECIPE_GRADIENT_SCRATCH_BASE
...
%gradient.a.vector.source = getelementptr inbounds i8, ptr addrspace(1) %input, i32 %gradient.a.vector.index
%gradient.a.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr addrspace(1) %gradient.a.vector.source, align 1
call void @contraction_stage_a_columns(<RECIPE_FRAGMENT_K x i8> %gradient.a.vector.value, i32 %gradient.a.r, i32 %gradient.a.m, i32 %gradient.tile.m, i32 %gradient.tile.k)
br label %gradient.load.advance
gradient.load.a.scalar:
%gradient.a.value = call i8 @contraction_input( ptr addrspace(1) %input, i32 %gradient.a.row.base, i32 %gradient.a.position, i32 %gradient.a.term, i32 %span, i32 %in.length, i1 %is.conv )
...
%gradient.b.vector.value = call <RECIPE_FRAGMENT_K x i8> @contraction_delta_vector16(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %gradient.b.index, i1 %relu)
call void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x i8> %gradient.b.vector.value, i32 %gradient.b.r, i32 %gradient.b.n, i32 %gradient.tile.m, i32 %gradient.tile.n, i32 %gradient.tile.k)
br label %gradient.load.advance
gradient.load.b.scalar:
%gradient.b.value = call i8 @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %gradient.b.index, i1 %relu)
br label %gradient.load.store
gradient.load.store: %gradient.load.value = phi i8 [ %gradient.a.value, %gradient.load.a.scalar ], [ %gradient.b.value, %gradient.load.b.scalar ] %gradient.load.index = phi i32 [ %gradient.a.tile.index, %gradient.load.a.scalar ], [ %gradient.b.tile.index, %gradient.load.b.scalar ]
%gradient.load.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %gradient.load.index store i8 %gradient.load.value, ptr addrspace(3) %gradient.load.ptr, align 1
br label %gradient.load.advance
...
%gradient.store.ptr = getelementptr inbounds i8, ptr addrspace(1) %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr addrspace(5) %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load float, ptr addrspace(5) %gradient.store.sum.ptr, align 4 %gradient.store.sum = call i8 @recipe.encode(float %gradient.store.sum.wide) store i8 %gradient.store.sum, ptr addrspace(1) %gradient.store.ptr, align 1
...
%previous.a.vector.delta = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %previous.a.index
%previous.a.vector.output = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %previous.a.index
%previous.a.vector.delta.value = load <RECIPE_FRAGMENT_K x i8>, ptr addrspace(1) %previous.a.vector.delta, align 1
%previous.a.vector.output.value = load <RECIPE_FRAGMENT_K x i8>, ptr addrspace(1) %previous.a.vector.output, align 1
call void @contraction_stage_delta_a_fragment(<RECIPE_FRAGMENT_K x i8> %previous.a.vector.delta.value, <RECIPE_FRAGMENT_K x i8> %previous.a.vector.output.value, i1 %relu, i32 %previous.a.r, i32 %previous.a.m, i32 %previous.tile.m, i32 %previous.tile.k)
br label %previous.load.advance
previous.load.a.scalar:
%previous.a.raw = call i8 @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %previous.a.index, i1 %relu)
%previous.a.value = select i1 %previous.a.valid, i8 %previous.a.raw, i8 0
...
%previous.b.vector.source = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %previous.b.index
%previous.b.vector.value = load <RECIPE_FRAGMENT_K x i8>, ptr addrspace(1) %previous.b.vector.source, align 1
call void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x i8> %previous.b.vector.value, i32 %previous.b.r, i32 %previous.b.n, i32 %previous.tile.m, i32 %previous.tile.n, i32 %previous.tile.k)
br label %previous.load.advance
previous.load.b.scalar:
%previous.b.ptr = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %previous.b.index
%previous.b.value = load i8, ptr addrspace(1) %previous.b.ptr, align 1
br label %previous.load.store
previous.load.store: %previous.load.value = phi i8 [ %previous.a.value, %previous.load.a.scalar ], [ %previous.b.value, %previous.load.b.scalar ] %previous.load.index = phi i32 [ %previous.a.tile.index, %previous.load.a.scalar ], [ %previous.b.tile.index, %previous.load.b.scalar ]
%previous.load.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int8, i32 0, i32 %previous.load.index store i8 %previous.load.value, ptr addrspace(3) %previous.load.ptr, align 1
br label %previous.load.advance
...
%previous.store.row.base = mul i32 %previous.store.row, %in.elements %previous.store.channel.base = mul i32 %previous.store.channel, %in.length %previous.store.local = add i32 %previous.store.channel.base, %previous.store.position %previous.store.index = add i32 %previous.store.row.base, %previous.store.local %previous.store.ptr = getelementptr inbounds i8, ptr addrspace(1) %previous, i32 %previous.store.index
%previous.store.old = load i8, ptr addrspace(1) %previous.store.ptr, align 1 %previous.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr addrspace(5) %sums, i32 0, i32 %previous.store.register %previous.store.sum.wide = load float, ptr addrspace(5) %previous.store.sum.ptr, align 4 %previous.store.sum = call i8 @recipe.encode(float %previous.store.sum.wide) %previous.store.value = call i8 @recipe.add(i8 %previous.store.old, i8 %previous.store.sum) store i8 %previous.store.value, ptr addrspace(1) %previous.store.ptr, align 1 br label %previous.store.next
...
%clear.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %clear.index
store i8 0, ptr addrspace(1) %clear.ptr, align 1 %clear.next = add nuw i32 %clear.p, 1
...
%clear.dh.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %clear.dh.index
%clear.dc.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %clear.dc.index
store i8 0, ptr addrspace(1) %clear.dh.ptr, align 1 store i8 0, ptr addrspace(1) %clear.dc.ptr, align 1
...
%rnn.index = add i32 %row.output.base, %rnn.local %rnn.dy.ptr = getelementptr inbounds i8,
ptr addrspace(1) %delta, i32 %rnn.index %rnn.future.index = add i32 %dh.start, %rnn.hidden
%rnn.future.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %rnn.future.index
%rnn.gate.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %rnn.index
%rnn.dy = load i8, ptr addrspace(1) %rnn.dy.ptr, align 1
%rnn.future = load i8, ptr addrspace(1) %rnn.future.ptr, align 1
%rnn.gate = load i8, ptr addrspace(1) %rnn.gate.ptr, align 1 %rnn.dh = call i8 @recipe.add(i8 %rnn.dy, i8 %rnn.future)
%rnn.square = call i8 @recipe.mul(i8 %rnn.gate, i8 %rnn.gate) %rnn.derivative = call i8 @recipe.sub(i8 1, i8 %rnn.square)
%rnn.delta = call i8 @recipe.mul(i8 %rnn.dh, i8 %rnn.derivative) %rnn.delta.index = add i32 %delta.base, %rnn.index
%rnn.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %rnn.delta.index
store i8 %rnn.delta, ptr addrspace(1) %rnn.delta.ptr, align 1 %rnn.next = add i32 %rnn.hidden, 1
...
%gru.dy.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %gru.index
%gru.future.index = add i32 %dh.start, %gru.hidden
%gru.future.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.future.index
%gru.previous.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %gru.previous.index
%gru.z.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.index
%gru.n.index = add i32 %gru.index, %gate2.batch
%gru.n.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.n.index
%gru.dy = load i8, ptr addrspace(1) %gru.dy.ptr, align 1
%gru.future = load i8, ptr addrspace(1) %gru.future.ptr, align 1
%gru.previous.loaded = load i8, ptr addrspace(1) %gru.previous.ptr, align 1
%gru.previous = select i1 %previous.exists, i8 %gru.previous.loaded, i8 0
%gru.z = load i8, ptr addrspace(1) %gru.z.ptr, align 1
%gru.n = load i8, ptr addrspace(1) %gru.n.ptr, align 1 %gru.dh = call i8 @recipe.add(i8 %gru.dy, i8 %gru.future)
%gru.one.z = call i8 @recipe.sub(i8 1, i8 %gru.z) %gru.z.difference = call i8 @recipe.sub(i8 %gru.previous, i8 %gru.n)
%gru.dz.0 = call i8 @recipe.mul(i8 %gru.dh, i8 %gru.z.difference) %gru.dz.1 = call i8 @recipe.mul(i8 %gru.dz.0, i8 %gru.z)
%gru.dz = call i8 @recipe.mul(i8 %gru.dz.1, i8 %gru.one.z) %gru.n.square = call i8 @recipe.mul(i8 %gru.n, i8 %gru.n)
%gru.n.derivative = call i8 @recipe.sub(i8 1, i8 %gru.n.square) %gru.dn.0 = call i8 @recipe.mul(i8 %gru.dh, i8 %gru.one.z)
%gru.dn = call i8 @recipe.mul(i8 %gru.dn.0, i8 %gru.n.derivative) %gru.dz.index = add i32 %delta.base, %gru.index
%gru.dn.index.0 = add i32 %delta.base, %gate2.batch %gru.dn.index = add i32 %gru.dn.index.0, %gru.index
%gru.dz.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.dz.index
%gru.dn.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.dn.index
store i8 %gru.dz, ptr addrspace(1) %gru.dz.ptr, align 1
store i8 %gru.dn, ptr addrspace(1) %gru.dn.ptr, align 1 %gru.next = add i32 %gru.hidden, 1
...
%gru.reset.sum = phi i8 [ 0, %gru.reset.loop ], [ %gru.reset.sum.next, %gru.reset.sum.step ]
...
%gru.weight.ptr = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %gru.weight.index
...
%gru.target.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.target.delta.index
%gru.weight = load i8, ptr addrspace(1) %gru.weight.ptr, align 1
%gru.target.delta = load i8, ptr addrspace(1) %gru.target.delta.ptr, align 1
%gru.reset.product = call i8 @recipe.mul(i8 %gru.weight, i8 %gru.target.delta)
%gru.reset.sum.next = call i8 @recipe.add(i8 %gru.reset.sum, i8 %gru.reset.product)
...
%gru.source.previous.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %gru.source.previous.index
%gru.r.index = add i32 %batch, %gru.source.index
%gru.r.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.r.index
%gru.source.previous.loaded = load i8, ptr addrspace(1) %gru.source.previous.ptr, align 1
%gru.source.previous = select i1 %previous.exists, i8 %gru.source.previous.loaded, i8 0
%gru.r = load i8, ptr addrspace(1) %gru.r.ptr, align 1
%gru.dr = call i8 @recipe.mul(i8 %gru.reset.sum, i8 %gru.source.previous) %gru.one.r = call i8 @recipe.sub(i8 1, i8 %gru.r)
%gru.dr.0 = call i8 @recipe.mul(i8 %gru.dr, i8 %gru.r) %gru.dr.1 = call i8 @recipe.mul(i8 %gru.dr.0, i8 %gru.one.r)
%gru.dr.base = add i32 %delta.base, %batch %gru.dr.index = add i32 %gru.dr.base, %gru.source.index
%gru.dr.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %gru.dr.index
store i8 %gru.dr.1, ptr addrspace(1) %gru.dr.ptr, align 1 %gru.source.next = add i32 %gru.source, 1
...
%dy.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %index %dh.index = add i32 %dh.start, %hidden
%dc.index = add i32 %dc.start, %hidden %dh.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %dh.index
%dc.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %dc.index
%cell.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %cell.index
%cell.previous.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %cell.previous.index
%dy = load i8, ptr addrspace(1) %dy.ptr, align 1 %dh.future = load i8, ptr addrspace(1) %dh.ptr, align 1
%dc.future = load i8, ptr addrspace(1) %dc.ptr, align 1 %cell = load i8, ptr addrspace(1) %cell.ptr, align 1
%cell.previous.loaded = load i8, ptr addrspace(1) %cell.previous.ptr, align 1
%cell.previous = select i1 %previous.exists, i8 %cell.previous.loaded, i8 0
%i.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %index %f.index = add i32 %batch, %index
%o.index = add i32 %f.index, %batch %g.index = add i32 %o.index, %batch
%f.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %f.index
%o.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %o.index
%g.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %g.index
%i = load i8, ptr addrspace(1) %i.ptr, align 1 %f = load i8, ptr addrspace(1) %f.ptr, align 1
%o = load i8, ptr addrspace(1) %o.ptr, align 1 %g = load i8, ptr addrspace(1) %g.ptr, align 1
%dh = call i8 @recipe.add(i8 %dy, i8 %dh.future) %cell.tanh = call i8 @recipe.tanh(i8 %cell)
%cell.tanh.square = call i8 @recipe.mul(i8 %cell.tanh, i8 %cell.tanh) %cell.tanh.derivative = call i8 @recipe.sub(i8 1, i8 %cell.tanh.square)
%cell.chain.0 = call i8 @recipe.mul(i8 %dh, i8 %o) %cell.chain = call i8 @recipe.mul(i8 %cell.chain.0, i8 %cell.tanh.derivative)
%dc = call i8 @recipe.add(i8 %dc.future, i8 %cell.chain) %one.o = call i8 @recipe.sub(i8 1, i8 %o) %do.0 = call i8 @recipe.mul(i8 %dh, i8 %cell.tanh)
%do.1 = call i8 @recipe.mul(i8 %do.0, i8 %o) %do = call i8 @recipe.mul(i8 %do.1, i8 %one.o) %one.i = call i8 @recipe.sub(i8 1, i8 %i) %di.0 = call i8 @recipe.mul(i8 %dc, i8 %g)
%di.1 = call i8 @recipe.mul(i8 %di.0, i8 %i) %di = call i8 @recipe.mul(i8 %di.1, i8 %one.i) %one.f = call i8 @recipe.sub(i8 1, i8 %f)
%df.0 = call i8 @recipe.mul(i8 %dc, i8 %cell.previous) %df.1 = call i8 @recipe.mul(i8 %df.0, i8 %f) %df = call i8 @recipe.mul(i8 %df.1, i8 %one.f)
%g.square = call i8 @recipe.mul(i8 %g, i8 %g) %one.g.square = call i8 @recipe.sub(i8 1, i8 %g.square) %dg.0 = call i8 @recipe.mul(i8 %dc, i8 %i)
%dg = call i8 @recipe.mul(i8 %dg.0, i8 %one.g.square) %dc.previous = call i8 @recipe.mul(i8 %dc, i8 %f)
store i8 %dc.previous, ptr addrspace(1) %dc.ptr, align 1 %delta0.index = add i32 %delta.base, %index
%delta1.index = add i32 %delta0.index, %batch %delta2.index = add i32 %delta1.index, %batch
%delta3.index = add i32 %delta2.index, %batch
%delta0.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %delta0.index
%delta1.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %delta1.index
%delta2.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %delta2.index
%delta3.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %delta3.index
store i8 %di, ptr addrspace(1) %delta0.ptr, align 1 store i8 %df, ptr addrspace(1) %delta1.ptr, align 1
store i8 %do, ptr addrspace(1) %delta2.ptr, align 1 store i8 %dg, ptr addrspace(1) %delta3.ptr, align 1
...
%gate.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %delta.index
%gate.delta = load i8, ptr addrspace(1) %gate.delta.ptr, align 1
...
%state.ptr = getelementptr inbounds i8, ptr addrspace(1) %output, i32 %state.index.value
%state.loaded = load i8, ptr addrspace(1) %state.ptr, align 1
%state.value = select i1 %previous.exists, i8 %state.loaded, i8 0
...
%parameter.reset.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %parameter.reset.index
%parameter.reset = load i8, ptr addrspace(1) %parameter.reset.ptr, align 1
%parameter.reset.state = call i8 @recipe.mul(i8 %parameter.reset, i8 %state.value)
%parameter.state = select i1 %gru.candidate, i8 %parameter.reset.state, i8 %state.value
%source.value = select i1 %state.weight, i8 %parameter.state, i8 1
%contribution = call i8 @recipe.mul(i8 %source.value, i8 %gate.delta) %row.gradient.index = add i32 %row.gradient.start, %p
%row.gradient.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %row.gradient.index
%row.gradient.old = load i8, ptr addrspace(1) %row.gradient.ptr, align 1
%row.gradient.new = call i8 @recipe.add(i8 %row.gradient.old, i8 %contribution)
store i8 %row.gradient.new, ptr addrspace(1) %row.gradient.ptr, align 1
...
%state.sum = phi i8 [ 0, %hidden.gradient.loop ], [ %state.sum.next, %hidden.gradient.sum.step ]
...
%state.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %state.delta.index
%state.weight.value = load i8, ptr addrspace(1) %state.weight.ptr, align 1
%state.delta.value = load i8, ptr addrspace(1) %state.delta.ptr, align 1
%state.product = call i8 @recipe.mul(i8 %state.weight.value, i8 %state.delta.value) %state.candidate = icmp eq i32 %state.gate, 2
...
%state.reset.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %state.reset.index
%state.reset = load i8, ptr addrspace(1) %state.reset.ptr, align 1
%state.reset.product = call i8 @recipe.mul(i8 %state.product, i8 %state.reset)
%state.contribution = select i1 %state.gru.candidate, i8 %state.reset.product, i8 %state.product
%state.sum.next = call i8 @recipe.add(i8 %state.sum, i8 %state.contribution) %state.term.next = add nuw i32 %state.term, 1
br label %hidden.gradient.sum.loop hidden.gradient.store: %state.dh.index = add i32 %dh.start, %state.channel
%state.dh.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %state.dh.index
...
%state.direct.delta.ptr = getelementptr inbounds i8, ptr addrspace(1) %delta, i32 %state.direct.index
%state.direct.z.ptr = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %state.direct.index
%state.direct.dy = load i8, ptr addrspace(1) %state.direct.delta.ptr, align 1
%state.direct.future = load i8, ptr addrspace(1) %state.dh.ptr, align 1
%state.direct.z = load i8, ptr addrspace(1) %state.direct.z.ptr, align 1
%state.direct.dh = call i8 @recipe.add(i8 %state.direct.dy, i8 %state.direct.future)
%state.direct.raw = call i8 @recipe.mul(i8 %state.direct.z, i8 %state.direct.dh)
%state.direct = select i1 %gru, i8 %state.direct.raw, i8 0
%state.total = call i8 @recipe.add(i8 %state.sum, i8 %state.direct)
store i8 %state.total, ptr addrspace(1) %state.dh.ptr, align 1 %state.channel.next = add nuw i32 %state.channel, 1
...
%projection.weights = getelementptr inbounds i8, ptr addrspace(1) %weights, i32 %projection.weight.offset
%projection.delta.gate = mul i32 %projection.gate, %batch
%projection.delta.offset = add i32 %delta.base, %projection.delta.gate
%projection.delta = getelementptr inbounds i8, ptr addrspace(1) %context, i32 %projection.delta.offset
