...
%matrix.first.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.first.full, <8 x float> %matrix.first)
%matrix.second.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.second.full, <8 x float> %matrix.second)
%matrix.third.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.third.full, <8 x float> %matrix.third)
%matrix.fourth.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.fourth.full, <8 x float> %matrix.fourth)
...
%matrix.accumulator.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.q.fragment, <16 x i16> %matrix.k.fragment, <8 x float> %matrix.accumulator)
...
%accumulator.next = call <8 x float> @recipe.wmma(<16 x i16> %left.fragment, <16 x i16> %right.fragment, <8 x float> %accumulator)
...
%matrix.score.accumulator.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.q.fragment, <16 x i16> %matrix.k.fragment, <8 x float> %matrix.score.accumulator)
%matrix.dp.accumulator.next = call <8 x float> @recipe.wmma(<16 x i16> %matrix.do.fragment, <16 x i16> %matrix.v.fragment, <8 x float> %matrix.dp.accumulator)
%matrix.width.next = add i32 %matrix.width, 16
br label %attention.matrix.score.width.loop
