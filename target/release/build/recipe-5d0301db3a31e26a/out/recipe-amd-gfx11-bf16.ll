...
define internal float @recipe.decode(i16 %value) #1 { entry: %wide = zext i16 %value to i32 %bits = shl i32 %wide, 16 %result = bitcast i32 %bits to float ret float %result }
...
define internal i16 @recipe.add(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %wide = fadd float %left.wide, %right.wide %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.sub(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %wide = fsub float %left.wide, %right.wide %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.mul(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %wide = fmul float %left.wide, %right.wide %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.div(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %wide = fdiv float %left.wide, %right.wide %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.madd(i16 %sum, i16 %left, i16 %right) #1 { entry: %sum.wide = call float @recipe.decode(i16 %sum) %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %wide = call float @llvm.fma.f32(float %left.wide, float %right.wide, float %sum.wide) %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal <RECIPE_REGISTER_M x i16> @recipe.madd.vector(<RECIPE_REGISTER_M x i16> %sum, <RECIPE_REGISTER_M x i16> %left, <RECIPE_REGISTER_M x i16> %right) #1 {
entry:
br label %loop
loop:
%p = phi i32 [ 0, %entry ], [ %p.next, %step ]
%result = phi <RECIPE_REGISTER_M x i16> [ poison, %entry ], [ %next, %step ]
%more = icmp ult i32 %p, RECIPE_REGISTER_M
br i1 %more, label %step, label %done
step:
%sum.value = extractelement <RECIPE_REGISTER_M x i16> %sum, i32 %p
%left.value = extractelement <RECIPE_REGISTER_M x i16> %left, i32 %p
%right.value = extractelement <RECIPE_REGISTER_M x i16> %right, i32 %p
%value = call i16 @recipe.madd(i16 %sum.value, i16 %left.value, i16 %right.value)
%next = insertelement <RECIPE_REGISTER_M x i16> %result, i16 %value, i32 %p
%p.next = add i32 %p, 1
br label %loop
done:
ret <RECIPE_REGISTER_M x i16> %result
}
define internal i16 @recipe.neg(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %negative = fneg float %wide %result = call i16 @recipe.encode(float %negative) ret i16 %result }
define internal i1 @recipe.oeq(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp oeq float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.oge(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp oge float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ogt(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp ogt float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ole(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp ole float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.olt(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp olt float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.one(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp one float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ord(i16 %left, i16 %right) #1 { entry: %left.wide = call float @recipe.decode(i16 %left) %right.wide = call float @recipe.decode(i16 %right) %result = fcmp ord float %left.wide, %right.wide ret i1 %result }
define internal i16 @recipe.from.u1(i1 %value) #1 { entry: %wide = uitofp i1 %value to float %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.from.u32(i32 %value) #1 { entry: %wide = uitofp i32 %value to float %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.from.s32(i32 %value) #1 { entry: %wide = sitofp i32 %value to float %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i32 @recipe.to.u32(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %result = fptoui float %wide to i32 ret i32 %result }
define internal i32 @recipe.to.s32(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %result = fptosi float %wide to i32 ret i32 %result }
define internal i16 @recipe.from.f32(float %value) #1 { entry: %wide = fadd float %value, 0.0 %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal i16 @recipe.from.f16(half %value) #1 { entry: %wide = fpext half %value to float %result = call i16 @recipe.encode(float %wide) ret i16 %result }
define internal half @recipe.to.f16(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %result = fptrunc float %wide to half ret half %result }
define internal i16 @recipe.abs(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @llvm.fabs.f32(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.floor(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @llvm.floor.f32(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.sqrt(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @llvm.sqrt.f32(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.exp(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @recipe.math.exp(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.tanh(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @recipe.math.tanh(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.cos(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @recipe.math.cos(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.sin(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @recipe.math.sin(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.log(i16 %value) #1 { entry: %wide = call float @recipe.decode(i16 %value) %computed = call float @recipe.math.log(float %wide) %result = call i16 @recipe.encode(float %computed) ret i16 %result }
define internal i16 @recipe.sigmoid(i16 %value) #1 { entry: %negative = call i16 @recipe.neg(i16 %value) %exponential = call i16 @recipe.exp(i16 %negative) %one = call i16 @recipe.from.u1(i1 true) %denominator = call i16 @recipe.add(i16 %exponential, i16 %one) %result = call i16 @recipe.div(i16 %one, i16 %denominator) ret i16 %result }
...
define internal float @recipe.state.from.model(i16 %value) #1 { entry: %result = call float @recipe.decode(i16 %value) ret float %result }
define internal i16 @recipe.model.from.state(float %value) #1 { entry: %result = call i16 @recipe.encode(float %value) ret i16 %result }
; NUMERIC END
declare i32 @llvm.amdgcn.workitem.id.x()
declare void @llvm.amdgcn.s.barrier() declare i64 @__ockl_steadyctr_u64()
declare void @llvm.trap() @contraction_tile_bf16 = external addrspace(3) global [0 x i16], align 16
define internal i16 @contraction_input(
...
%index = add i32 %row.base, %local %ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %index
%value = load i16, ptr addrspace(1) %ptr, align 2 ret i16 %value }
define internal i16 @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %index
%delta.value = load i16, ptr addrspace(1) %delta.ptr, align 2
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %index
%output.value = load i16, ptr addrspace(1) %output.ptr, align 2
%positive = call i1 @recipe.ogt(i16 %output.value, i16 0)
%activated = select i1 %positive, i16 %delta.value, i16 0
br label %done
done:
%value = phi i16 [ %delta.value, %entry ], [ %activated, %activation ]
ret i16 %value
}
define internal <16 x i16> @contraction_delta_vector16(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %index
%delta.value = load <16 x i16>, ptr addrspace(1) %delta.ptr, align 2
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %index
%output.value = load <16 x i16>, ptr addrspace(1) %output.ptr, align 2
br label %activation.loop
activation.loop:
%activation.index = phi i32 [ 0, %activation ], [ %activation.next, %activation.step ]
%activation.values = phi <16 x i16> [ zeroinitializer, %activation ], [ %activation.values.next, %activation.step ]
%activation.more = icmp ult i32 %activation.index, 16
br i1 %activation.more, label %activation.step, label %done
activation.step:
%activation.output = extractelement <16 x i16> %output.value, i32 %activation.index
%activation.delta = extractelement <16 x i16> %delta.value, i32 %activation.index
%activation.positive = call i1 @recipe.ogt(i16 %activation.output, i16 0)
%activation.value = select i1 %activation.positive, i16 %activation.delta, i16 0
%activation.values.next = insertelement <16 x i16> %activation.values, i16 %activation.value, i32 %activation.index
%activation.next = add i32 %activation.index, 1
br label %activation.loop
done:
%value = phi <16 x i16> [ %delta.value, %entry ], [ %activation.values, %activation.loop ]
ret <16 x i16> %value
}
...
%target.ptr = getelementptr inbounds i16, ptr addrspace(1) %target, i32 %target.index
%source.first.index = add i32 %source.offset, %parameter
%source.first.ptr = getelementptr inbounds i16, ptr addrspace(1) %source, i32 %source.first.index
%source.first = load i16, ptr addrspace(1) %source.first.ptr, align 2
br label %row.loop
row.loop:
%row = phi i32 [ 1, %seed.load ], [ %row.next, %row.step ]
%sum = phi i16 [ %source.first, %seed.load ], [ %sum.next, %row.step ]
...
%source.ptr = getelementptr inbounds i16, ptr addrspace(1) %source, i32 %source.index
%source.value = load i16, ptr addrspace(1) %source.ptr, align 2
%sum.next = call i16 @recipe.add(i16 %sum, i16 %source.value)
%row.next = add i32 %row, 1
br label %row.loop
store:
store i16 %sum, ptr addrspace(1) %target.ptr, align 2
...
define internal void @contraction_stage_column16(<16 x i16> %values, i32 %base, i32 %r, i32 %column, i32 %stride) #1 {
entry:
br label %loop
loop:
...
br i1 %more, label %step, label %done
step:
%value = extractelement <16 x i16> %values, i32 %j
%row.local = add i32 %r, %j
%row = mul i32 %row.local, %stride
%local = add i32 %row, %column
%index = add i32 %base, %local
%ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
store i16 %value, ptr addrspace(3) %ptr, align 2
%j.next = add i32 %j, 1
br label %loop
done:
ret void
...
%ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
store i16 0, ptr addrspace(3) %ptr, align 2
%next = add i32 %p, %block
br label %loop
exit:
ret void
}
define internal <RECIPE_REGISTER_M x i16> @contraction_a_fragment(i32 %k, i32 %output.m.base, i32 %tile.m, i32 %tile.k) #1 {
entry:
%index = call i32 @contraction_matrix_a_index(i32 %k, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_M x i16>, ptr addrspace(3) %ptr, align 2
ret <RECIPE_REGISTER_M x i16> %fragment
}
define internal <RECIPE_REGISTER_N x i16> @contraction_b_fragment(i32 %k, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
%local = call i32 @contraction_matrix_b_index(i32 %k, i32 %output.n.base, i32 %tile.n, i32 %tile.k)
%index = add i32 %base, %local
%ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_N x i16>, ptr addrspace(3) %ptr, align 2
ret <RECIPE_REGISTER_N x i16> %fragment
}
define internal void @contraction_stage_a_fragment(<RECIPE_FRAGMENT_K x i16> %fragment, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
...
%value = extractelement <RECIPE_FRAGMENT_K x i16> %fragment, i32 %element
%target = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
store i16 %value, ptr addrspace(3) %target, align 2
%next = add i32 %element, 1
br label %loop
exit:
ret void
}
define internal void @contraction_stage_a_columns(<RECIPE_FRAGMENT_K x i16> %fragment, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
%element = phi i32 [ 0, %entry ], [ %next, %step ]
...
define internal void @contraction_stage_b_terms(<RECIPE_FRAGMENT_K x i16> %fragment, i32 %k, i32 %n, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
br label %loop
loop:
...
define internal void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x i16> %fragment, i32 %k, i32 %n, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
br label %loop
loop:
...
define internal void @contraction_stage_delta_a_fragment(<RECIPE_FRAGMENT_K x i16> %delta, <RECIPE_FRAGMENT_K x i16> %output, i1 %relu, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
%element = phi i32 [ 0, %entry ], [ %next, %step ]
...
br i1 %more, label %step, label %exit
step:
%delta.value = extractelement <RECIPE_FRAGMENT_K x i16> %delta, i32 %element
%output.value = extractelement <RECIPE_FRAGMENT_K x i16> %output, i32 %element
%positive = call i1 @recipe.ogt(i16 %output.value, i16 0)
%active = select i1 %positive, i16 %delta.value, i16 0
%value = select i1 %relu, i16 %active, i16 %delta.value
%local.k = add i32 %k, %element
%index = call i32 @contraction_matrix_a_index(i32 %local.k, i32 %m, i32 %tile.m, i32 %tile.k)
%target = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
store i16 %value, ptr addrspace(3) %target, align 2
...
%local.a.initial = call <RECIPE_REGISTER_M x i16> @contraction_a_fragment(i32 0, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%local.b.initial = call <RECIPE_REGISTER_N x i16> @contraction_b_fragment(i32 0, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
...
%local.a.fragment = phi <RECIPE_REGISTER_M x i16> [ %local.a.initial, %local.k.begin ], [ %local.a.next, %local.product.done ]
%local.b.fragment = phi <RECIPE_REGISTER_N x i16> [ %local.b.initial, %local.k.begin ], [ %local.b.next, %local.product.done ]
...
%local.a.next = call <RECIPE_REGISTER_M x i16> @contraction_a_fragment(i32 %local.k.prefetch, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%local.b.next = call <RECIPE_REGISTER_N x i16> @contraction_b_fragment(i32 %local.k.prefetch, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
%local.a.wide = call <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x i16> %local.a.fragment)
...
%local.b = extractelement <RECIPE_REGISTER_N x i16> %local.b.fragment, i32 %local.b.index
%local.b.wide = call float @recipe.decode(i16 %local.b)
...
%a.initial = call <RECIPE_REGISTER_M x i16> @contraction_a_fragment(i32 %k.first, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%b.initial = call <RECIPE_REGISTER_N x i16> @contraction_b_fragment(i32 %k.first, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
br label %k.loop
k.loop:
%k = phi i32 [ %k.first, %k.begin ], [ %k.next, %register.done ]
%a.fragment = phi <RECIPE_REGISTER_M x i16> [ %a.initial, %k.begin ], [ %a.next, %register.done ]
%b.fragment = phi <RECIPE_REGISTER_N x i16> [ %b.initial, %k.begin ], [ %b.next, %register.done ]
%k.next = add i32 %k, 1
%k.more = icmp ult i32 %k.next, %k.limit
%k.prefetch = select i1 %k.more, i32 %k.next, i32 %k
%a.next = call <RECIPE_REGISTER_M x i16> @contraction_a_fragment(i32 %k.prefetch, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%b.next = call <RECIPE_REGISTER_N x i16> @contraction_b_fragment(i32 %k.prefetch, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
%a.wide = call <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x i16> %a.fragment)
...
%b = extractelement <RECIPE_REGISTER_N x i16> %b.fragment, i32 %register.n
%b.wide = call float @recipe.decode(i16 %b)
...
%publish.target = getelementptr float, ptr addrspace(3) @contraction_tile_bf16, i32 %publish.target.index
...
%fold.source = getelementptr float, ptr addrspace(3) @contraction_tile_bf16, i32 %fold.source.index
...
%ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %index
%raw = load i16, ptr addrspace(3) %ptr, align 2 %value = call float @recipe.decode(i16 %raw) %sum.next = call float @recipe.state.add(float %sum, float %value)
...
%bias.ptr = getelementptr inbounds i16, ptr addrspace(1) %destination, i32 %bias.index
%bias = call i16 @recipe.encode(float %sum) store i16 %bias, ptr addrspace(1) %bias.ptr, align 2 br label %channel.done
channel.done:
...
define internal <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x i16> %source) #1 {
entry:
br label %loop
loop:
%p = phi i32 [ 0, %entry ], [ %p.next, %step ]
...
br i1 %more, label %step, label %done
step:
%value = extractelement <RECIPE_REGISTER_M x i16> %source, i32 %p
%wide = call float @recipe.decode(i16 %value)
...
%matrix.a.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.a.index
%matrix.a.loaded = load <16 x i16>, ptr addrspace(3) %matrix.a.ptr, align 16
%matrix.a.full = select i1 %m.valid, <16 x i16> %matrix.a.loaded, <16 x i16> zeroinitializer
...
%matrix.b.first.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.b.first.index
%matrix.b.first.loaded = load <16 x i16>, ptr addrspace(3) %matrix.b.first.ptr, align 16
%matrix.b.first.full = select i1 %n.first.valid, <16 x i16> %matrix.b.first.loaded, <16 x i16> zeroinitializer
...
%matrix.b.second.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.b.second.index
%matrix.b.second.loaded = load <16 x i16>, ptr addrspace(3) %matrix.b.second.ptr, align 16
%matrix.b.second.full = select i1 %n.second.valid, <16 x i16> %matrix.b.second.loaded, <16 x i16> zeroinitializer
...
%matrix.b.third.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.b.third.index
%matrix.b.third.loaded = load <16 x i16>, ptr addrspace(3) %matrix.b.third.ptr, align 16
%matrix.b.third.full = select i1 %n.third.valid, <16 x i16> %matrix.b.third.loaded, <16 x i16> zeroinitializer
...
%matrix.b.fourth.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.b.fourth.index
%matrix.b.fourth.loaded = load <16 x i16>, ptr addrspace(3) %matrix.b.fourth.ptr, align 16
%matrix.b.fourth.full = select i1 %n.fourth.valid, <16 x i16> %matrix.b.fourth.loaded, <16 x i16> zeroinitializer
%matrix.first.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.first.full, <8 x float> %matrix.first)
%matrix.second.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.second.full, <8 x float> %matrix.second)
%matrix.third.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.third.full, <8 x float> %matrix.third)
%matrix.fourth.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.a.full, <16 x i16> %matrix.b.fourth.full, <8 x float> %matrix.fourth)
...
%a.vector.source = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %a.vector.index
%a.vector.value = load <RECIPE_FRAGMENT_K x i16>, ptr addrspace(1) %a.vector.source, align 2
call void @contraction_stage_a_fragment(<RECIPE_FRAGMENT_K x i16> %a.vector.value, i32 %a.k, i32 %a.m, i32 %tile.m, i32 %tile.k)
br label %load.advance
load.a.scalar:
%a.loaded = call i16 @contraction_input( ptr addrspace(1) %input, i32 %a.row.base, i32 %a.position, i32 %a.term, i32 %span, i32 %in.length, i1 %is.conv )
br i1 %a.gate, label %load.a.activation, label %load.a.ready
load.a.activation:
%a.activation.channel = mul i32 %a.term, %in.length %a.activation.local = add i32 %a.activation.channel, %a.position %a.activation.index = add i32 %a.row.base, %a.activation.local %a.activation.ptr = getelementptr inbounds i16, ptr addrspace(1) %activation, i32 %a.activation.index %a.activation.value = load i16, ptr addrspace(1) %a.activation.ptr, align 2 %a.activation.positive = call i1 @recipe.ogt(i16 %a.activation.value, i16 0) %a.gated = select i1 %a.activation.positive, i16 %a.loaded, i16 0
br label %load.a.ready
load.a.ready:
%a.value = phi i16 [ %a.loaded, %load.a.scalar ], [ %a.gated, %load.a.activation ]
br label %load.store
...
load.b.vector:
%b.vector.source = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %b.index
%b.vector.value = load <RECIPE_FRAGMENT_K x i16>, ptr addrspace(1) %b.vector.source, align 2
call void @contraction_stage_b_terms(<RECIPE_FRAGMENT_K x i16> %b.vector.value, i32 %b.k, i32 %b.n, i32 %tile.m, i32 %tile.n, i32 %tile.k)
br label %load.advance
load.b.scalar:
%b.ptr = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %b.index
%b.value = load i16, ptr addrspace(1) %b.ptr, align 2
br label %load.store
load.store: %load.value = phi i16 [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %load.tile.index store i16 %load.value, ptr addrspace(3) %load.tile.ptr, align 2
br label %load.advance
load.advance:
...
%store.output.channel.base = mul i32 %store.channel, %out.length %store.output.local = add i32 %store.output.channel.base, %store.position %store.output.index = add i32 %store.output.row.base, %store.output.local %store.output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %store.output.index
%store.bias.base = mul i32 %out.channels, %terms %store.bias.index = add i32 %store.bias.base, %store.channel %store.bias.ptr = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %store.bias.index %store.bias = load i16, ptr addrspace(1) %store.bias.ptr, align 2 %store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr addrspace(5) %sums, i32 0, i32 %store.register %store.sum.wide = load float, ptr addrspace(5) %store.sum.ptr, align 4 %store.sum = call i16 @recipe.encode(float %store.sum.wide)
%store.biased = call i16 @recipe.add(i16 %store.sum, i16 %store.bias) %store.raw = select i1 %has.bias, i16 %store.biased, i16 %store.sum %store.forward = xor i1 %reverse, true %store.activate = and i1 %relu, %store.forward %store.positive = call i1 @recipe.ogt(i16 %store.raw, i16 0) %store.activated = select i1 %store.positive, i16 %store.raw, i16 0 %store.result = select i1 %store.activate, i16 %store.activated, i16 %store.raw %store.prior = load i16, ptr addrspace(1) %store.output.ptr, align 2 %store.accumulated = call i16 @recipe.add(i16 %store.prior, i16 %store.result) %store.value = select i1 %accumulate, i16 %store.accumulated, i16 %store.result store i16 %store.value, ptr addrspace(1) %store.output.ptr, align 2 br label %store.next
...
%maximum = phi i16 [ 65408, %entry ], [ %maximum.next, %step ]
...
%input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %index
%value = load i16, ptr addrspace(1) %input.ptr, align 2 %greater = call i1 @recipe.ogt(i16 %value, i16 %maximum)
%maximum.next = select i1 %greater, i16 %value, i16 %maximum
%maximum.index.next = select i1 %greater, i32 %index, i32 %maximum.index %next = add i32 %i, 1 br label %loop done:
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %p
%context.ptr = getelementptr inbounds i64, ptr addrspace(1) %context, i32 %p
%maximum.index.wide = zext i32 %maximum.index to i64
store i16 %maximum, ptr addrspace(1) %output.ptr, align 2
store i64 %maximum.index.wide, ptr addrspace(1) %context.ptr, align 2 ret void }
define internal i16 @sigmoid(i16 %x) #1 { entry: %negative = call i16 @recipe.neg(i16 %x)
%exponential = call i16 @recipe.exp(i16 %negative) %denominator = call i16 @recipe.add(i16 16256, i16 %exponential)
%value = call i16 @recipe.div(i16 16256, i16 %denominator) ret i16 %value }
define internal i16 @attention_tile_dot(i32 %left, i32 %right, i32 %width, i32 %left.base, i32 %right.base) #1 { entry:
br label %channel.loop
channel.loop:
%channel = phi i32 [ 0, %entry ], [ %channel.next, %channel.step ]
%sum = phi i16 [ 0, %entry ], [ %sum.next, %channel.step ]
...
%left.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %left.index
%left.value = load i16, ptr addrspace(3) %left.ptr, align 2
%right.row = mul i32 %right, %width
%right.local = add i32 %right.row, %channel
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %right.index
%right.value = load i16, ptr addrspace(3) %right.ptr, align 2
%product = call i16 @recipe.mul(i16 %left.value, i16 %right.value)
%sum.next = call i16 @recipe.add(i16 %sum, i16 %product)
%channel.next = add i32 %channel, 1
br label %channel.loop
done:
ret i16 %sum
}
define internal i16 @attention_tile_score(i32 %query, i32 %key, i32 %width, i32 %key.base, i16 %scale) #1 { entry:
%sum = call i16 @attention_tile_dot(i32 %query, i32 %key, i32 %width, i32 0, i32 %key.base)
%score = call i16 @recipe.div(i16 %sum, i16 %scale)
ret i16 %score
}
...
%sum = phi i16 [ 0, %prepare ], [ %sum.next, %channel.step ]
...
%delta.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %delta.index
%delta = load i16, ptr addrspace(3) %delta.ptr, align 2
...
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %output.index
%output.value = load i16, ptr addrspace(1) %output.ptr, align 2
%term = call i16 @recipe.mul(i16 %delta, i16 %output.value)
%sum.next = call i16 @recipe.add(i16 %sum, i16 %term)
%channel.next = add i32 %channel, 1
br label %channel.loop
store:
%product.index = add i32 %product.base, %query
%product.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %product.index
store i16 %sum, ptr addrspace(3) %product.ptr, align 2
...
i16 %scale, i32 %lid, i32 %block) #1 { entry:
...
complete:
%score.raw = call i16 @attention_tile_dot(i32 %query.local, i32 %key.local, i32 %head.width, i32 %query.shared, i32 %key.shared)
%score = call i16 @recipe.div(i16 %score.raw, i16 %scale)
%dp = call i16 @attention_tile_dot(i32 %query.local, i32 %key.local, i32 %head.width, i32 %delta.shared, i32 %value.shared)
%statistics.base = mul i32 %head.job, %length
%statistics.index = add i32 %statistics.base, %query
%maximum.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %statistics.index
%maximum = load i16, ptr addrspace(1) %maximum.ptr, align 2
%denominator.index = add i32 %statistics.denominator.base, %statistics.index
%denominator.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %denominator.index
%denominator = load i16, ptr addrspace(1) %denominator.ptr, align 2
%centered = call i16 @recipe.sub(i16 %score, i16 %maximum)
%exponential = call i16 @recipe.exp(i16 %centered)
%probability = call i16 @recipe.div(i16 %exponential, i16 %denominator)
%product.index = add i32 %product.shared, %query.local
%product.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %product.index
%product = load i16, ptr addrspace(3) %product.ptr, align 2
%dp.centered = call i16 @recipe.sub(i16 %dp, i16 %product)
%derivative = call i16 @recipe.mul(i16 %probability, i16 %dp.centered)
br label %store
invalid:
br label %store
store:
%probability.value = phi i16 [ %probability, %complete ], [ 0, %invalid ]
%derivative.value = phi i16 [ %derivative, %complete ], [ 0, %invalid ]
...
%probability.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %probability.index
store i16 %probability.value, ptr addrspace(3) %probability.ptr, align 2
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %derivative.index
store i16 %derivative.value, ptr addrspace(3) %derivative.ptr, align 2
...
%head.width.double = call i16 @recipe.from.u32(i32 %head.width)
%scale = call i16 @recipe.sqrt(i16 %head.width.double)
...
%query.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %query.input.index
%query.value = load i16, ptr addrspace(1) %query.input.ptr, align 2
%query.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %query.p
store i16 %query.value, ptr addrspace(3) %query.shared.ptr, align 2
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %accumulator.index
store i16 0, ptr addrspace(3) %accumulator.ptr, align 2
...
%maximum.ptr.init = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %maximum.index.init
store i16 65408, ptr addrspace(3) %maximum.ptr.init, align 2
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %denominator.index.init
store i16 0, ptr addrspace(3) %denominator.ptr.init, align 2
...
%key.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %key.input.index
%key.value = load i16, ptr addrspace(1) %key.input.ptr, align 2
%key.shared.index = add i32 %key.base.shared, %key.p
%key.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %key.shared.index
store i16 %key.value, ptr addrspace(3) %key.shared.ptr, align 2
%value.plane = mul i32 %from, 2
%value.row = add i32 %row.base, %value.plane
%value.input.index = add i32 %value.row, %key.input.local
%value.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %value.input.index
%value.value = load i16, ptr addrspace(1) %value.input.ptr, align 2
%value.shared.index = add i32 %value.base.shared, %key.p
%value.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %value.shared.index
store i16 %value.value, ptr addrspace(3) %value.shared.ptr, align 2
...
score.complete:
%score.scaled = call i16 @attention_tile_score(i32 %score.query.local, i32 %score.key.local, i32 %head.width, i32 %key.base.shared, i16 %scale)
br label %score.store
score.invalid:
br label %score.store
score.store:
%score.value = phi i16 [ %score.scaled, %score.complete ], [ 65408, %score.invalid ]
...
%score.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %score.shared.index
store i16 %score.value, ptr addrspace(3) %score.shared.ptr, align 2
...
%maximum.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %maximum.index
%maximum.old = load i16, ptr addrspace(3) %maximum.ptr, align 2
br label %maximum.loop
maximum.loop:
%maximum.key = phi i32 [ 0, %maximum.load ], [ %maximum.key.next, %maximum.step ]
%maximum.value = phi i16 [ %maximum.old, %maximum.load ], [ %maximum.next, %maximum.step ]
...
%maximum.score.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %maximum.score.index
%maximum.score = load i16, ptr addrspace(3) %maximum.score.ptr, align 2
%maximum.larger = call i1 @recipe.ogt(i16 %maximum.score, i16 %maximum.value)
%maximum.next = select i1 %maximum.larger, i16 %maximum.score, i16 %maximum.value
%maximum.key.next = add i32 %maximum.key, 1
br label %maximum.loop
probability.prepare:
%denominator.index = add i32 %denominator.base.shared, %softmax.query
%denominator.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %denominator.index
%denominator.old = load i16, ptr addrspace(3) %denominator.ptr, align 2
%maximum.old.centered = call i16 @recipe.sub(i16 %maximum.old, i16 %maximum.value)
%old.rescale = call i16 @recipe.exp(i16 %maximum.old.centered)
%denominator.rescaled = call i16 @recipe.mul(i16 %denominator.old, i16 %old.rescale)
br label %probability.loop
probability.loop:
%probability.key = phi i32 [ 0, %probability.prepare ], [ %probability.key.next, %probability.step ]
%denominator.value = phi i16 [ %denominator.rescaled, %probability.prepare ], [ %denominator.next, %probability.step ]
...
%probability.score.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %probability.score.index
%probability.score = load i16, ptr addrspace(3) %probability.score.ptr, align 2
%probability.centered = call i16 @recipe.sub(i16 %probability.score, i16 %maximum.value)
%probability.value = call i16 @recipe.exp(i16 %probability.centered)
%probability.index = add i32 %probability.base.shared, %probability.local
%probability.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %probability.index
store i16 %probability.value, ptr addrspace(3) %probability.ptr, align 2
%denominator.next = call i16 @recipe.add(i16 %denominator.value, i16 %probability.value)
%probability.key.next = add i32 %probability.key, 1
br label %probability.loop
softmax.store:
store i16 %maximum.value, ptr addrspace(3) %maximum.ptr, align 2
store i16 %denominator.value, ptr addrspace(3) %denominator.ptr, align 2
%rescale.index = add i32 %rescale.base.shared, %softmax.query
%rescale.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %rescale.index
store i16 %old.rescale, ptr addrspace(3) %rescale.ptr, align 2
...
%accumulate.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %accumulate.index
%accumulate.old = load i16, ptr addrspace(3) %accumulate.ptr, align 2
%accumulate.rescale.index = add i32 %rescale.base.shared, %accumulate.query
%accumulate.rescale.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %accumulate.rescale.index
%accumulate.rescale = load i16, ptr addrspace(3) %accumulate.rescale.ptr, align 2
%accumulate.initial = call i16 @recipe.mul(i16 %accumulate.old, i16 %accumulate.rescale)
br label %accumulate.key.loop
accumulate.key.loop:
%accumulate.key = phi i32 [ 0, %accumulate.prepare ], [ %accumulate.key.next, %accumulate.key.step ]
%accumulate.value = phi i16 [ %accumulate.initial, %accumulate.prepare ], [ %accumulate.next, %accumulate.key.step ]
...
%accumulate.probability.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %accumulate.probability.index
%accumulate.probability = load i16, ptr addrspace(3) %accumulate.probability.ptr, align 2
...
%accumulate.value.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %accumulate.value.index
%accumulate.v = load i16, ptr addrspace(3) %accumulate.value.ptr, align 2
%accumulate.weighted = call i16 @recipe.mul(i16 %accumulate.probability, i16 %accumulate.v)
%accumulate.next = call i16 @recipe.add(i16 %accumulate.value, i16 %accumulate.weighted)
%accumulate.key.next = add i32 %accumulate.key, 1
br label %accumulate.key.loop
accumulate.store:
store i16 %accumulate.value, ptr addrspace(3) %accumulate.ptr, align 2
...
%output.accumulator.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %output.accumulator.index
%output.accumulator = load i16, ptr addrspace(3) %output.accumulator.ptr, align 2
%output.denominator.index = add i32 %denominator.base.shared, %output.query.local
%output.denominator.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %output.denominator.index
%output.denominator = load i16, ptr addrspace(3) %output.denominator.ptr, align 2
%attention = call i16 @recipe.div(i16 %output.accumulator, i16 %output.denominator)
...
%output.maximum.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %output.maximum.index
%output.maximum = load i16, ptr addrspace(3) %output.maximum.ptr, align 2
...
%output.statistics.maximum.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %output.statistics.index
store i16 %output.maximum, ptr addrspace(1) %output.statistics.maximum.ptr, align 2
%output.statistics.denominator.index = add i32 %statistics.plane, %output.statistics.index
%output.statistics.denominator.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %output.statistics.denominator.index
store i16 %output.denominator, ptr addrspace(1) %output.statistics.denominator.ptr, align 2
...
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %output.index
store i16 %attention, ptr addrspace(1) %output.ptr, align 2
...
%length = udiv i32 %from, %channels
%head.width = udiv i32 %channels, %heads
%width.double = call i16 @recipe.from.u32(i32 %head.width)
%scale = call i16 @recipe.sqrt(i16 %width.double)
%head.jobs = mul i32 %rows, %heads
...
%stage.vector.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %stage.vector.index
%stage.vector.value = load <16 x i16>, ptr addrspace(1) %stage.vector.ptr, align 2
call void @contraction_stage_column16(<16 x i16> %stage.vector.value, i32 %stage.shared.base, i32 %stage.position, i32 %stage.channel.local, i32 %head.width)
...
%stage.scalar.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %stage.scalar.index
%stage.scalar.value = load i16, ptr addrspace(1) %stage.scalar.ptr, align 2
...
%stage.scalar.ptr.shared = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %stage.scalar.index.shared
store i16 %stage.scalar.value, ptr addrspace(3) %stage.scalar.ptr.shared, align 2
...
%matrix.q.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.q.index
%matrix.q.fragment = load <16 x i16>, ptr addrspace(3) %matrix.q.ptr, align 2
...
%matrix.k.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.k.index
%matrix.k.fragment = load <16 x i16>, ptr addrspace(3) %matrix.k.ptr, align 2
%matrix.accumulator.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.q.fragment, <16 x i16> %matrix.k.fragment, <8 x float> %matrix.accumulator)
...
%matrix.score.raw = call i16 @recipe.encode(float %matrix.score.wide)
%matrix.score.scaled = call i16 @recipe.div(i16 %matrix.score.raw, i16 %scale)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.score = select i1 %matrix.causal, i16 %matrix.score.scaled, i16 65408
...
%matrix.p.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.p.index
store i16 %matrix.score, ptr addrspace(3) %matrix.p.ptr, align 2
...
%maximum = phi i16 [ 65408, %attention.forward.matrix.softmax.loop ], [ %maximum.next, %attention.forward.matrix.maximum.step ]
...
%maximum.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %maximum.index
%maximum.score = load i16, ptr addrspace(3) %maximum.ptr, align 2
%maximum.larger = call i1 @recipe.ogt(i16 %maximum.score, i16 %maximum)
%maximum.next = select i1 %maximum.larger, i16 %maximum.score, i16 %maximum
%maximum.key.next = add i32 %maximum.key, 1
...
%denominator = phi i16 [ 0, %attention.forward.matrix.maximum.loop ], [ %denominator.next, %attention.forward.matrix.probability.step ]
...
%probability.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %probability.index
%probability.score = load i16, ptr addrspace(3) %probability.ptr, align 2
%probability.centered = call i16 @recipe.sub(i16 %probability.score, i16 %maximum)
%probability.value = call i16 @recipe.exp(i16 %probability.centered)
store i16 %probability.value, ptr addrspace(3) %probability.ptr, align 2
%denominator.next = call i16 @recipe.add(i16 %denominator, i16 %probability.value)
%probability.key.next = add i32 %probability.key, 1
...
%normalize.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %normalize.index
%normalize.value = load i16, ptr addrspace(3) %normalize.ptr, align 2
%normalized = call i16 @recipe.div(i16 %normalize.value, i16 %denominator)
store i16 %normalized, ptr addrspace(3) %normalize.ptr, align 2
...
%maximum.context.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %statistics.index
store i16 %maximum, ptr addrspace(1) %maximum.context.ptr, align 2
%denominator.index = add i32 %statistics.rows, %statistics.index
%denominator.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %denominator.index
store i16 %denominator, ptr addrspace(1) %denominator.ptr, align 2
%softmax.query.next = add i32 %softmax.query, %block
br label %attention.forward.matrix.softmax.loop
attention.forward.matrix.softmax.done:
call void @llvm.amdgcn.s.barrier()
call void @attention_matrix_product(ptr addrspace(1) %output, i32 3, i32 %p.base, i32 %v.base, i32 %output.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i16 %scale, i32 %lid, i32 %block)
call void @llvm.amdgcn.s.barrier()
...
%left.fragment = phi <16 x i16> [ zeroinitializer, %attention.matrix.gradient.k.loop ], [ %left.fragment.next, %attention.matrix.gradient.fragment.step ]
%right.fragment = phi <16 x i16> [ zeroinitializer, %attention.matrix.gradient.k.loop ], [ %right.fragment.next, %attention.matrix.gradient.fragment.step ]
...
%left.index = add i32 %left.base, %left.local
%left.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %left.index
%left.loaded = load i16, ptr addrspace(3) %left.ptr, align 2
%right.row = mul i32 %term.safe, %head.width
%right.local = add i32 %right.row, %n.safe
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %right.index
%right.loaded = load i16, ptr addrspace(3) %right.ptr, align 2
%left.valid = and i1 %m.valid, %term.valid
%right.valid = and i1 %n.valid, %term.valid
%left.value = select i1 %left.valid, i16 %left.loaded, i16 0
%right.value = select i1 %right.valid, i16 %right.loaded, i16 0
%left.fragment.next = insertelement <16 x i16> %left.fragment, i16 %left.value, i32 %fragment
%right.fragment.next = insertelement <16 x i16> %right.fragment, i16 %right.value, i32 %fragment
%fragment.next = add i32 %fragment, 1
br label %attention.matrix.gradient.fragment.loop
attention.matrix.gradient.fragment.done:
%accumulator.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %left.fragment, <16 x i16> %right.fragment, <8 x float> %accumulator)
...
%output.raw = call i16 @recipe.encode(float %output.wide)
%output.scaled = call i16 @recipe.div(i16 %output.raw, i16 %scale)
%output.value = select i1 %unscaled, i16 %output.raw, i16 %output.scaled
...
%output.index = add i32 %output.row, %output.local
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %previous, i32 %output.index
store i16 %output.value, ptr addrspace(1) %output.ptr, align 2
...
%stage.vector.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %stage.vector.input.index
%stage.vector.input.value = load <16 x i16>, ptr addrspace(1) %stage.vector.input.ptr, align 2
...
%stage.vector.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %stage.vector.delta.index
%stage.vector.delta.value = load <16 x i16>, ptr addrspace(1) %stage.vector.delta.ptr, align 2
br label %attention.matrix.stage.vector.store
attention.matrix.stage.vector.store:
%stage.vector.value = phi <16 x i16> [ %stage.vector.input.value, %attention.matrix.stage.vector.input ], [ %stage.vector.delta.value, %attention.matrix.stage.vector.delta ]
call void @contraction_stage_column16(<16 x i16> %stage.vector.value, i32 %stage.shared.base, i32 %stage.position, i32 %stage.channel.local, i32 %head.width)
%stage.vector.position.next = add i32 %stage.position, 16
...
%stage.scalar.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %stage.scalar.input.index
%stage.scalar.input.value = load i16, ptr addrspace(1) %stage.scalar.input.ptr, align 2
...
%stage.scalar.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %stage.scalar.delta.index
%stage.scalar.delta.value = load i16, ptr addrspace(1) %stage.scalar.delta.ptr, align 2
br label %attention.matrix.stage.scalar.store
attention.matrix.stage.scalar.store:
%stage.scalar.value = phi i16 [ %stage.scalar.input.value, %attention.matrix.stage.scalar.input ], [ %stage.scalar.delta.value, %attention.matrix.stage.scalar.delta ]
%stage.scalar.row = mul i32 %stage.position, %head.width
%stage.scalar.local = add i32 %stage.scalar.row, %stage.channel.local
%stage.scalar.index.shared = add i32 %stage.shared.base, %stage.scalar.local
%stage.scalar.ptr.shared = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %stage.scalar.index.shared
...
%d.sum = phi i16 [ 0, %attention.matrix.d.loop ], [ %d.sum.next, %attention.matrix.d.sum.step ]
...
%d.do.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %d.do.index
%d.do = load i16, ptr addrspace(3) %d.do.ptr, align 2
...
%d.output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %d.output.index
%d.output = load i16, ptr addrspace(1) %d.output.ptr, align 2
%d.term = call i16 @recipe.mul(i16 %d.do, i16 %d.output)
%d.sum.next = call i16 @recipe.add(i16 %d.sum, i16 %d.term)
...
%d.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %d.index
store i16 %d.sum, ptr addrspace(3) %d.ptr, align 2
...
%matrix.do.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x i16>, ptr addrspace(3) %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.v.index
%matrix.v.fragment = load <16 x i16>, ptr addrspace(3) %matrix.v.ptr, align 2
%matrix.score.accumulator.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.q.fragment, <16 x i16> %matrix.k.fragment, <8 x float> %matrix.score.accumulator)
%matrix.dp.accumulator.next = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v16i16(<16 x i16> %matrix.do.fragment, <16 x i16> %matrix.v.fragment, <8 x float> %matrix.dp.accumulator)
%matrix.width.next = add i32 %matrix.width, 16
br label %attention.matrix.score.width.loop
...
%matrix.score.raw = call i16 @recipe.encode(float %matrix.score.wide)
%matrix.score = call i16 @recipe.div(i16 %matrix.score.raw, i16 %scale)
%matrix.dp.wide = extractelement <8 x float> %matrix.dp.accumulator, i32 %matrix.output
%matrix.dp = call i16 @recipe.encode(float %matrix.dp.wide)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.statistics.base = mul i32 %head.job, %length
%matrix.statistics.index = add i32 %matrix.statistics.base, %matrix.query
%matrix.maximum.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %matrix.statistics.index
%matrix.maximum = load i16, ptr addrspace(1) %matrix.maximum.ptr, align 2
%matrix.denominator.index = add i32 %statistics.rows, %matrix.statistics.index
%matrix.denominator.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %matrix.denominator.index
%matrix.denominator = load i16, ptr addrspace(1) %matrix.denominator.ptr, align 2
%matrix.centered = call i16 @recipe.sub(i16 %matrix.score, i16 %matrix.maximum)
%matrix.exponential = call i16 @recipe.exp(i16 %matrix.centered)
%matrix.probability.raw = call i16 @recipe.div(i16 %matrix.exponential, i16 %matrix.denominator)
%matrix.probability = select i1 %matrix.causal, i16 %matrix.probability.raw, i16 0
%matrix.d.index = add i32 %d.base, %matrix.query
%matrix.d.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.d.index
%matrix.d = load i16, ptr addrspace(3) %matrix.d.ptr, align 2
%matrix.dp.centered = call i16 @recipe.sub(i16 %matrix.dp, i16 %matrix.d)
%matrix.derivative = call i16 @recipe.mul(i16 %matrix.probability, i16 %matrix.dp.centered)
%matrix.pair.row = mul i32 %matrix.query, %length
%matrix.pair.local = add i32 %matrix.pair.row, %matrix.k
%matrix.p.index = add i32 %p.base, %matrix.pair.local
%matrix.p.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.p.index
store i16 %matrix.probability, ptr addrspace(3) %matrix.p.ptr, align 2
%matrix.ds.index = add i32 %ds.base, %matrix.pair.local
%matrix.ds.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %matrix.ds.index
store i16 %matrix.derivative, ptr addrspace(3) %matrix.ds.ptr, align 2
...
call void @llvm.amdgcn.s.barrier()
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 0, i32 %ds.base, i32 %k.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i16 %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 1, i32 %ds.base, i32 %q.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i16 %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 2, i32 %p.base, i32 %do.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, i16 %scale, i32 %lid, i32 %block)
call void @llvm.amdgcn.s.barrier()
...
%dq.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %dq.input.index
%dq.query.value = load i16, ptr addrspace(1) %dq.input.ptr, align 2
%dq.query.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.query.p
store i16 %dq.query.value, ptr addrspace(3) %dq.query.shared.ptr, align 2
%dq.delta.index = add i32 %dq.output.row, %dq.local
%dq.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %dq.delta.index
%dq.delta.value = load i16, ptr addrspace(1) %dq.delta.ptr, align 2
%dq.delta.shared.index = add i32 %dq.delta.base.shared, %dq.query.p
%dq.delta.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.delta.shared.index
store i16 %dq.delta.value, ptr addrspace(3) %dq.delta.shared.ptr, align 2
%dq.gradient.shared.index = add i32 %dq.gradient.base.shared, %dq.query.p
%dq.gradient.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.gradient.shared.index
store i16 0, ptr addrspace(3) %dq.gradient.shared.ptr, align 2
...
%dq.key.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %dq.key.input.index
%dq.key.value = load i16, ptr addrspace(1) %dq.key.input.ptr, align 2
%dq.key.shared.index = add i32 %dq.key.base.shared, %dq.key.p
%dq.key.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.key.shared.index
store i16 %dq.key.value, ptr addrspace(3) %dq.key.shared.ptr, align 2
...
%dq.value.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %dq.value.input.index
%dq.value.value = load i16, ptr addrspace(1) %dq.value.input.ptr, align 2
%dq.value.shared.index = add i32 %dq.value.base.shared, %dq.key.p
%dq.value.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.value.shared.index
store i16 %dq.value.value, ptr addrspace(3) %dq.value.shared.ptr, align 2
...
%dq.accumulate.gradient.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.accumulate.gradient.index
%dq.accumulate.initial = load i16, ptr addrspace(3) %dq.accumulate.gradient.ptr, align 2
...
%dq.accumulate.value = phi i16 [ %dq.accumulate.initial, %dq.accumulate.prepare ], [ %dq.accumulate.next, %dq.accumulate.key.step ]
...
%dq.accumulate.pair.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.accumulate.pair.index
%dq.accumulate.ds = load i16, ptr addrspace(3) %dq.accumulate.pair.ptr, align 2
...
%dq.accumulate.key.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.accumulate.key.index
%dq.accumulate.key.value = load i16, ptr addrspace(3) %dq.accumulate.key.ptr, align 2
%dq.accumulate.raw = call i16 @recipe.mul(i16 %dq.accumulate.ds, i16 %dq.accumulate.key.value)
%dq.accumulate.term = call i16 @recipe.div(i16 %dq.accumulate.raw, i16 %scale)
%dq.accumulate.next = call i16 @recipe.add(i16 %dq.accumulate.value, i16 %dq.accumulate.term)
%dq.accumulate.key.next = add i32 %dq.accumulate.key, 1
br label %dq.accumulate.key.loop
dq.accumulate.store:
store i16 %dq.accumulate.value, ptr addrspace(3) %dq.accumulate.gradient.ptr, align 2
...
%dq.store.ptr = getelementptr inbounds i16, ptr addrspace(1) %previous, i32 %dq.store.index
%dq.store.shared.index = add i32 %dq.gradient.base.shared, %dq.store.p
%dq.store.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dq.store.shared.index
%dq.store.value = load i16, ptr addrspace(3) %dq.store.shared.ptr, align 2
store i16 %dq.store.value, ptr addrspace(1) %dq.store.ptr, align 2
...
%dkv.key.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %dkv.key.input.index
%dkv.key.value = load i16, ptr addrspace(1) %dkv.key.input.ptr, align 2
%dkv.key.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.key.p
store i16 %dkv.key.value, ptr addrspace(3) %dkv.key.shared.ptr, align 2
...
%dkv.value.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %dkv.value.input.index
%dkv.value.value = load i16, ptr addrspace(1) %dkv.value.input.ptr, align 2
%dkv.value.shared.index = add i32 %dkv.value.base.shared, %dkv.key.p
%dkv.value.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.value.shared.index
store i16 %dkv.value.value, ptr addrspace(3) %dkv.value.shared.ptr, align 2
%dkv.key.gradient.index = add i32 %dkv.key.gradient.base.shared, %dkv.key.p
%dkv.key.gradient.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.key.gradient.index
store i16 0, ptr addrspace(3) %dkv.key.gradient.ptr, align 2
%dkv.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.key.p
%dkv.value.gradient.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.value.gradient.index
store i16 0, ptr addrspace(3) %dkv.value.gradient.ptr, align 2
...
%dkv.query.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %dkv.query.input.index
%dkv.query.value = load i16, ptr addrspace(1) %dkv.query.input.ptr, align 2
%dkv.query.shared.index = add i32 %dkv.query.base.shared, %dkv.query.p
%dkv.query.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.query.shared.index
store i16 %dkv.query.value, ptr addrspace(3) %dkv.query.shared.ptr, align 2
%dkv.delta.input.index = add i32 %dkv.output.row, %dkv.query.input.local
%dkv.delta.input.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %dkv.delta.input.index
%dkv.delta.value = load i16, ptr addrspace(1) %dkv.delta.input.ptr, align 2
%dkv.delta.shared.index = add i32 %dkv.delta.base.shared, %dkv.query.p
%dkv.delta.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.delta.shared.index
store i16 %dkv.delta.value, ptr addrspace(3) %dkv.delta.shared.ptr, align 2
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.accumulate.key.gradient.index
%dkv.accumulate.key.initial = load i16, ptr addrspace(3) %dkv.accumulate.key.gradient.ptr, align 2
%dkv.accumulate.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.accumulate.p
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.accumulate.value.gradient.index
%dkv.accumulate.value.initial = load i16, ptr addrspace(3) %dkv.accumulate.value.gradient.ptr, align 2
...
%dkv.accumulate.key.value = phi i16 [ %dkv.accumulate.key.initial, %dkv.accumulate.prepare ], [ %dkv.accumulate.key.next, %dkv.accumulate.query.step ]
%dkv.accumulate.value.value = phi i16 [ %dkv.accumulate.value.initial, %dkv.accumulate.prepare ], [ %dkv.accumulate.value.next, %dkv.accumulate.query.step ]
...
%dkv.accumulate.probability.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.accumulate.probability.index
%dkv.accumulate.probability = load i16, ptr addrspace(3) %dkv.accumulate.probability.ptr, align 2
%dkv.accumulate.derivative.index = add i32 %dkv.derivative.base.shared, %dkv.accumulate.pair.local
%dkv.accumulate.derivative.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.accumulate.derivative.index
%dkv.accumulate.derivative = load i16, ptr addrspace(3) %dkv.accumulate.derivative.ptr, align 2
...
%dkv.accumulate.query.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.accumulate.query.index
%dkv.accumulate.query.value = load i16, ptr addrspace(3) %dkv.accumulate.query.ptr, align 2
%dkv.accumulate.delta.index = add i32 %dkv.delta.base.shared, %dkv.accumulate.query.local
%dkv.accumulate.delta.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.accumulate.delta.index
%dkv.accumulate.delta = load i16, ptr addrspace(3) %dkv.accumulate.delta.ptr, align 2
%dkv.accumulate.key.raw = call i16 @recipe.mul(i16 %dkv.accumulate.derivative, i16 %dkv.accumulate.query.value)
%dkv.accumulate.key.term = call i16 @recipe.div(i16 %dkv.accumulate.key.raw, i16 %scale)
%dkv.accumulate.key.next = call i16 @recipe.add(i16 %dkv.accumulate.key.value, i16 %dkv.accumulate.key.term)
%dkv.accumulate.value.term = call i16 @recipe.mul(i16 %dkv.accumulate.probability, i16 %dkv.accumulate.delta)
%dkv.accumulate.value.next = call i16 @recipe.add(i16 %dkv.accumulate.value.value, i16 %dkv.accumulate.value.term)
%dkv.accumulate.query.next = add i32 %dkv.accumulate.query, 1
br label %dkv.accumulate.query.loop
dkv.accumulate.store:
store i16 %dkv.accumulate.key.value, ptr addrspace(3) %dkv.accumulate.key.gradient.ptr, align 2
store i16 %dkv.accumulate.value.value, ptr addrspace(3) %dkv.accumulate.value.gradient.ptr, align 2
...
%dkv.store.key.ptr = getelementptr inbounds i16, ptr addrspace(1) %previous, i32 %dkv.store.key.index
%dkv.store.key.shared.index = add i32 %dkv.key.gradient.base.shared, %dkv.store.p
%dkv.store.key.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.store.key.shared.index
%dkv.store.key.value = load i16, ptr addrspace(3) %dkv.store.key.shared.ptr, align 2
store i16 %dkv.store.key.value, ptr addrspace(1) %dkv.store.key.ptr, align 2
...
%dkv.store.value.ptr = getelementptr inbounds i16, ptr addrspace(1) %previous, i32 %dkv.store.value.index
%dkv.store.value.shared.index = add i32 %dkv.value.gradient.base.shared, %dkv.store.p
%dkv.store.value.shared.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %dkv.store.value.shared.index
%dkv.store.value.value = load i16, ptr addrspace(3) %dkv.store.value.shared.ptr, align 2
store i16 %dkv.store.value.value, ptr addrspace(1) %dkv.store.value.ptr, align 2
...
%precompute.weights = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %precompute.weight.offset
%precompute.context.offset = mul i32 %precompute.gate, %gate.batch
%precompute.context = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %precompute.context.offset
...
%input.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %input.index
%input.sum = load i16, ptr addrspace(1) %input.ptr, align 2 br label %state.sum.loop state.sum.loop:
%state.channel = phi i32 [ 0, %input.load ], [ %state.next, %state.sum.step ]
%state.sum = phi i16 [ %input.sum, %input.load ], [ %state.sum.next, %state.sum.step ]
...
%previous.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %previous.index
%previous.loaded = load i16, ptr addrspace(1) %previous.ptr, align 2
%previous = select i1 %previous.exists, i16 %previous.loaded, i16 0 %candidate.gate = icmp eq i32 %gate, 2
...
%reset.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %reset.base
%reset = load i16, ptr addrspace(1) %reset.ptr, align 2 %reset.state = call i16 @recipe.mul(i16 %reset, i16 %previous)
%state.value = select i1 %reset.candidate, i16 %reset.state, i16 %previous
...
%state.weight.ptr = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %state.weight.index
%state.weight = load i16, ptr addrspace(1) %state.weight.ptr, align 2
%state.product = call i16 @recipe.mul(i16 %state.value, i16 %state.weight) %state.sum.next = call i16 @recipe.add(i16 %state.sum, i16 %state.product)
...
%bias.ptr = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %bias.index
%bias = load i16, ptr addrspace(1) %bias.ptr, align 2 %linear = call i16 @recipe.add(i16 %state.sum, i16 %bias)
%rnn = icmp eq i32 %gates, 1 %last.gate = sub i32 %gates, 1 %candidate = icmp eq i32 %gate, %last.gate
%use.tanh = or i1 %rnn, %candidate %tanh.value = call i16 @recipe.tanh(i16 %linear)
%sigmoid.value = call i16 @sigmoid(i16 %linear)
%gate.value = select i1 %use.tanh, i16 %tanh.value, i16 %sigmoid.value br label %gate.store gate.store:
...
%gate.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gate.index
store i16 %gate.value, ptr addrspace(1) %gate.ptr, align 2 %hidden.next = add nuw i32 %hidden, 1
...
%output.index = add i32 %output.row.base, %output.local
%gate0.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %output.index
%gate0 = load i16, ptr addrspace(1) %gate0.ptr, align 2
...
%gate1.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gate1.index
%gate1 = load i16, ptr addrspace(1) %gate1.ptr, align 2 %gate2.base = mul i32 %gate.batch, 2
...
%gate2.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gate2.index
%gate2 = load i16, ptr addrspace(1) %gate2.ptr, align 2 %gate3.base = mul i32 %gate.batch, 3
%gate3.raw = add i32 %gate3.base, %output.index %gate3.index = select i1 %is.lstm, i32 %gate3.raw, i32 %output.index
%gate3.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gate3.index
%gate3 = load i16, ptr addrspace(1) %gate3.ptr, align 2 %output.previous.time = sub i32 %time, 1
...
%output.previous.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %output.previous.index
%output.previous.loaded = load i16, ptr addrspace(1) %output.previous.ptr, align 2
%output.previous = select i1 %previous.exists, i16 %output.previous.loaded, i16 0
%one.update = call i16 @recipe.sub(i16 16256, i16 %gate0) %gru.old = call i16 @recipe.mul(i16 %gate0, i16 %output.previous)
%gru.new = call i16 @recipe.mul(i16 %one.update, i16 %gate2) %gru.value = call i16 @recipe.add(i16 %gru.old, i16 %gru.new)
...
%cell.previous.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %cell.previous.index
%cell.previous.loaded = load i16, ptr addrspace(1) %cell.previous.ptr, align 2
%cell.previous = select i1 %previous.exists, i16 %cell.previous.loaded, i16 0
%cell.old = call i16 @recipe.mul(i16 %gate1, i16 %cell.previous) %cell.new = call i16 @recipe.mul(i16 %gate0, i16 %gate3)
%cell = call i16 @recipe.add(i16 %cell.old, i16 %cell.new)
%cell.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %cell.index
store i16 %cell, ptr addrspace(1) %cell.ptr, align 2 %cell.tanh = call i16 @recipe.tanh(i16 %cell)
%lstm.value = call i16 @recipe.mul(i16 %gate2, i16 %cell.tanh)
%rnn.or.gru = select i1 %is.gru, i16 %gru.value, i16 %gate0
%output.value = select i1 %is.lstm, i16 %lstm.value, i16 %rnn.or.gru br label %output.store output.store:
%output.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %output.index
store i16 %output.value, ptr addrspace(1) %output.ptr, align 2 %output.next = add nuw i32 %output.hidden, 1
...
%gradient.scratch = getelementptr inbounds i16, ptr addrspace(1) %gradient, i32 RECIPE_GRADIENT_SCRATCH_BASE
...
%gradient.a.vector.source = getelementptr inbounds i16, ptr addrspace(1) %input, i32 %gradient.a.vector.index
%gradient.a.vector.value = load <RECIPE_FRAGMENT_K x i16>, ptr addrspace(1) %gradient.a.vector.source, align 2
call void @contraction_stage_a_columns(<RECIPE_FRAGMENT_K x i16> %gradient.a.vector.value, i32 %gradient.a.r, i32 %gradient.a.m, i32 %gradient.tile.m, i32 %gradient.tile.k)
br label %gradient.load.advance
gradient.load.a.scalar:
%gradient.a.value = call i16 @contraction_input( ptr addrspace(1) %input, i32 %gradient.a.row.base, i32 %gradient.a.position, i32 %gradient.a.term, i32 %span, i32 %in.length, i1 %is.conv )
...
%gradient.b.vector.value = call <RECIPE_FRAGMENT_K x i16> @contraction_delta_vector16(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %gradient.b.index, i1 %relu)
call void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x i16> %gradient.b.vector.value, i32 %gradient.b.r, i32 %gradient.b.n, i32 %gradient.tile.m, i32 %gradient.tile.n, i32 %gradient.tile.k)
br label %gradient.load.advance
gradient.load.b.scalar:
%gradient.b.value = call i16 @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %gradient.b.index, i1 %relu)
br label %gradient.load.store
gradient.load.store: %gradient.load.value = phi i16 [ %gradient.a.value, %gradient.load.a.scalar ], [ %gradient.b.value, %gradient.load.b.scalar ] %gradient.load.index = phi i32 [ %gradient.a.tile.index, %gradient.load.a.scalar ], [ %gradient.b.tile.index, %gradient.load.b.scalar ]
%gradient.load.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %gradient.load.index store i16 %gradient.load.value, ptr addrspace(3) %gradient.load.ptr, align 2
br label %gradient.load.advance
...
%gradient.store.ptr = getelementptr inbounds i16, ptr addrspace(1) %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr addrspace(5) %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load float, ptr addrspace(5) %gradient.store.sum.ptr, align 4 %gradient.store.sum = call i16 @recipe.encode(float %gradient.store.sum.wide) store i16 %gradient.store.sum, ptr addrspace(1) %gradient.store.ptr, align 2
...
%previous.a.vector.delta = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %previous.a.index
%previous.a.vector.output = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %previous.a.index
%previous.a.vector.delta.value = load <RECIPE_FRAGMENT_K x i16>, ptr addrspace(1) %previous.a.vector.delta, align 2
%previous.a.vector.output.value = load <RECIPE_FRAGMENT_K x i16>, ptr addrspace(1) %previous.a.vector.output, align 2
call void @contraction_stage_delta_a_fragment(<RECIPE_FRAGMENT_K x i16> %previous.a.vector.delta.value, <RECIPE_FRAGMENT_K x i16> %previous.a.vector.output.value, i1 %relu, i32 %previous.a.r, i32 %previous.a.m, i32 %previous.tile.m, i32 %previous.tile.k)
br label %previous.load.advance
previous.load.a.scalar:
%previous.a.raw = call i16 @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %previous.a.index, i1 %relu)
%previous.a.value = select i1 %previous.a.valid, i16 %previous.a.raw, i16 0
...
%previous.b.vector.source = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %previous.b.index
%previous.b.vector.value = load <RECIPE_FRAGMENT_K x i16>, ptr addrspace(1) %previous.b.vector.source, align 2
call void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x i16> %previous.b.vector.value, i32 %previous.b.r, i32 %previous.b.n, i32 %previous.tile.m, i32 %previous.tile.n, i32 %previous.tile.k)
br label %previous.load.advance
previous.load.b.scalar:
%previous.b.ptr = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %previous.b.index
%previous.b.value = load i16, ptr addrspace(1) %previous.b.ptr, align 2
br label %previous.load.store
previous.load.store: %previous.load.value = phi i16 [ %previous.a.value, %previous.load.a.scalar ], [ %previous.b.value, %previous.load.b.scalar ] %previous.load.index = phi i32 [ %previous.a.tile.index, %previous.load.a.scalar ], [ %previous.b.tile.index, %previous.load.b.scalar ]
%previous.load.ptr = getelementptr [0 x i16], ptr addrspace(3) @contraction_tile_bf16, i32 0, i32 %previous.load.index store i16 %previous.load.value, ptr addrspace(3) %previous.load.ptr, align 2
br label %previous.load.advance
...
%clear.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %clear.index
store i16 0, ptr addrspace(1) %clear.ptr, align 2 %clear.next = add nuw i32 %clear.p, 1
...
%clear.dh.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %clear.dh.index
%clear.dc.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %clear.dc.index
store i16 0, ptr addrspace(1) %clear.dh.ptr, align 2 store i16 0, ptr addrspace(1) %clear.dc.ptr, align 2
...
%rnn.index = add i32 %row.output.base, %rnn.local %rnn.dy.ptr = getelementptr inbounds i16,
ptr addrspace(1) %delta, i32 %rnn.index %rnn.future.index = add i32 %dh.start, %rnn.hidden
%rnn.future.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %rnn.future.index
%rnn.gate.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %rnn.index
%rnn.dy = load i16, ptr addrspace(1) %rnn.dy.ptr, align 2
%rnn.future = load i16, ptr addrspace(1) %rnn.future.ptr, align 2
%rnn.gate = load i16, ptr addrspace(1) %rnn.gate.ptr, align 2 %rnn.dh = call i16 @recipe.add(i16 %rnn.dy, i16 %rnn.future)
%rnn.square = call i16 @recipe.mul(i16 %rnn.gate, i16 %rnn.gate) %rnn.derivative = call i16 @recipe.sub(i16 16256, i16 %rnn.square)
%rnn.delta = call i16 @recipe.mul(i16 %rnn.dh, i16 %rnn.derivative) %rnn.delta.index = add i32 %delta.base, %rnn.index
%rnn.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %rnn.delta.index
store i16 %rnn.delta, ptr addrspace(1) %rnn.delta.ptr, align 2 %rnn.next = add i32 %rnn.hidden, 1
...
%gru.dy.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %gru.index
%gru.future.index = add i32 %dh.start, %gru.hidden
%gru.future.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.future.index
%gru.previous.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %gru.previous.index
%gru.z.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.index
%gru.n.index = add i32 %gru.index, %gate2.batch
%gru.n.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.n.index
%gru.dy = load i16, ptr addrspace(1) %gru.dy.ptr, align 2
%gru.future = load i16, ptr addrspace(1) %gru.future.ptr, align 2
%gru.previous.loaded = load i16, ptr addrspace(1) %gru.previous.ptr, align 2
%gru.previous = select i1 %previous.exists, i16 %gru.previous.loaded, i16 0
%gru.z = load i16, ptr addrspace(1) %gru.z.ptr, align 2
%gru.n = load i16, ptr addrspace(1) %gru.n.ptr, align 2 %gru.dh = call i16 @recipe.add(i16 %gru.dy, i16 %gru.future)
%gru.one.z = call i16 @recipe.sub(i16 16256, i16 %gru.z) %gru.z.difference = call i16 @recipe.sub(i16 %gru.previous, i16 %gru.n)
%gru.dz.0 = call i16 @recipe.mul(i16 %gru.dh, i16 %gru.z.difference) %gru.dz.1 = call i16 @recipe.mul(i16 %gru.dz.0, i16 %gru.z)
%gru.dz = call i16 @recipe.mul(i16 %gru.dz.1, i16 %gru.one.z) %gru.n.square = call i16 @recipe.mul(i16 %gru.n, i16 %gru.n)
%gru.n.derivative = call i16 @recipe.sub(i16 16256, i16 %gru.n.square) %gru.dn.0 = call i16 @recipe.mul(i16 %gru.dh, i16 %gru.one.z)
%gru.dn = call i16 @recipe.mul(i16 %gru.dn.0, i16 %gru.n.derivative) %gru.dz.index = add i32 %delta.base, %gru.index
%gru.dn.index.0 = add i32 %delta.base, %gate2.batch %gru.dn.index = add i32 %gru.dn.index.0, %gru.index
%gru.dz.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.dz.index
%gru.dn.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.dn.index
store i16 %gru.dz, ptr addrspace(1) %gru.dz.ptr, align 2
store i16 %gru.dn, ptr addrspace(1) %gru.dn.ptr, align 2 %gru.next = add i32 %gru.hidden, 1
...
%gru.reset.sum = phi i16 [ 0, %gru.reset.loop ], [ %gru.reset.sum.next, %gru.reset.sum.step ]
...
%gru.weight.ptr = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %gru.weight.index
...
%gru.target.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.target.delta.index
%gru.weight = load i16, ptr addrspace(1) %gru.weight.ptr, align 2
%gru.target.delta = load i16, ptr addrspace(1) %gru.target.delta.ptr, align 2
%gru.reset.product = call i16 @recipe.mul(i16 %gru.weight, i16 %gru.target.delta)
%gru.reset.sum.next = call i16 @recipe.add(i16 %gru.reset.sum, i16 %gru.reset.product)
...
%gru.source.previous.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %gru.source.previous.index
%gru.r.index = add i32 %batch, %gru.source.index
%gru.r.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.r.index
%gru.source.previous.loaded = load i16, ptr addrspace(1) %gru.source.previous.ptr, align 2
%gru.source.previous = select i1 %previous.exists, i16 %gru.source.previous.loaded, i16 0
%gru.r = load i16, ptr addrspace(1) %gru.r.ptr, align 2
%gru.dr = call i16 @recipe.mul(i16 %gru.reset.sum, i16 %gru.source.previous) %gru.one.r = call i16 @recipe.sub(i16 16256, i16 %gru.r)
%gru.dr.0 = call i16 @recipe.mul(i16 %gru.dr, i16 %gru.r) %gru.dr.1 = call i16 @recipe.mul(i16 %gru.dr.0, i16 %gru.one.r)
%gru.dr.base = add i32 %delta.base, %batch %gru.dr.index = add i32 %gru.dr.base, %gru.source.index
%gru.dr.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %gru.dr.index
store i16 %gru.dr.1, ptr addrspace(1) %gru.dr.ptr, align 2 %gru.source.next = add i32 %gru.source, 1
...
%dy.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %index %dh.index = add i32 %dh.start, %hidden
%dc.index = add i32 %dc.start, %hidden %dh.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %dh.index
%dc.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %dc.index
%cell.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %cell.index
%cell.previous.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %cell.previous.index
%dy = load i16, ptr addrspace(1) %dy.ptr, align 2 %dh.future = load i16, ptr addrspace(1) %dh.ptr, align 2
%dc.future = load i16, ptr addrspace(1) %dc.ptr, align 2 %cell = load i16, ptr addrspace(1) %cell.ptr, align 2
%cell.previous.loaded = load i16, ptr addrspace(1) %cell.previous.ptr, align 2
%cell.previous = select i1 %previous.exists, i16 %cell.previous.loaded, i16 0
%i.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %index %f.index = add i32 %batch, %index
%o.index = add i32 %f.index, %batch %g.index = add i32 %o.index, %batch
%f.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %f.index
%o.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %o.index
%g.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %g.index
%i = load i16, ptr addrspace(1) %i.ptr, align 2 %f = load i16, ptr addrspace(1) %f.ptr, align 2
%o = load i16, ptr addrspace(1) %o.ptr, align 2 %g = load i16, ptr addrspace(1) %g.ptr, align 2
%dh = call i16 @recipe.add(i16 %dy, i16 %dh.future) %cell.tanh = call i16 @recipe.tanh(i16 %cell)
%cell.tanh.square = call i16 @recipe.mul(i16 %cell.tanh, i16 %cell.tanh) %cell.tanh.derivative = call i16 @recipe.sub(i16 16256, i16 %cell.tanh.square)
%cell.chain.0 = call i16 @recipe.mul(i16 %dh, i16 %o) %cell.chain = call i16 @recipe.mul(i16 %cell.chain.0, i16 %cell.tanh.derivative)
%dc = call i16 @recipe.add(i16 %dc.future, i16 %cell.chain) %one.o = call i16 @recipe.sub(i16 16256, i16 %o) %do.0 = call i16 @recipe.mul(i16 %dh, i16 %cell.tanh)
%do.1 = call i16 @recipe.mul(i16 %do.0, i16 %o) %do = call i16 @recipe.mul(i16 %do.1, i16 %one.o) %one.i = call i16 @recipe.sub(i16 16256, i16 %i) %di.0 = call i16 @recipe.mul(i16 %dc, i16 %g)
%di.1 = call i16 @recipe.mul(i16 %di.0, i16 %i) %di = call i16 @recipe.mul(i16 %di.1, i16 %one.i) %one.f = call i16 @recipe.sub(i16 16256, i16 %f)
%df.0 = call i16 @recipe.mul(i16 %dc, i16 %cell.previous) %df.1 = call i16 @recipe.mul(i16 %df.0, i16 %f) %df = call i16 @recipe.mul(i16 %df.1, i16 %one.f)
%g.square = call i16 @recipe.mul(i16 %g, i16 %g) %one.g.square = call i16 @recipe.sub(i16 16256, i16 %g.square) %dg.0 = call i16 @recipe.mul(i16 %dc, i16 %i)
%dg = call i16 @recipe.mul(i16 %dg.0, i16 %one.g.square) %dc.previous = call i16 @recipe.mul(i16 %dc, i16 %f)
store i16 %dc.previous, ptr addrspace(1) %dc.ptr, align 2 %delta0.index = add i32 %delta.base, %index
%delta1.index = add i32 %delta0.index, %batch %delta2.index = add i32 %delta1.index, %batch
%delta3.index = add i32 %delta2.index, %batch
%delta0.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %delta0.index
%delta1.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %delta1.index
%delta2.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %delta2.index
%delta3.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %delta3.index
store i16 %di, ptr addrspace(1) %delta0.ptr, align 2 store i16 %df, ptr addrspace(1) %delta1.ptr, align 2
store i16 %do, ptr addrspace(1) %delta2.ptr, align 2 store i16 %dg, ptr addrspace(1) %delta3.ptr, align 2
...
%gate.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %delta.index
%gate.delta = load i16, ptr addrspace(1) %gate.delta.ptr, align 2
...
%state.ptr = getelementptr inbounds i16, ptr addrspace(1) %output, i32 %state.index.value
%state.loaded = load i16, ptr addrspace(1) %state.ptr, align 2
%state.value = select i1 %previous.exists, i16 %state.loaded, i16 0
...
%parameter.reset.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %parameter.reset.index
%parameter.reset = load i16, ptr addrspace(1) %parameter.reset.ptr, align 2
%parameter.reset.state = call i16 @recipe.mul(i16 %parameter.reset, i16 %state.value)
%parameter.state = select i1 %gru.candidate, i16 %parameter.reset.state, i16 %state.value
%source.value = select i1 %state.weight, i16 %parameter.state, i16 16256
%contribution = call i16 @recipe.mul(i16 %source.value, i16 %gate.delta) %row.gradient.index = add i32 %row.gradient.start, %p
%row.gradient.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %row.gradient.index
%row.gradient.old = load i16, ptr addrspace(1) %row.gradient.ptr, align 2
%row.gradient.new = call i16 @recipe.add(i16 %row.gradient.old, i16 %contribution)
store i16 %row.gradient.new, ptr addrspace(1) %row.gradient.ptr, align 2
...
%state.sum = phi i16 [ 0, %hidden.gradient.loop ], [ %state.sum.next, %hidden.gradient.sum.step ]
...
%state.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %state.delta.index
%state.weight.value = load i16, ptr addrspace(1) %state.weight.ptr, align 2
%state.delta.value = load i16, ptr addrspace(1) %state.delta.ptr, align 2
%state.product = call i16 @recipe.mul(i16 %state.weight.value, i16 %state.delta.value) %state.candidate = icmp eq i32 %state.gate, 2
...
%state.reset.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %state.reset.index
%state.reset = load i16, ptr addrspace(1) %state.reset.ptr, align 2
%state.reset.product = call i16 @recipe.mul(i16 %state.product, i16 %state.reset)
%state.contribution = select i1 %state.gru.candidate, i16 %state.reset.product, i16 %state.product
%state.sum.next = call i16 @recipe.add(i16 %state.sum, i16 %state.contribution) %state.term.next = add nuw i32 %state.term, 1
br label %hidden.gradient.sum.loop hidden.gradient.store: %state.dh.index = add i32 %dh.start, %state.channel
%state.dh.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %state.dh.index
...
%state.direct.delta.ptr = getelementptr inbounds i16, ptr addrspace(1) %delta, i32 %state.direct.index
%state.direct.z.ptr = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %state.direct.index
%state.direct.dy = load i16, ptr addrspace(1) %state.direct.delta.ptr, align 2
%state.direct.future = load i16, ptr addrspace(1) %state.dh.ptr, align 2
%state.direct.z = load i16, ptr addrspace(1) %state.direct.z.ptr, align 2
%state.direct.dh = call i16 @recipe.add(i16 %state.direct.dy, i16 %state.direct.future)
%state.direct.raw = call i16 @recipe.mul(i16 %state.direct.z, i16 %state.direct.dh)
%state.direct = select i1 %gru, i16 %state.direct.raw, i16 0
%state.total = call i16 @recipe.add(i16 %state.sum, i16 %state.direct)
store i16 %state.total, ptr addrspace(1) %state.dh.ptr, align 2 %state.channel.next = add nuw i32 %state.channel, 1
...
%projection.weights = getelementptr inbounds i16, ptr addrspace(1) %weights, i32 %projection.weight.offset
%projection.delta.gate = mul i32 %projection.gate, %batch
%projection.delta.offset = add i32 %delta.base, %projection.delta.gate
%projection.delta = getelementptr inbounds i16, ptr addrspace(1) %context, i32 %projection.delta.offset
