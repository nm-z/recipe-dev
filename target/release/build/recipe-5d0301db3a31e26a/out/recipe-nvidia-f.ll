...
declare void @llvm.trap() @contraction_tile_f = external addrspace(3) global [0 x double], align 16
...
%ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %index
...
%target = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %index
...
%publish.target = getelementptr double, ptr addrspace(3) @contraction_tile_f, i32 %publish.target.index
store double %publish.value, ptr addrspace(3) %publish.target, align 8
...
%fold.source = getelementptr double, ptr addrspace(3) @contraction_tile_f, i32 %fold.source.index
%fold.value = load double, ptr addrspace(3) %fold.source, align 8
...
%ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %index
%raw = load double, ptr addrspace(3) %ptr, align 8 %value = call double @recipe.decode(double %raw) %sum.next = call double @recipe.state.add(double %sum, double %value)
...
%bias = call double @recipe.encode(double %sum) store double %bias, ptr addrspace(1) %bias.ptr, align 8 br label %channel.done
channel.done:
...
%matrix.a.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.a.index
...
%matrix.b.first.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.b.first.index
...
%matrix.b.second.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.b.second.index
...
%matrix.b.third.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.b.third.index
...
%matrix.b.fourth.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.b.fourth.index
...
%sums = alloca [RECIPE_REGISTER_COUNT x double], align 8 %state.zero = call double @recipe.state.from.u1(i1 false) %lid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() %group = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() %block = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() %groups = udiv i32 %threads, %block
...
%store.bias.base = mul i32 %out.channels, %terms %store.bias.index = add i32 %store.bias.base, %store.channel %store.bias.ptr = getelementptr inbounds double, ptr addrspace(1) %weights, i32 %store.bias.index %store.bias = load double, ptr addrspace(1) %store.bias.ptr, align 8 %store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %store.register %store.sum.wide = load double, ptr %store.sum.ptr, align 8 %store.sum = call double @recipe.encode(double %store.sum.wide)
...
%left.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %left.index
...
%right.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %right.index
...
%delta.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %delta.index
...
%product.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %product.index
...
%probability.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %probability.index
...
%derivative.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %derivative.index
...
%query.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %query.p
...
%accumulator.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %accumulator.index
...
%maximum.ptr.init = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %maximum.index.init
...
%denominator.ptr.init = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %denominator.index.init
...
%key.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %key.shared.index
...
%value.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %value.shared.index
...
%score.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %score.shared.index
...
%maximum.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %maximum.index
...
%maximum.score.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %maximum.score.index
...
%denominator.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %denominator.index
...
%probability.score.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %probability.score.index
...
%rescale.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %rescale.index
...
%accumulate.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %accumulate.index
...
%accumulate.rescale.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %accumulate.rescale.index
...
%accumulate.probability.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %accumulate.probability.index
...
%accumulate.value.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %accumulate.value.index
...
%output.accumulator.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %output.accumulator.index
...
%output.denominator.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %output.denominator.index
...
%output.maximum.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %output.maximum.index
...
%stage.scalar.ptr.shared = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %stage.scalar.index.shared
...
%matrix.q.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.q.index
...
%matrix.k.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.k.index
...
%matrix.p.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.p.index
...
%normalize.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %normalize.index
...
%d.do.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %d.do.index
...
%d.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %d.index
...
%matrix.do.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x double>, ptr addrspace(3) %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.v.index
...
%matrix.d.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.d.index
...
%matrix.ds.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %matrix.ds.index
...
%dq.query.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.query.p
...
%dq.delta.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.delta.shared.index
...
%dq.gradient.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.gradient.shared.index
...
%dq.key.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.key.shared.index
...
%dq.value.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.value.shared.index
...
%dq.accumulate.gradient.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.accumulate.gradient.index
...
%dq.accumulate.pair.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.accumulate.pair.index
...
%dq.accumulate.key.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.accumulate.key.index
...
%dq.store.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dq.store.shared.index
...
%dkv.key.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.key.p
...
%dkv.value.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.value.shared.index
...
%dkv.key.gradient.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.key.gradient.index
...
%dkv.value.gradient.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.value.gradient.index
...
%dkv.query.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.query.shared.index
...
%dkv.delta.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.delta.shared.index
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.accumulate.key.gradient.index
...
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.accumulate.value.gradient.index
...
%dkv.accumulate.probability.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.accumulate.probability.index
...
%dkv.accumulate.derivative.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.accumulate.derivative.index
...
%dkv.accumulate.query.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.accumulate.query.index
...
%dkv.accumulate.delta.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.accumulate.delta.index
...
%dkv.store.key.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.store.key.shared.index
...
%dkv.store.value.shared.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %dkv.store.value.shared.index
...
%state.zero = call double @recipe.state.from.u1(i1 false) %lid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() %group = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() %block = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() %groups = udiv i32 %threads, %block
...
%gradient.load.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %gradient.load.index store double %gradient.load.value, ptr addrspace(3) %gradient.load.ptr, align 8
br label %gradient.load.advance
...
%gradient.store.ptr = getelementptr inbounds double, ptr addrspace(1) %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load double, ptr %gradient.store.sum.ptr, align 8 %gradient.store.sum = call double @recipe.encode(double %gradient.store.sum.wide) store double %gradient.store.sum, ptr addrspace(1) %gradient.store.ptr, align 8
...
%previous.load.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile_f, i32 0, i32 %previous.load.index store double %previous.load.value, ptr addrspace(3) %previous.load.ptr, align 8
br label %previous.load.advance
...
%previous.store.old = load double, ptr addrspace(1) %previous.store.ptr, align 8 %previous.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %previous.store.register %previous.store.sum.wide = load double, ptr %previous.store.sum.ptr, align 8 %previous.store.sum = call double @recipe.encode(double %previous.store.sum.wide) %previous.store.value = call double @recipe.add(double %previous.store.old, double %previous.store.sum) store double %previous.store.value, ptr addrspace(1) %previous.store.ptr, align 8 br label %previous.store.next
