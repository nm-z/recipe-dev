...
%publish.target = getelementptr double, ptr addrspace(3) @contraction_tile, i32 %publish.target.index
...
%fold.source = getelementptr double, ptr addrspace(3) @contraction_tile, i32 %fold.source.index
