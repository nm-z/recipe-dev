...
declare void @llvm.trap() @contraction_tile_f32 = internal thread_local global [65536 x float] zeroinitializer, align 16
...
%ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %index
...
%target = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %index
...
%publish.target = getelementptr float, ptr @contraction_tile_f32, i32 %publish.target.index
...
%fold.source = getelementptr float, ptr @contraction_tile_f32, i32 %fold.source.index
...
%matrix.a.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.a.index
...
%matrix.b.first.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.b.first.index
...
%matrix.b.second.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.b.second.index
...
%matrix.b.third.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.b.third.index
...
%matrix.b.fourth.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.b.fourth.index
...
br label %load.store
load.store: %load.value = phi float [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %load.tile.index store float %load.value, ptr %load.tile.ptr, align 4
br label %load.advance
load.advance:
...
%left.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %left.index
...
%right.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %right.index
...
%delta.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %delta.index
...
%product.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %product.index
...
%probability.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %probability.index
store float %probability.value, ptr %probability.ptr, align 4
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %derivative.index
...
%query.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %query.p
store float %query.value, ptr %query.shared.ptr, align 4
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %accumulator.index
...
%maximum.ptr.init = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %maximum.index.init
...
%denominator.ptr.init = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %denominator.index.init
...
%key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %key.shared.index
...
%value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %value.shared.index
...
%score.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %score.shared.index
...
%maximum.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %maximum.index
...
%maximum.score.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %maximum.score.index
...
%denominator.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %denominator.index
...
%probability.score.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %probability.score.index
...
%rescale.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %rescale.index
...
%accumulate.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %accumulate.index
...
%accumulate.rescale.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %accumulate.rescale.index
...
%accumulate.probability.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %accumulate.probability.index
...
%accumulate.value.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %accumulate.value.index
...
%output.accumulator.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %output.accumulator.index
...
%output.denominator.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %output.denominator.index
...
%output.maximum.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %output.maximum.index
...
%stage.scalar.ptr.shared = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %stage.scalar.index.shared
...
%matrix.q.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.q.index
...
%matrix.k.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.k.index
...
%matrix.p.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.p.index
...
%normalize.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %normalize.index
...
%d.do.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %d.do.index
...
%d.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %d.index
...
%matrix.do.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x float>, ptr %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.v.index
...
%matrix.d.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.d.index
...
%matrix.ds.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %matrix.ds.index
...
%dq.query.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.query.p
...
%dq.delta.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.delta.shared.index
...
%dq.gradient.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.gradient.shared.index
...
%dq.key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.key.shared.index
...
%dq.value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.value.shared.index
...
%dq.accumulate.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.accumulate.gradient.index
...
%dq.accumulate.pair.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.accumulate.pair.index
...
%dq.accumulate.key.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.accumulate.key.index
...
%dq.store.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dq.store.shared.index
...
%dkv.key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.key.p
...
%dkv.value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.value.shared.index
...
%dkv.key.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.key.gradient.index
...
%dkv.value.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.value.gradient.index
...
%dkv.query.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.query.shared.index
...
%dkv.delta.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.delta.shared.index
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.accumulate.key.gradient.index
...
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.accumulate.value.gradient.index
...
%dkv.accumulate.probability.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.accumulate.probability.index
...
%dkv.accumulate.derivative.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.accumulate.derivative.index
...
%dkv.accumulate.query.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.accumulate.query.index
...
%dkv.accumulate.delta.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.accumulate.delta.index
...
%dkv.store.key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.store.key.shared.index
...
%dkv.store.value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %dkv.store.value.shared.index
...
%gradient.load.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %gradient.load.index store float %gradient.load.value, ptr %gradient.load.ptr, align 4
br label %gradient.load.advance
...
%previous.load.ptr = getelementptr [0 x float], ptr @contraction_tile_f32, i32 0, i32 %previous.load.index store float %previous.load.value, ptr %previous.load.ptr, align 4
br label %previous.load.advance
