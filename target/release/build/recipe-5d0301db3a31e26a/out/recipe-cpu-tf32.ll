...
declare void @llvm.trap() @contraction_tile_tf32 = internal thread_local global [65536 x float] zeroinitializer, align 16
define internal float @contraction_input(
ptr %input, i32 %row.base, i32 %position, i32 %term, i32 %span, i32 %length, i1 %conv ) #1 { entry:
...
%index = add i32 %row.base, %local %ptr = getelementptr inbounds float, ptr %input, i32 %index
%value = load float, ptr %ptr, align 4 ret float %value }
define internal float @contraction_delta(ptr %delta, ptr %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds float, ptr %delta, i32 %index
%delta.value = load float, ptr %delta.ptr, align 4
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds float, ptr %output, i32 %index
%output.value = load float, ptr %output.ptr, align 4
...
define internal <16 x float> @contraction_delta_vector16(ptr %delta, ptr %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds float, ptr %delta, i32 %index
%delta.value = load <16 x float>, ptr %delta.ptr, align 4
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds float, ptr %output, i32 %index
%output.value = load <16 x float>, ptr %output.ptr, align 4
...
define internal void @reduce_rows(ptr %source, ptr %target, i32 %rows, i32 %columns, i32 %stride, i32 %source.offset, i32 %target.offset, i32 %threads) #1 {
entry:
%reduce.lid = add i32 0, 0
%reduce.group = call i32 @recipe.cpu.thread.id()
%reduce.block = add i32 1, 0
...
%target.ptr = getelementptr inbounds float, ptr %target, i32 %target.index
%source.first.index = add i32 %source.offset, %parameter
%source.first.ptr = getelementptr inbounds float, ptr %source, i32 %source.first.index
%source.first = load float, ptr %source.first.ptr, align 4
br label %row.loop
row.loop:
...
%source.ptr = getelementptr inbounds float, ptr %source, i32 %source.index
%source.value = load float, ptr %source.ptr, align 4
%sum.next = call float @recipe.add(float %sum, float %source.value)
%row.next = add i32 %row, 1
br label %row.loop
store:
store float %sum, ptr %target.ptr, align 4
...
%ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %index
...
%ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_M x float>, ptr %ptr, align 4
...
%index = add i32 %base, %local
%ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_N x float>, ptr %ptr, align 4
...
%target = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %index
store float %value, ptr %target, align 4
...
%publish.target = getelementptr float, ptr @contraction_tile_tf32, i32 %publish.target.index
store float %publish.value, ptr %publish.target, align 4
...
%fold.source = getelementptr float, ptr @contraction_tile_tf32, i32 %fold.source.index
%fold.value = load float, ptr %fold.source, align 4
...
%ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %index
%raw = load float, ptr %ptr, align 4 %value = call float @recipe.decode(float %raw) %sum.next = call float @recipe.state.add(float %sum, float %value)
...
%bias.ptr = getelementptr inbounds float, ptr %destination, i32 %bias.index
%bias = call float @recipe.encode(float %sum) store float %bias, ptr %bias.ptr, align 4 br label %channel.done
channel.done:
...
%matrix.a.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.a.index
%matrix.a.loaded = load <16 x float>, ptr %matrix.a.ptr, align 16
...
%matrix.b.first.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.b.first.index
%matrix.b.first.loaded = load <16 x float>, ptr %matrix.b.first.ptr, align 16
...
%matrix.b.second.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.b.second.index
%matrix.b.second.loaded = load <16 x float>, ptr %matrix.b.second.ptr, align 16
...
%matrix.b.third.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.b.third.index
%matrix.b.third.loaded = load <16 x float>, ptr %matrix.b.third.ptr, align 16
...
%matrix.b.fourth.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.b.fourth.index
%matrix.b.fourth.loaded = load <16 x float>, ptr %matrix.b.fourth.ptr, align 16
...
ptr %input, ptr %weights, ptr %output, ptr %activation, i32 %rows, i32 %in.channels, i32 %in.length, i32 %out.channels, i32 %out.length, i32 %kernel,
...
%sums = alloca [RECIPE_REGISTER_COUNT x float], align 4 %state.zero = call float @recipe.state.from.u1(i1 false) %lid = add i32 0, 0 %group = call i32 @recipe.cpu.thread.id() %block = add i32 1, 0 %groups = udiv i32 %threads, %block
...
%a.vector.source = getelementptr inbounds float, ptr %input, i32 %a.vector.index
%a.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr %a.vector.source, align 4
...
load.a.scalar:
%a.loaded = call float @contraction_input( ptr %input, i32 %a.row.base, i32 %a.position, i32 %a.term, i32 %span, i32 %in.length, i1 %is.conv )
br i1 %a.gate, label %load.a.activation, label %load.a.ready
load.a.activation:
%a.activation.channel = mul i32 %a.term, %in.length %a.activation.local = add i32 %a.activation.channel, %a.position %a.activation.index = add i32 %a.row.base, %a.activation.local %a.activation.ptr = getelementptr inbounds float, ptr %activation, i32 %a.activation.index %a.activation.value = load float, ptr %a.activation.ptr, align 2 %a.activation.positive = call i1 @recipe.ogt(float %a.activation.value, float 0.0) %a.gated = select i1 %a.activation.positive, float %a.loaded, float 0.0
...
load.b.vector:
%b.vector.source = getelementptr inbounds float, ptr %weights, i32 %b.index
%b.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr %b.vector.source, align 4
...
br label %load.advance
load.b.scalar:
%b.ptr = getelementptr inbounds float, ptr %weights, i32 %b.index
%b.value = load float, ptr %b.ptr, align 4
br label %load.store
load.store: %load.value = phi float [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %load.tile.index store float %load.value, ptr %load.tile.ptr, align 4
br label %load.advance
load.advance:
...
%store.output.channel.base = mul i32 %store.channel, %out.length %store.output.local = add i32 %store.output.channel.base, %store.position %store.output.index = add i32 %store.output.row.base, %store.output.local %store.output.ptr = getelementptr inbounds float, ptr %output, i32 %store.output.index
%store.bias.base = mul i32 %out.channels, %terms %store.bias.index = add i32 %store.bias.base, %store.channel %store.bias.ptr = getelementptr inbounds float, ptr %weights, i32 %store.bias.index %store.bias = load float, ptr %store.bias.ptr, align 4 %store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %store.register %store.sum.wide = load float, ptr %store.sum.ptr, align 4 %store.sum = call float @recipe.encode(float %store.sum.wide)
%store.biased = call float @recipe.add(float %store.sum, float %store.bias) %store.raw = select i1 %has.bias, float %store.biased, float %store.sum %store.forward = xor i1 %reverse, true %store.activate = and i1 %relu, %store.forward %store.positive = call i1 @recipe.ogt(float %store.raw, float 0.0) %store.activated = select i1 %store.positive, float %store.raw, float 0.0 %store.result = select i1 %store.activate, float %store.activated, float %store.raw %store.prior = load float, ptr %store.output.ptr, align 2 %store.accumulated = call float @recipe.add(float %store.prior, float %store.result) %store.value = select i1 %accumulate, float %store.accumulated, float %store.result store float %store.value, ptr %store.output.ptr, align 4 br label %store.next
...
define internal void @pool_forward_body( ptr %input, ptr %output, ptr %context,
...
%input.ptr = getelementptr inbounds float, ptr %input, i32 %index
%value = load float, ptr %input.ptr, align 4 %greater = call i1 @recipe.ogt(float %value, float %maximum)
...
%output.ptr = getelementptr inbounds float, ptr %output, i32 %p
%context.ptr = getelementptr inbounds i64, ptr %context, i32 %p
%maximum.index.wide = zext i32 %maximum.index to i64
store float %maximum, ptr %output.ptr, align 4
store i64 %maximum.index.wide, ptr %context.ptr, align 4 ret void }
...
%left.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %left.index
...
%right.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %right.index
...
define internal void @attention_tile_products(ptr nocapture readonly %output, i32 %output.row,
...
%delta.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %delta.index
%delta = load float, ptr %delta.ptr, align 4
...
%output.ptr = getelementptr inbounds float, ptr %output, i32 %output.index
%output.value = load float, ptr %output.ptr, align 4
...
%product.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %product.index
store float %sum, ptr %product.ptr, align 4
%query.next = add i32 %query, %block
br label %query.loop
exit:
ret void
}
define internal void @attention_tile_derivatives(ptr nocapture readonly %context,
...
%maximum.ptr = getelementptr inbounds float, ptr %context, i32 %statistics.index
%maximum = load float, ptr %maximum.ptr, align 4
%denominator.index = add i32 %statistics.denominator.base, %statistics.index
%denominator.ptr = getelementptr inbounds float, ptr %context, i32 %denominator.index
%denominator = load float, ptr %denominator.ptr, align 4
...
%product.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %product.index
%product = load float, ptr %product.ptr, align 4
...
%probability.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %probability.index
store float %probability.value, ptr %probability.ptr, align 4
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %derivative.index
store float %derivative.value, ptr %derivative.ptr, align 4
...
ptr nocapture readonly %input, ptr nocapture readonly %weights,
ptr nocapture writeonly %output, ptr %context,
i32 %rows, i32 %from, i32 %heads, i32 %channels, i32 %tile.m, i32 %tile.n, i32 %tile.k, i32 %threads ) #3 { entry:
%lid = add i32 0, 0
%group = call i32 @recipe.cpu.thread.id()
%block = add i32 1, 0
...
%query.input.ptr = getelementptr inbounds float, ptr %input, i32 %query.input.index
%query.value = load float, ptr %query.input.ptr, align 4
%query.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %query.p
store float %query.value, ptr %query.shared.ptr, align 4
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %accumulator.index
store float 0.0, ptr %accumulator.ptr, align 4
...
%maximum.ptr.init = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %maximum.index.init
store float 0xFFF0000000000000, ptr %maximum.ptr.init, align 4
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %denominator.index.init
store float 0.0, ptr %denominator.ptr.init, align 4
...
%key.input.ptr = getelementptr inbounds float, ptr %input, i32 %key.input.index
%key.value = load float, ptr %key.input.ptr, align 4
%key.shared.index = add i32 %key.base.shared, %key.p
%key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %key.shared.index
store float %key.value, ptr %key.shared.ptr, align 4
%value.plane = mul i32 %from, 2
%value.row = add i32 %row.base, %value.plane
%value.input.index = add i32 %value.row, %key.input.local
%value.input.ptr = getelementptr inbounds float, ptr %input, i32 %value.input.index
%value.value = load float, ptr %value.input.ptr, align 4
%value.shared.index = add i32 %value.base.shared, %key.p
%value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %value.shared.index
store float %value.value, ptr %value.shared.ptr, align 4
...
%score.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %score.shared.index
store float %score.value, ptr %score.shared.ptr, align 4
...
%maximum.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %maximum.index
%maximum.old = load float, ptr %maximum.ptr, align 4
...
%maximum.score.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %maximum.score.index
%maximum.score = load float, ptr %maximum.score.ptr, align 4
...
%denominator.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %denominator.index
%denominator.old = load float, ptr %denominator.ptr, align 4
...
%probability.score.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %probability.score.index
%probability.score = load float, ptr %probability.score.ptr, align 4
...
br label %probability.loop
softmax.store:
store float %maximum.value, ptr %maximum.ptr, align 4
store float %denominator.value, ptr %denominator.ptr, align 4
%rescale.index = add i32 %rescale.base.shared, %softmax.query
%rescale.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %rescale.index
store float %old.rescale, ptr %rescale.ptr, align 4
...
%accumulate.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %accumulate.index
%accumulate.old = load float, ptr %accumulate.ptr, align 4
%accumulate.rescale.index = add i32 %rescale.base.shared, %accumulate.query
%accumulate.rescale.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %accumulate.rescale.index
%accumulate.rescale = load float, ptr %accumulate.rescale.ptr, align 4
...
%accumulate.probability.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %accumulate.probability.index
%accumulate.probability = load float, ptr %accumulate.probability.ptr, align 4
...
%accumulate.value.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %accumulate.value.index
%accumulate.v = load float, ptr %accumulate.value.ptr, align 4
...
br label %accumulate.key.loop
accumulate.store:
store float %accumulate.value, ptr %accumulate.ptr, align 4
...
%output.accumulator.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %output.accumulator.index
%output.accumulator = load float, ptr %output.accumulator.ptr, align 4
%output.denominator.index = add i32 %denominator.base.shared, %output.query.local
%output.denominator.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %output.denominator.index
%output.denominator = load float, ptr %output.denominator.ptr, align 4
...
%output.maximum.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %output.maximum.index
%output.maximum = load float, ptr %output.maximum.ptr, align 4
...
%output.statistics.maximum.ptr = getelementptr inbounds float, ptr %context, i32 %output.statistics.index
store float %output.maximum, ptr %output.statistics.maximum.ptr, align 4
%output.statistics.denominator.index = add i32 %statistics.plane, %output.statistics.index
%output.statistics.denominator.ptr = getelementptr inbounds float, ptr %context, i32 %output.statistics.denominator.index
store float %output.denominator, ptr %output.statistics.denominator.ptr, align 4
...
%output.ptr = getelementptr inbounds float, ptr %output, i32 %output.index
store float %attention, ptr %output.ptr, align 4
...
%stage.vector.ptr = getelementptr inbounds float, ptr %input, i32 %stage.vector.index
%stage.vector.value = load <16 x float>, ptr %stage.vector.ptr, align 4
...
%stage.scalar.ptr = getelementptr inbounds float, ptr %input, i32 %stage.scalar.index
%stage.scalar.value = load float, ptr %stage.scalar.ptr, align 4
...
%stage.scalar.ptr.shared = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %stage.scalar.index.shared
store float %stage.scalar.value, ptr %stage.scalar.ptr.shared, align 4
...
%matrix.q.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.q.index
%matrix.q.fragment = load <16 x float>, ptr %matrix.q.ptr, align 2
...
%matrix.k.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.k.index
%matrix.k.fragment = load <16 x float>, ptr %matrix.k.ptr, align 2
...
%matrix.p.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.p.index
store float %matrix.score, ptr %matrix.p.ptr, align 4
...
%maximum.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %maximum.index
%maximum.score = load float, ptr %maximum.ptr, align 4
...
%probability.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %probability.index
%probability.score = load float, ptr %probability.ptr, align 4
...
%normalize.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %normalize.index
%normalize.value = load float, ptr %normalize.ptr, align 4
%normalized = call float @recipe.div(float %normalize.value, float %denominator)
store float %normalized, ptr %normalize.ptr, align 4
...
%maximum.context.ptr = getelementptr inbounds float, ptr %context, i32 %statistics.index
store float %maximum, ptr %maximum.context.ptr, align 4
%denominator.index = add i32 %statistics.rows, %statistics.index
%denominator.ptr = getelementptr inbounds float, ptr %context, i32 %denominator.index
store float %denominator, ptr %denominator.ptr, align 4
%softmax.query.next = add i32 %softmax.query, %block
br label %attention.forward.matrix.softmax.loop
attention.forward.matrix.softmax.done:

call void @attention_matrix_product(ptr %output, i32 3, i32 %p.base, i32 %v.base, i32 %output.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
...
ptr %previous, i32 %mode, i32 %left.base, i32 %right.base,
...
%left.index = add i32 %left.base, %left.local
%left.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %left.index
%left.loaded = load float, ptr %left.ptr, align 4
%right.row = mul i32 %term.safe, %head.width
%right.local = add i32 %right.row, %n.safe
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %right.index
%right.loaded = load float, ptr %right.ptr, align 4
...
%output.index = add i32 %output.row, %output.local
%output.ptr = getelementptr inbounds float, ptr %previous, i32 %output.index
store float %output.value, ptr %output.ptr, align 4
...
ptr nocapture readonly %input, ptr nocapture readonly %output, ptr %context,
ptr nocapture readonly %delta, ptr nocapture writeonly %previous,
i32 %rows, i32 %from, i32 %heads, i32 %channels, i32 %tile.m, i32 %tile.n, i32 %tile.k, i32 %threads ) #3 { entry:
%lid = add i32 0, 0
%group = call i32 @recipe.cpu.thread.id()
%block = add i32 1, 0
...
%stage.vector.input.ptr = getelementptr inbounds float, ptr %input, i32 %stage.vector.input.index
%stage.vector.input.value = load <16 x float>, ptr %stage.vector.input.ptr, align 4
...
%stage.vector.delta.ptr = getelementptr inbounds float, ptr %delta, i32 %stage.vector.delta.index
%stage.vector.delta.value = load <16 x float>, ptr %stage.vector.delta.ptr, align 4
br label %attention.matrix.stage.vector.store
...
%stage.scalar.input.ptr = getelementptr inbounds float, ptr %input, i32 %stage.scalar.input.index
%stage.scalar.input.value = load float, ptr %stage.scalar.input.ptr, align 4
...
%stage.scalar.delta.ptr = getelementptr inbounds float, ptr %delta, i32 %stage.scalar.delta.index
%stage.scalar.delta.value = load float, ptr %stage.scalar.delta.ptr, align 4
br label %attention.matrix.stage.scalar.store
...
%d.do.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %d.do.index
%d.do = load float, ptr %d.do.ptr, align 4
...
%d.output.ptr = getelementptr inbounds float, ptr %output, i32 %d.output.index
%d.output = load float, ptr %d.output.ptr, align 4
...
%d.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %d.index
store float %d.sum, ptr %d.ptr, align 4
...
%matrix.do.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x float>, ptr %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.v.index
%matrix.v.fragment = load <16 x float>, ptr %matrix.v.ptr, align 2
...
%matrix.maximum.ptr = getelementptr inbounds float, ptr %context, i32 %matrix.statistics.index
%matrix.maximum = load float, ptr %matrix.maximum.ptr, align 4
%matrix.denominator.index = add i32 %statistics.rows, %matrix.statistics.index
%matrix.denominator.ptr = getelementptr inbounds float, ptr %context, i32 %matrix.denominator.index
%matrix.denominator = load float, ptr %matrix.denominator.ptr, align 4
...
%matrix.d.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.d.index
%matrix.d = load float, ptr %matrix.d.ptr, align 4
...
%matrix.p.index = add i32 %p.base, %matrix.pair.local
%matrix.p.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.p.index
store float %matrix.probability, ptr %matrix.p.ptr, align 4
%matrix.ds.index = add i32 %ds.base, %matrix.pair.local
%matrix.ds.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %matrix.ds.index
store float %matrix.derivative, ptr %matrix.ds.ptr, align 4
...
call void @attention_matrix_product(ptr %previous, i32 0, i32 %ds.base, i32 %k.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr %previous, i32 1, i32 %ds.base, i32 %q.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr %previous, i32 2, i32 %p.base, i32 %do.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
...
%dq.input.ptr = getelementptr inbounds float, ptr %input, i32 %dq.input.index
%dq.query.value = load float, ptr %dq.input.ptr, align 4
%dq.query.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.query.p
store float %dq.query.value, ptr %dq.query.shared.ptr, align 4
%dq.delta.index = add i32 %dq.output.row, %dq.local
%dq.delta.ptr = getelementptr inbounds float, ptr %delta, i32 %dq.delta.index
%dq.delta.value = load float, ptr %dq.delta.ptr, align 4
%dq.delta.shared.index = add i32 %dq.delta.base.shared, %dq.query.p
%dq.delta.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.delta.shared.index
store float %dq.delta.value, ptr %dq.delta.shared.ptr, align 4
%dq.gradient.shared.index = add i32 %dq.gradient.base.shared, %dq.query.p
%dq.gradient.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.gradient.shared.index
store float 0.0, ptr %dq.gradient.shared.ptr, align 4
%dq.query.p.next = add i32 %dq.query.p, %block
br label %dq.query.stage.loop
dq.query.stage.done:

call void @attention_tile_products(ptr %output, i32 %dq.output.row, i32 %dq.delta.base.shared,
...
%dq.key.input.ptr = getelementptr inbounds float, ptr %input, i32 %dq.key.input.index
%dq.key.value = load float, ptr %dq.key.input.ptr, align 4
%dq.key.shared.index = add i32 %dq.key.base.shared, %dq.key.p
%dq.key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.key.shared.index
store float %dq.key.value, ptr %dq.key.shared.ptr, align 4
...
%dq.value.input.ptr = getelementptr inbounds float, ptr %input, i32 %dq.value.input.index
%dq.value.value = load float, ptr %dq.value.input.ptr, align 4
%dq.value.shared.index = add i32 %dq.value.base.shared, %dq.key.p
%dq.value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.value.shared.index
store float %dq.value.value, ptr %dq.value.shared.ptr, align 4
%dq.key.p.next = add i32 %dq.key.p, %block
br label %dq.key.stage.loop
dq.key.stage.done:

call void @attention_tile_derivatives(ptr %context, i32 0, i32 %dq.key.base.shared,
...
%dq.accumulate.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.accumulate.gradient.index
%dq.accumulate.initial = load float, ptr %dq.accumulate.gradient.ptr, align 4
...
%dq.accumulate.pair.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.accumulate.pair.index
%dq.accumulate.ds = load float, ptr %dq.accumulate.pair.ptr, align 4
...
%dq.accumulate.key.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.accumulate.key.index
%dq.accumulate.key.value = load float, ptr %dq.accumulate.key.ptr, align 4
...
br label %dq.accumulate.key.loop
dq.accumulate.store:
store float %dq.accumulate.value, ptr %dq.accumulate.gradient.ptr, align 4
...
%dq.store.ptr = getelementptr inbounds float, ptr %previous, i32 %dq.store.index
%dq.store.shared.index = add i32 %dq.gradient.base.shared, %dq.store.p
%dq.store.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dq.store.shared.index
%dq.store.value = load float, ptr %dq.store.shared.ptr, align 4
store float %dq.store.value, ptr %dq.store.ptr, align 4
...
%dkv.key.input.ptr = getelementptr inbounds float, ptr %input, i32 %dkv.key.input.index
%dkv.key.value = load float, ptr %dkv.key.input.ptr, align 4
%dkv.key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.key.p
store float %dkv.key.value, ptr %dkv.key.shared.ptr, align 4
...
%dkv.value.input.ptr = getelementptr inbounds float, ptr %input, i32 %dkv.value.input.index
%dkv.value.value = load float, ptr %dkv.value.input.ptr, align 4
%dkv.value.shared.index = add i32 %dkv.value.base.shared, %dkv.key.p
%dkv.value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.value.shared.index
store float %dkv.value.value, ptr %dkv.value.shared.ptr, align 4
%dkv.key.gradient.index = add i32 %dkv.key.gradient.base.shared, %dkv.key.p
%dkv.key.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.key.gradient.index
store float 0.0, ptr %dkv.key.gradient.ptr, align 4
%dkv.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.key.p
%dkv.value.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.value.gradient.index
store float 0.0, ptr %dkv.value.gradient.ptr, align 4
...
%dkv.query.input.ptr = getelementptr inbounds float, ptr %input, i32 %dkv.query.input.index
%dkv.query.value = load float, ptr %dkv.query.input.ptr, align 4
%dkv.query.shared.index = add i32 %dkv.query.base.shared, %dkv.query.p
%dkv.query.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.query.shared.index
store float %dkv.query.value, ptr %dkv.query.shared.ptr, align 4
%dkv.delta.input.index = add i32 %dkv.output.row, %dkv.query.input.local
%dkv.delta.input.ptr = getelementptr inbounds float, ptr %delta, i32 %dkv.delta.input.index
%dkv.delta.value = load float, ptr %dkv.delta.input.ptr, align 4
%dkv.delta.shared.index = add i32 %dkv.delta.base.shared, %dkv.query.p
%dkv.delta.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.delta.shared.index
store float %dkv.delta.value, ptr %dkv.delta.shared.ptr, align 4
%dkv.query.p.next = add i32 %dkv.query.p, %block
br label %dkv.query.stage.loop
dkv.query.stage.done:

call void @attention_tile_products(ptr %output, i32 %dkv.output.row, i32 %dkv.delta.base.shared,
i32 %dkv.product.base.shared, i32 %dkv.query.base, i32 %dkv.query.count, i32 %dkv.head.start,
i32 %head.width, i32 %length, i32 %lid, i32 %block)

call void @attention_tile_derivatives(ptr %context, i32 %dkv.query.base.shared, i32 0,
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.key.gradient.index
%dkv.accumulate.key.initial = load float, ptr %dkv.accumulate.key.gradient.ptr, align 4
%dkv.accumulate.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.accumulate.p
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.value.gradient.index
%dkv.accumulate.value.initial = load float, ptr %dkv.accumulate.value.gradient.ptr, align 4
...
%dkv.accumulate.probability.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.probability.index
%dkv.accumulate.probability = load float, ptr %dkv.accumulate.probability.ptr, align 4
%dkv.accumulate.derivative.index = add i32 %dkv.derivative.base.shared, %dkv.accumulate.pair.local
%dkv.accumulate.derivative.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.derivative.index
%dkv.accumulate.derivative = load float, ptr %dkv.accumulate.derivative.ptr, align 4
...
%dkv.accumulate.query.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.query.index
%dkv.accumulate.query.value = load float, ptr %dkv.accumulate.query.ptr, align 4
%dkv.accumulate.delta.index = add i32 %dkv.delta.base.shared, %dkv.accumulate.query.local
%dkv.accumulate.delta.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.delta.index
%dkv.accumulate.delta = load float, ptr %dkv.accumulate.delta.ptr, align 4
...
store float %dkv.accumulate.key.value, ptr %dkv.accumulate.key.gradient.ptr, align 4
store float %dkv.accumulate.value.value, ptr %dkv.accumulate.value.gradient.ptr, align 4
...
%dkv.store.key.ptr = getelementptr inbounds float, ptr %previous, i32 %dkv.store.key.index
%dkv.store.key.shared.index = add i32 %dkv.key.gradient.base.shared, %dkv.store.p
%dkv.store.key.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.store.key.shared.index
%dkv.store.key.value = load float, ptr %dkv.store.key.shared.ptr, align 4
store float %dkv.store.key.value, ptr %dkv.store.key.ptr, align 4
...
%dkv.store.value.ptr = getelementptr inbounds float, ptr %previous, i32 %dkv.store.value.index
%dkv.store.value.shared.index = add i32 %dkv.value.gradient.base.shared, %dkv.store.p
%dkv.store.value.shared.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %dkv.store.value.shared.index
%dkv.store.value.value = load float, ptr %dkv.store.value.shared.ptr, align 4
store float %dkv.store.value.value, ptr %dkv.store.value.ptr, align 4
...
define internal void @scan_forward_body( ptr %input, ptr %weights, ptr %output,
ptr %context, i32 %rows, i32 %in.channels, i32 %length, i32 %out.channels, i32 %gates,
i32 %tile.m, i32 %tile.n, i32 %tile.k, i32 %threads ) #3 { entry: %tid = call i32 @recipe.cpu.thread.id()
...
%precompute.weights = getelementptr inbounds float, ptr %weights, i32 %precompute.weight.offset
%precompute.context.offset = mul i32 %precompute.gate, %gate.batch
%precompute.context = getelementptr inbounds float, ptr %context, i32 %precompute.context.offset
call void @contraction_forward_body( ptr %input, ptr %precompute.weights,
ptr %precompute.context, ptr %input,
...
call void @recipe.cpu.barrier() br label %row.loop row.loop:
...
%input.ptr = getelementptr inbounds float, ptr %context, i32 %input.index
%input.sum = load float, ptr %input.ptr, align 4 br label %state.sum.loop state.sum.loop:
...
%previous.ptr = getelementptr inbounds float, ptr %output, i32 %previous.index
%previous.loaded = load float, ptr %previous.ptr, align 4
...
%reset.ptr = getelementptr inbounds float, ptr %context, i32 %reset.base
%reset = load float, ptr %reset.ptr, align 4 %reset.state = call float @recipe.mul(float %reset, float %previous)
...
%state.weight.ptr = getelementptr inbounds float, ptr %weights, i32 %state.weight.index
%state.weight = load float, ptr %state.weight.ptr, align 4
...
%bias.ptr = getelementptr inbounds float, ptr %weights, i32 %bias.index
%bias = load float, ptr %bias.ptr, align 4 %linear = call float @recipe.add(float %state.sum, float %bias)
...
%gate.ptr = getelementptr inbounds float, ptr %context, i32 %gate.index
store float %gate.value, ptr %gate.ptr, align 4 %hidden.next = add nuw i32 %hidden, 1
...
%output.index = add i32 %output.row.base, %output.local
%gate0.ptr = getelementptr inbounds float, ptr %context, i32 %output.index
%gate0 = load float, ptr %gate0.ptr, align 4
...
%gate1.ptr = getelementptr inbounds float, ptr %context, i32 %gate1.index
%gate1 = load float, ptr %gate1.ptr, align 4 %gate2.base = mul i32 %gate.batch, 2
...
%gate2.ptr = getelementptr inbounds float, ptr %context, i32 %gate2.index
%gate2 = load float, ptr %gate2.ptr, align 4 %gate3.base = mul i32 %gate.batch, 3
%gate3.raw = add i32 %gate3.base, %output.index %gate3.index = select i1 %is.lstm, i32 %gate3.raw, i32 %output.index
%gate3.ptr = getelementptr inbounds float, ptr %context, i32 %gate3.index
%gate3 = load float, ptr %gate3.ptr, align 4 %output.previous.time = sub i32 %time, 1
...
%output.previous.ptr = getelementptr inbounds float, ptr %output, i32 %output.previous.index
%output.previous.loaded = load float, ptr %output.previous.ptr, align 4
...
%cell.previous.ptr = getelementptr inbounds float, ptr %context, i32 %cell.previous.index
%cell.previous.loaded = load float, ptr %cell.previous.ptr, align 4
...
%cell.ptr = getelementptr inbounds float, ptr %context, i32 %cell.index
store float %cell, ptr %cell.ptr, align 4 %cell.tanh = call float @recipe.tanh(float %cell)
...
%output.ptr = getelementptr inbounds float, ptr %output, i32 %output.index
store float %output.value, ptr %output.ptr, align 4 %output.next = add nuw i32 %output.hidden, 1
...
ptr %input, ptr %weights, ptr %output, ptr %delta, ptr %previous, ptr %gradient, i1 %write.input, i1 %has.bias, i1 %relu, i1 %matrix.gradient,
...
%state.zero = call float @recipe.state.from.u1(i1 false) %lid = add i32 0, 0 %group = call i32 @recipe.cpu.thread.id() %block = add i32 1, 0 %groups = udiv i32 %threads, %block
...
%gradient.scratch = getelementptr inbounds float, ptr %gradient, i32 RECIPE_GRADIENT_SCRATCH_BASE
...
%gradient.destination = select i1 %gradient.direct, ptr %gradient, ptr %gradient.scratch
...
%gradient.a.vector.source = getelementptr inbounds float, ptr %input, i32 %gradient.a.vector.index
%gradient.a.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr %gradient.a.vector.source, align 4
...
%gradient.a.value = call float @contraction_input( ptr %input, i32 %gradient.a.row.base, i32 %gradient.a.position, i32 %gradient.a.term, i32 %span, i32 %in.length, i1 %is.conv )
...
%gradient.b.vector.value = call <RECIPE_FRAGMENT_K x float> @contraction_delta_vector16(ptr %delta, ptr %output, i32 %gradient.b.index, i1 %relu)
...
%gradient.b.value = call float @contraction_delta(ptr %delta, ptr %output, i32 %gradient.b.index, i1 %relu)
br label %gradient.load.store
...
%gradient.load.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %gradient.load.index store float %gradient.load.value, ptr %gradient.load.ptr, align 4
br label %gradient.load.advance
...
call void @contraction_bias_accumulate(ptr %bias.sums, ptr %gradient.destination, i1 %gradient.bias.enable, i1 %gradient.r.first.tile, i1 %gradient.r.last.tile, i32 %lid, i32 %block, i32 %gradient.n.base, i32 %gradient.n.count, i32 %gradient.r.count, i32 %out.channels, i32 %window, i32 %gradient.tile.m, i32 %gradient.tile.n, i32 %gradient.tile.k, i32 %gradient.store.offset)
...
%gradient.store.ptr = getelementptr inbounds float, ptr %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load float, ptr %gradient.store.sum.ptr, align 4 %gradient.store.sum = call float @recipe.encode(float %gradient.store.sum.wide) store float %gradient.store.sum, ptr %gradient.store.ptr, align 4
...
call void @recipe.cpu.barrier()
call void @reduce_rows(ptr %gradient.scratch, ptr %gradient, i32 %gradient.splits, i32 %gradient.values, i32 %gradient.stride, i32 0, i32 %offset, i32 %threads)
...
%previous.a.vector.delta = getelementptr inbounds float, ptr %delta, i32 %previous.a.index
%previous.a.vector.output = getelementptr inbounds float, ptr %output, i32 %previous.a.index
%previous.a.vector.delta.value = load <RECIPE_FRAGMENT_K x float>, ptr %previous.a.vector.delta, align 4
%previous.a.vector.output.value = load <RECIPE_FRAGMENT_K x float>, ptr %previous.a.vector.output, align 4
...
%previous.a.raw = call float @contraction_delta(ptr %delta, ptr %output, i32 %previous.a.index, i1 %relu)
...
%previous.b.vector.source = getelementptr inbounds float, ptr %weights, i32 %previous.b.index
%previous.b.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr %previous.b.vector.source, align 4
...
%previous.b.ptr = getelementptr inbounds float, ptr %weights, i32 %previous.b.index
%previous.b.value = load float, ptr %previous.b.ptr, align 4
br label %previous.load.store
...
%previous.load.ptr = getelementptr [0 x float], ptr @contraction_tile_tf32, i32 0, i32 %previous.load.index store float %previous.load.value, ptr %previous.load.ptr, align 4
br label %previous.load.advance
...
define internal void @scan_reverse_body( ptr %input, ptr %weights, ptr %output,
ptr %context, ptr %delta, ptr %previous,
ptr %gradient, i1 %write.input, i32 %rows, i32 %in.channels,
...
%tid = call i32 @recipe.cpu.thread.id() %in.elements = mul i32 %in.channels, %length
...
%clear.ptr = getelementptr inbounds float, ptr %context, i32 %clear.index
store float 0.0, ptr %clear.ptr, align 4 %clear.next = add nuw i32 %clear.p, 1
...
%clear.dh.ptr = getelementptr inbounds float, ptr %context, i32 %clear.dh.index
%clear.dc.ptr = getelementptr inbounds float, ptr %context, i32 %clear.dc.index
store float 0.0, ptr %clear.dh.ptr, align 4 store float 0.0, ptr %clear.dc.ptr, align 4
...
ptr %delta, i32 %rnn.index %rnn.future.index = add i32 %dh.start, %rnn.hidden
%rnn.future.ptr = getelementptr inbounds float, ptr %context, i32 %rnn.future.index
%rnn.gate.ptr = getelementptr inbounds float, ptr %context, i32 %rnn.index
%rnn.dy = load float, ptr %rnn.dy.ptr, align 4
%rnn.future = load float, ptr %rnn.future.ptr, align 4
%rnn.gate = load float, ptr %rnn.gate.ptr, align 4 %rnn.dh = call float @recipe.add(float %rnn.dy, float %rnn.future)
...
%rnn.delta.ptr = getelementptr inbounds float, ptr %context, i32 %rnn.delta.index
store float %rnn.delta, ptr %rnn.delta.ptr, align 4 %rnn.next = add i32 %rnn.hidden, 1
...
%gru.dy.ptr = getelementptr inbounds float, ptr %delta, i32 %gru.index
%gru.future.index = add i32 %dh.start, %gru.hidden
%gru.future.ptr = getelementptr inbounds float, ptr %context, i32 %gru.future.index
%gru.previous.ptr = getelementptr inbounds float, ptr %output, i32 %gru.previous.index
%gru.z.ptr = getelementptr inbounds float, ptr %context, i32 %gru.index
%gru.n.index = add i32 %gru.index, %gate2.batch
%gru.n.ptr = getelementptr inbounds float, ptr %context, i32 %gru.n.index
%gru.dy = load float, ptr %gru.dy.ptr, align 4
%gru.future = load float, ptr %gru.future.ptr, align 4
%gru.previous.loaded = load float, ptr %gru.previous.ptr, align 4
%gru.previous = select i1 %previous.exists, float %gru.previous.loaded, float 0.0
%gru.z = load float, ptr %gru.z.ptr, align 4
%gru.n = load float, ptr %gru.n.ptr, align 4 %gru.dh = call float @recipe.add(float %gru.dy, float %gru.future)
...
%gru.dz.ptr = getelementptr inbounds float, ptr %context, i32 %gru.dz.index
%gru.dn.ptr = getelementptr inbounds float, ptr %context, i32 %gru.dn.index
store float %gru.dz, ptr %gru.dz.ptr, align 4
store float %gru.dn, ptr %gru.dn.ptr, align 4 %gru.next = add i32 %gru.hidden, 1
...
%gru.weight.ptr = getelementptr inbounds float, ptr %weights, i32 %gru.weight.index
...
%gru.target.delta.ptr = getelementptr inbounds float, ptr %context, i32 %gru.target.delta.index
%gru.weight = load float, ptr %gru.weight.ptr, align 4
%gru.target.delta = load float, ptr %gru.target.delta.ptr, align 4
...
%gru.source.previous.ptr = getelementptr inbounds float, ptr %output, i32 %gru.source.previous.index
%gru.r.index = add i32 %batch, %gru.source.index
%gru.r.ptr = getelementptr inbounds float, ptr %context, i32 %gru.r.index
%gru.source.previous.loaded = load float, ptr %gru.source.previous.ptr, align 4
%gru.source.previous = select i1 %previous.exists, float %gru.source.previous.loaded, float 0.0
%gru.r = load float, ptr %gru.r.ptr, align 4
...
%gru.dr.ptr = getelementptr inbounds float, ptr %context, i32 %gru.dr.index
store float %gru.dr.1, ptr %gru.dr.ptr, align 4 %gru.source.next = add i32 %gru.source, 1
...
%dy.ptr = getelementptr inbounds float, ptr %delta, i32 %index %dh.index = add i32 %dh.start, %hidden
%dc.index = add i32 %dc.start, %hidden %dh.ptr = getelementptr inbounds float, ptr %context, i32 %dh.index
%dc.ptr = getelementptr inbounds float, ptr %context, i32 %dc.index
%cell.ptr = getelementptr inbounds float, ptr %context, i32 %cell.index
%cell.previous.ptr = getelementptr inbounds float, ptr %context, i32 %cell.previous.index
%dy = load float, ptr %dy.ptr, align 4 %dh.future = load float, ptr %dh.ptr, align 4
%dc.future = load float, ptr %dc.ptr, align 4 %cell = load float, ptr %cell.ptr, align 4
%cell.previous.loaded = load float, ptr %cell.previous.ptr, align 4
%cell.previous = select i1 %previous.exists, float %cell.previous.loaded, float 0.0
%i.ptr = getelementptr inbounds float, ptr %context, i32 %index %f.index = add i32 %batch, %index
%o.index = add i32 %f.index, %batch %g.index = add i32 %o.index, %batch
%f.ptr = getelementptr inbounds float, ptr %context, i32 %f.index
%o.ptr = getelementptr inbounds float, ptr %context, i32 %o.index
%g.ptr = getelementptr inbounds float, ptr %context, i32 %g.index
%i = load float, ptr %i.ptr, align 4 %f = load float, ptr %f.ptr, align 4
%o = load float, ptr %o.ptr, align 4 %g = load float, ptr %g.ptr, align 4
...
store float %dc.previous, ptr %dc.ptr, align 4 %delta0.index = add i32 %delta.base, %index
%delta1.index = add i32 %delta0.index, %batch %delta2.index = add i32 %delta1.index, %batch
%delta3.index = add i32 %delta2.index, %batch
%delta0.ptr = getelementptr inbounds float, ptr %context, i32 %delta0.index
%delta1.ptr = getelementptr inbounds float, ptr %context, i32 %delta1.index
%delta2.ptr = getelementptr inbounds float, ptr %context, i32 %delta2.index
%delta3.ptr = getelementptr inbounds float, ptr %context, i32 %delta3.index
store float %di, ptr %delta0.ptr, align 4 store float %df, ptr %delta1.ptr, align 4
store float %do, ptr %delta2.ptr, align 4 store float %dg, ptr %delta3.ptr, align 4
...
%gate.delta.ptr = getelementptr inbounds float, ptr %context, i32 %delta.index
%gate.delta = load float, ptr %gate.delta.ptr, align 4
...
%state.ptr = getelementptr inbounds float, ptr %output, i32 %state.index.value
%state.loaded = load float, ptr %state.ptr, align 4
...
%parameter.reset.ptr = getelementptr inbounds float, ptr %context, i32 %parameter.reset.index
%parameter.reset = load float, ptr %parameter.reset.ptr, align 4
...
%row.gradient.ptr = getelementptr inbounds float, ptr %context, i32 %row.gradient.index
%row.gradient.old = load float, ptr %row.gradient.ptr, align 4
%row.gradient.new = call float @recipe.add(float %row.gradient.old, float %contribution)
store float %row.gradient.new, ptr %row.gradient.ptr, align 4
...
%state.delta.ptr = getelementptr inbounds float, ptr %context, i32 %state.delta.index
%state.weight.value = load float, ptr %state.weight.ptr, align 4
%state.delta.value = load float, ptr %state.delta.ptr, align 4
...
%state.reset.ptr = getelementptr inbounds float, ptr %context, i32 %state.reset.index
%state.reset = load float, ptr %state.reset.ptr, align 4
...
%state.dh.ptr = getelementptr inbounds float, ptr %context, i32 %state.dh.index
...
%state.direct.delta.ptr = getelementptr inbounds float, ptr %delta, i32 %state.direct.index
%state.direct.z.ptr = getelementptr inbounds float, ptr %context, i32 %state.direct.index
%state.direct.dy = load float, ptr %state.direct.delta.ptr, align 4
%state.direct.future = load float, ptr %state.dh.ptr, align 4
%state.direct.z = load float, ptr %state.direct.z.ptr, align 4
...
store float %state.total, ptr %state.dh.ptr, align 4 %state.channel.next = add nuw i32 %state.channel, 1
br label %hidden.gradient.loop time.done: br label %time.loop row.done: %row.next = add i32 %row, %threads
br label %row.loop reduce.entry: call void @recipe.cpu.barrier()
call void @reduce_rows(ptr %context, ptr %gradient, i32 %rows, i32 %parameters, i32 %parameters, i32 %row.gradient.base, i32 %offset, i32 %threads)
br label %projection.entry
projection.entry: call void @recipe.cpu.barrier() br label %projection.loop projection.loop:
...
%projection.weights = getelementptr inbounds float, ptr %weights, i32 %projection.weight.offset
%projection.delta.gate = mul i32 %projection.gate, %batch
%projection.delta.offset = add i32 %delta.base, %projection.delta.gate
%projection.delta = getelementptr inbounds float, ptr %context, i32 %projection.delta.offset
%projection.gradient.offset = add i32 %offset, %projection.weight.offset
call void @contraction_reverse_body( ptr %input, ptr %projection.weights, ptr %output,
ptr %projection.delta, ptr %previous, ptr %gradient, i1 %write.input, i1 false, i1 false, i1 false,
...
i32 %previous.tile.m, i32 %previous.tile.n, i32 %previous.tile.k, i32 %threads ) call void @recipe.cpu.barrier() %projection.next = add i32 %projection.gate, 1 br label %projection.loop
...
!0 = distinct !{!0, !1}
!1 = !{!"llvm.loop.unroll.full"}@recipe.cpu.thread = internal thread_local global i32 0, align 4
@recipe.cpu.barrier.context = internal thread_local global ptr null, align 4
@recipe.cpu.barrier.wait = internal thread_local global ptr null, align 4
define  void @recipe_model_thread(i32 %thread, ptr %context, ptr %wait) #0 { entry: store i32 %thread, ptr @recipe.cpu.thread, align 4 store ptr %context, ptr @recipe.cpu.barrier.context, align 4 store ptr %wait, ptr @recipe.cpu.barrier.wait, align 4 ret void }
define internal i32 @recipe.cpu.thread.id() #1 { entry: %thread = load i32, ptr @recipe.cpu.thread, align 4 ret i32 %thread }
define internal void @recipe.cpu.barrier() #1 { entry: %context = load ptr, ptr @recipe.cpu.barrier.context, align 4 %wait = load ptr, ptr @recipe.cpu.barrier.wait, align 4 call void %wait(ptr %context) ret void }