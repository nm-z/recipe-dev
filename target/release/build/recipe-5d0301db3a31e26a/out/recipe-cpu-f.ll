...
; NUMERIC BEGIN
@recipe_f_exp = internal global i32 undef, align 4
@recipe_f_man = internal global i32 undef, align 4
declare double @llvm.sqrt.f64(double)
declare double @llvm.fabs.f64(double)
declare double @llvm.floor.f64(double)
declare i64 @llvm.ctlz.i64(i64, i1)
declare double @llvm.roundeven.f64(double)
define internal void @recipe.set.format(i32 %exp, i32 %man) #1 { entry: store atomic i32 %exp, ptr @recipe_f_exp monotonic, align 4 store atomic i32 %man, ptr @recipe_f_man monotonic, align 4 ret void }
...
define internal double @recipe.math.exp(double %value) #1 { entry: %result = call double @recipe.math.exp.wide(double %value) ret double %result }
define internal double @recipe.math.tanh(double %value) #1 { entry: %result = call double @recipe.math.tanh.wide(double %value) ret double %result }
define internal double @recipe.math.cos(double %value) #1 { entry: %result = call double @recipe.math.cos.wide(double %value) ret double %result }
define internal double @recipe.math.sin(double %value) #1 { entry: %result = call double @recipe.math.sin.wide(double %value) ret double %result }
define internal double @recipe.math.log(double %value) #1 { entry: %result = call double @recipe.math.log.wide(double %value) ret double %result }
define internal double @recipe.add(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %wide = fadd double %left.wide, %right.wide %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.sub(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %wide = fsub double %left.wide, %right.wide %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.mul(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %wide = fmul double %left.wide, %right.wide %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.div(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %wide = fdiv double %left.wide, %right.wide %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.madd(double %sum, double %left, double %right) #1 { entry: %sum.wide = call double @recipe.decode(double %sum) %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %wide = call double @llvm.fma.f64(double %left.wide, double %right.wide, double %sum.wide) %result = call double @recipe.encode(double %wide) ret double %result }
declare <RECIPE_REGISTER_M x double> @llvm.fma.vRECIPE_REGISTER_Mf64(<RECIPE_REGISTER_M x double>, <RECIPE_REGISTER_M x double>, <RECIPE_REGISTER_M x double>)
define internal <RECIPE_REGISTER_M x double> @recipe.madd.vector(<RECIPE_REGISTER_M x double> %sum, <RECIPE_REGISTER_M x double> %left, <RECIPE_REGISTER_M x double> %right) #1 {
entry:
%result = call <RECIPE_REGISTER_M x double> @llvm.fma.vRECIPE_REGISTER_Mf64(<RECIPE_REGISTER_M x double> %left, <RECIPE_REGISTER_M x double> %right, <RECIPE_REGISTER_M x double> %sum)
ret <RECIPE_REGISTER_M x double> %result
}
define internal double @recipe.neg(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %negative = fneg double %wide %result = call double @recipe.encode(double %negative) ret double %result }
define internal i1 @recipe.oeq(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp oeq double %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.oge(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp oge double %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ogt(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp ogt double %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ole(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp ole double %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.olt(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp olt double %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.one(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp one double %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ord(double %left, double %right) #1 { entry: %left.wide = call double @recipe.decode(double %left) %right.wide = call double @recipe.decode(double %right) %result = fcmp ord double %left.wide, %right.wide ret i1 %result }
define internal double @recipe.from.u1(i1 %value) #1 { entry: %wide = uitofp i1 %value to double %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.from.u32(i32 %value) #1 { entry: %wide = uitofp i32 %value to double %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.from.s32(i32 %value) #1 { entry: %wide = sitofp i32 %value to double %result = call double @recipe.encode(double %wide) ret double %result }
define internal i32 @recipe.to.u32(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %result = fptoui double %wide to i32 ret i32 %result }
define internal i32 @recipe.to.s32(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %result = fptosi double %wide to i32 ret i32 %result }
define internal double @recipe.from.f32(float %value) #1 { entry: %wide = fpext float %value to double %result = call double @recipe.encode(double %wide) ret double %result }
define internal double @recipe.from.f16(half %value) #1 { entry: %wide = fpext half %value to double %result = call double @recipe.encode(double %wide) ret double %result }
define internal half @recipe.to.f16(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %result = fptrunc double %wide to half ret half %result }
define internal double @recipe.abs(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @llvm.fabs.f64(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.floor(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @llvm.floor.f64(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.sqrt(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @llvm.sqrt.f64(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.exp(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @recipe.math.exp(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.tanh(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @recipe.math.tanh(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.cos(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @recipe.math.cos(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.sin(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @recipe.math.sin(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.log(double %value) #1 { entry: %wide = call double @recipe.decode(double %value) %computed = call double @recipe.math.log(double %wide) %result = call double @recipe.encode(double %computed) ret double %result }
define internal double @recipe.sigmoid(double %value) #1 { entry: %negative = call double @recipe.neg(double %value) %exponential = call double @recipe.exp(double %negative) %one = call double @recipe.from.u1(i1 true) %denominator = call double @recipe.add(double %exponential, double %one) %result = call double @recipe.div(double %one, double %denominator) ret double %result }
define internal double @recipe.state.add(double %left, double %right) #1 { entry: %result = fadd double %left, %right ret double %result }
define internal double @recipe.state.sub(double %left, double %right) #1 { entry: %result = fsub double %left, %right ret double %result }
define internal double @recipe.state.mul(double %left, double %right) #1 { entry: %result = fmul double %left, %right ret double %result }
define internal double @recipe.state.div(double %left, double %right) #1 { entry: %result = fdiv double %left, %right ret double %result }
define internal double @recipe.state.madd(double %sum, double %left, double %right) #1 { entry: %result = call double @llvm.fma.f64(double %left, double %right, double %sum) ret double %result }
define internal <RECIPE_REGISTER_M x double> @recipe.state.madd.vector(<RECIPE_REGISTER_M x double> %sum, <RECIPE_REGISTER_M x double> %left, <RECIPE_REGISTER_M x double> %right) #1 {
entry:
%result = call <RECIPE_REGISTER_M x double> @llvm.fma.vRECIPE_REGISTER_Mf64(<RECIPE_REGISTER_M x double> %left, <RECIPE_REGISTER_M x double> %right, <RECIPE_REGISTER_M x double> %sum)
ret <RECIPE_REGISTER_M x double> %result
}
define internal double @recipe.state.neg(double %value) #1 { entry: %result = fneg double %value ret double %result }
define internal i1 @recipe.state.oeq(double %left, double %right) #1 { entry: %result = fcmp oeq double %left, %right ret i1 %result }
define internal i1 @recipe.state.oge(double %left, double %right) #1 { entry: %result = fcmp oge double %left, %right ret i1 %result }
define internal i1 @recipe.state.ogt(double %left, double %right) #1 { entry: %result = fcmp ogt double %left, %right ret i1 %result }
define internal i1 @recipe.state.ole(double %left, double %right) #1 { entry: %result = fcmp ole double %left, %right ret i1 %result }
define internal i1 @recipe.state.olt(double %left, double %right) #1 { entry: %result = fcmp olt double %left, %right ret i1 %result }
define internal i1 @recipe.state.one(double %left, double %right) #1 { entry: %result = fcmp one double %left, %right ret i1 %result }
define internal i1 @recipe.state.ord(double %left, double %right) #1 { entry: %result = fcmp ord double %left, %right ret i1 %result }
define internal double @recipe.state.from.u1(i1 %value) #1 { entry: %result = uitofp i1 %value to double ret double %result }
define internal double @recipe.state.from.u32(i32 %value) #1 { entry: %result = uitofp i32 %value to double ret double %result }
define internal double @recipe.state.from.s32(i32 %value) #1 { entry: %result = sitofp i32 %value to double ret double %result }
define internal i32 @recipe.state.to.u32(double %value) #1 { entry: %result = fptoui double %value to i32 ret i32 %result }
define internal i32 @recipe.state.to.s32(double %value) #1 { entry: %result = fptosi double %value to i32 ret i32 %result }
define internal double @recipe.state.from.f32(float %value) #1 { entry: %wide = fpext float %value to double ret double %wide }
define internal double @recipe.state.from.f16(half %value) #1 { entry: %wide = fpext half %value to double ret double %wide }
define internal half @recipe.state.to.f16(double %value) #1 { entry: %wide = fadd double %value, 0.0 %result = fptrunc double %wide to half ret half %result }
define internal double @recipe.state.abs(double %value) #1 { entry: %result = call double @llvm.fabs.f64(double %value) ret double %result }
define internal double @recipe.state.floor(double %value) #1 { entry: %result = call double @llvm.floor.f64(double %value) ret double %result }
define internal double @recipe.state.sqrt(double %value) #1 { entry: %result = call double @llvm.sqrt.f64(double %value) ret double %result }
define internal double @recipe.state.exp(double %value) #1 { entry: %result = call double @recipe.math.exp(double %value) ret double %result }
define internal double @recipe.state.tanh(double %value) #1 { entry: %result = call double @recipe.math.tanh(double %value) ret double %result }
define internal double @recipe.state.cos(double %value) #1 { entry: %result = call double @recipe.math.cos(double %value) ret double %result }
define internal double @recipe.state.sin(double %value) #1 { entry: %result = call double @recipe.math.sin(double %value) ret double %result }
define internal double @recipe.state.log(double %value) #1 { entry: %result = call double @recipe.math.log(double %value) ret double %result }
define internal double @recipe.state.sigmoid(double %value) #1 { entry: %negative = call double @recipe.state.neg(double %value) %exponential = call double @recipe.state.exp(double %negative) %one = call double @recipe.state.from.u1(i1 true) %denominator = call double @recipe.state.add(double %exponential, double %one) %result = call double @recipe.state.div(double %one, double %denominator) ret double %result }
define internal double @recipe.state.from.model(double %value) #1 { entry: %result = call double @recipe.decode(double %value) ret double %result }
define internal double @recipe.model.from.state(double %value) #1 { entry: %result = call double @recipe.encode(double %value) ret double %result }
; NUMERIC END

 
declare void @llvm.trap() @contraction_tile_f = internal thread_local global [65536 x double] zeroinitializer, align 16
...
%index = add i32 %row.base, %local %ptr = getelementptr inbounds double, ptr %input, i32 %index
%value = load double, ptr %ptr, align 8 ret double %value }
define internal double @contraction_delta(ptr %delta, ptr %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds double, ptr %delta, i32 %index
%delta.value = load double, ptr %delta.ptr, align 8
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds double, ptr %output, i32 %index
%output.value = load double, ptr %output.ptr, align 8
...
define internal <16 x double> @contraction_delta_vector16(ptr %delta, ptr %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds double, ptr %delta, i32 %index
%delta.value = load <16 x double>, ptr %delta.ptr, align 8
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds double, ptr %output, i32 %index
%output.value = load <16 x double>, ptr %output.ptr, align 8
...
%target.ptr = getelementptr inbounds double, ptr %target, i32 %target.index
%source.first.index = add i32 %source.offset, %parameter
%source.first.ptr = getelementptr inbounds double, ptr %source, i32 %source.first.index
%source.first = load double, ptr %source.first.ptr, align 8
br label %row.loop
row.loop:
...
%source.ptr = getelementptr inbounds double, ptr %source, i32 %source.index
%source.value = load double, ptr %source.ptr, align 8
%sum.next = call double @recipe.add(double %sum, double %source.value)
%row.next = add i32 %row, 1
br label %row.loop
store:
store double %sum, ptr %target.ptr, align 8
...
%ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %index
store double %value, ptr %ptr, align 8
%j.next = add i32 %j, 1
br label %loop
done:
ret void
...
%ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_M x double>, ptr %ptr, align 8
...
%index = add i32 %base, %local
%ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_N x double>, ptr %ptr, align 8
...
%target = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %index
store double %value, ptr %target, align 8
...
entry:
%chunk.sums = alloca [RECIPE_CHUNK_VALUES x double], align 8
%state.zero = call double @recipe.state.from.u1(i1 false)
...
local.k.begin:
%local.sums.initial = load <RECIPE_REGISTER_COUNT x double>, ptr %sums, align 8
...
%local.sums = phi <RECIPE_REGISTER_COUNT x double> [ %local.sums.initial, %local.k.begin ], [ %local.sums.current, %local.product.done ]
...
%local.a.wide = call <RECIPE_REGISTER_M x double> @contraction_widen_m(<RECIPE_REGISTER_M x double> %local.a.fragment)
br label %local.product.loop
local.product.loop:
%local.product = phi i32 [ 0, %local.k.loop ], [ %local.product.next, %local.product.step ]
%local.sums.current = phi <RECIPE_REGISTER_COUNT x double> [ %local.sums, %local.k.loop ], [ %local.candidate, %local.product.step ]
...
%local.a = extractelement <RECIPE_REGISTER_M x double> %local.a.wide, i32 %local.a.index
%local.b = extractelement <RECIPE_REGISTER_N x double> %local.b.fragment, i32 %local.b.index
%local.b.wide = call double @recipe.decode(double %local.b)
%local.sum = extractelement <RECIPE_REGISTER_COUNT x double> %local.sums.current, i32 %local.product
%local.value = call double @recipe.state.madd(double %local.sum, double %local.a, double %local.b.wide)
%local.candidate = insertelement <RECIPE_REGISTER_COUNT x double> %local.sums.current, double %local.value, i32 %local.product
...
local.store:
store <RECIPE_REGISTER_COUNT x double> %local.sums.current, ptr %sums, align 8
br label %exit
shared.chunk.loop:
...
%zero.ptr = getelementptr double, ptr %chunk.sums, i32 %zero.index
store double %state.zero, ptr %zero.ptr, align 8
...
%a.wide = call <RECIPE_REGISTER_M x double> @contraction_widen_m(<RECIPE_REGISTER_M x double> %a.fragment)
...
%b.wide = call double @recipe.decode(double %b)
%b.seed = insertelement <RECIPE_REGISTER_M x double> poison, double %b.wide, i32 0
...
%sum.ptr = getelementptr double, ptr %chunk.sums, i32 %sum.index
%sum = load <RECIPE_REGISTER_M x double>, ptr %sum.ptr, align 8
%candidate = call <RECIPE_REGISTER_M x double> @recipe.state.madd.vector(<RECIPE_REGISTER_M x double> %sum, <RECIPE_REGISTER_M x double> %a.wide, <RECIPE_REGISTER_M x double> %b.vector)
store <RECIPE_REGISTER_M x double> %candidate, ptr %sum.ptr, align 8
...
%publish.source = getelementptr double, ptr %chunk.sums, i32 %publish.source.index
%publish.value = load double, ptr %publish.source, align 8
...
%publish.target = getelementptr double, ptr @contraction_tile_f, i32 %publish.target.index
store double %publish.value, ptr %publish.target, align 8
...
%fold.source = getelementptr double, ptr @contraction_tile_f, i32 %fold.source.index
%fold.value = load double, ptr %fold.source, align 8
%fold.target = getelementptr double, ptr %sums, i32 %fold.r
%fold.current = load double, ptr %fold.target, align 8
%fold.next = call double @recipe.state.add(double %fold.current, double %fold.value)
store double %fold.next, ptr %fold.target, align 8
...
%zero = call double @recipe.state.from.u1(i1 false) br i1 %enable, label %channel.loop, label %exit
channel.loop:
...
channel.begin:
%sum.ptr = getelementptr [RECIPE_REGISTER_N x double], ptr %sums, i32 0, i32 %slot
%previous = load double, ptr %sum.ptr, align 8 %initial = select i1 %first, double %zero, double %previous br label %r.loop
r.loop:
%r = phi i32 [ 0, %channel.begin ], [ %r.next, %r.step ] %sum = phi double [ %initial, %channel.begin ], [ %sum.next, %r.step ]
...
%ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %index
%raw = load double, ptr %ptr, align 8 %value = call double @recipe.decode(double %raw) %sum.next = call double @recipe.state.add(double %sum, double %value)
%r.next = add i32 %r, 1 br label %r.loop
sum.store:
store double %sum, ptr %sum.ptr, align 8 br i1 %last, label %destination.store, label %channel.done
destination.store:
...
%bias.ptr = getelementptr inbounds double, ptr %destination, i32 %bias.index
%bias = call double @recipe.encode(double %sum) store double %bias, ptr %bias.ptr, align 8 br label %channel.done
channel.done:
...
define internal <RECIPE_REGISTER_M x double> @contraction_widen_m(<RECIPE_REGISTER_M x double> %source) #1 {
entry:
br label %loop
loop:
%p = phi i32 [ 0, %entry ], [ %p.next, %step ]
%result = phi <RECIPE_REGISTER_M x double> [ poison, %entry ], [ %next, %step ]
%more = icmp ult i32 %p, RECIPE_REGISTER_M
br i1 %more, label %step, label %done
step:
%value = extractelement <RECIPE_REGISTER_M x double> %source, i32 %p
%wide = call double @recipe.decode(double %value)
%next = insertelement <RECIPE_REGISTER_M x double> %result, double %wide, i32 %p
%p.next = add i32 %p, 1
br label %loop
done:
ret <RECIPE_REGISTER_M x double> %result
...
declare <8 x double> @recipe.wmma(<16 x double>, <16 x double>, <8 x double>)
...
%matrix.first = phi <8 x double> [ zeroinitializer, %entry ], [ %matrix.first.next, %matrix.k.done ]
%matrix.second = phi <8 x double> [ zeroinitializer, %entry ], [ %matrix.second.next, %matrix.k.done ]
%matrix.third = phi <8 x double> [ zeroinitializer, %entry ], [ %matrix.third.next, %matrix.k.done ]
%matrix.fourth = phi <8 x double> [ zeroinitializer, %entry ], [ %matrix.fourth.next, %matrix.k.done ]
...
%matrix.a.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.a.index
%matrix.a.loaded = load <16 x double>, ptr %matrix.a.ptr, align 16
...
%matrix.b.first.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.b.first.index
%matrix.b.first.loaded = load <16 x double>, ptr %matrix.b.first.ptr, align 16
...
%matrix.b.second.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.b.second.index
%matrix.b.second.loaded = load <16 x double>, ptr %matrix.b.second.ptr, align 16
...
%matrix.b.third.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.b.third.index
%matrix.b.third.loaded = load <16 x double>, ptr %matrix.b.third.ptr, align 16
...
%matrix.b.fourth.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.b.fourth.index
%matrix.b.fourth.loaded = load <16 x double>, ptr %matrix.b.fourth.ptr, align 16
%matrix.b.fourth.full = select i1 %n.fourth.valid, <16 x double> %matrix.b.fourth.loaded, <16 x double> zeroinitializer
%matrix.first.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.a.full, <16 x double> %matrix.b.first.full, <8 x double> %matrix.first)
%matrix.second.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.a.full, <16 x double> %matrix.b.second.full, <8 x double> %matrix.second)
%matrix.third.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.a.full, <16 x double> %matrix.b.third.full, <8 x double> %matrix.third)
%matrix.fourth.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.a.full, <16 x double> %matrix.b.fourth.full, <8 x double> %matrix.fourth)
...
matrix.store.step:
%matrix.first.value = extractelement <8 x double> %matrix.first, i32 %matrix.register
%matrix.first.target = getelementptr double, ptr %sums, i32 %matrix.register
%matrix.first.current = load double, ptr %matrix.first.target, align 8
%matrix.first.sum = call double @recipe.state.add(double %matrix.first.current, double %matrix.first.value)
store double %matrix.first.sum, ptr %matrix.first.target, align 8
%matrix.second.register = add i32 %matrix.register, 8
%matrix.second.value = extractelement <8 x double> %matrix.second, i32 %matrix.register
%matrix.second.target = getelementptr double, ptr %sums, i32 %matrix.second.register
%matrix.second.current = load double, ptr %matrix.second.target, align 8
%matrix.second.sum = call double @recipe.state.add(double %matrix.second.current, double %matrix.second.value)
store double %matrix.second.sum, ptr %matrix.second.target, align 8
%matrix.third.register = add i32 %matrix.register, 16
%matrix.third.value = extractelement <8 x double> %matrix.third, i32 %matrix.register
%matrix.third.target = getelementptr double, ptr %sums, i32 %matrix.third.register
%matrix.third.current = load double, ptr %matrix.third.target, align 8
%matrix.third.sum = call double @recipe.state.add(double %matrix.third.current, double %matrix.third.value)
store double %matrix.third.sum, ptr %matrix.third.target, align 8
%matrix.fourth.register = add i32 %matrix.register, 24
%matrix.fourth.value = extractelement <8 x double> %matrix.fourth, i32 %matrix.register
%matrix.fourth.target = getelementptr double, ptr %sums, i32 %matrix.fourth.register
%matrix.fourth.current = load double, ptr %matrix.fourth.target, align 8
%matrix.fourth.sum = call double @recipe.state.add(double %matrix.fourth.current, double %matrix.fourth.value)
store double %matrix.fourth.sum, ptr %matrix.fourth.target, align 8
...
%sums = alloca [RECIPE_REGISTER_COUNT x double], align 8 %state.zero = call double @recipe.state.from.u1(i1 false) %lid = add i32 0, 0 %group = call i32 @recipe.cpu.thread.id() %block = add i32 1, 0 %groups = udiv i32 %threads, %block
...
sum.init.step: %sum.init.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %sum.init store double %state.zero, ptr %sum.init.ptr, align 8 %sum.init.next = add i32 %sum.init, 1 br label %sum.init.loop sum.init.done: br label %tile.loop tile.loop:
...
%a.vector.source = getelementptr inbounds double, ptr %input, i32 %a.vector.index
%a.vector.value = load <RECIPE_FRAGMENT_K x double>, ptr %a.vector.source, align 8
...
load.a.scalar:
%a.loaded = call double @contraction_input( ptr %input, i32 %a.row.base, i32 %a.position, i32 %a.term, i32 %span, i32 %in.length, i1 %is.conv )
br i1 %a.gate, label %load.a.activation, label %load.a.ready
load.a.activation:
%a.activation.channel = mul i32 %a.term, %in.length %a.activation.local = add i32 %a.activation.channel, %a.position %a.activation.index = add i32 %a.row.base, %a.activation.local %a.activation.ptr = getelementptr inbounds double, ptr %activation, i32 %a.activation.index %a.activation.value = load double, ptr %a.activation.ptr, align 2 %a.activation.positive = call i1 @recipe.ogt(double %a.activation.value, double 0.0) %a.gated = select i1 %a.activation.positive, double %a.loaded, double 0.0
...
load.b.vector:
%b.vector.source = getelementptr inbounds double, ptr %weights, i32 %b.index
%b.vector.value = load <RECIPE_FRAGMENT_K x double>, ptr %b.vector.source, align 8
...
br label %load.advance
load.b.scalar:
%b.ptr = getelementptr inbounds double, ptr %weights, i32 %b.index
%b.value = load double, ptr %b.ptr, align 8
br label %load.store
load.store: %load.value = phi double [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %load.tile.index store double %load.value, ptr %load.tile.ptr, align 8
br label %load.advance
load.advance:
...
%store.output.channel.base = mul i32 %store.channel, %out.length %store.output.local = add i32 %store.output.channel.base, %store.position %store.output.index = add i32 %store.output.row.base, %store.output.local %store.output.ptr = getelementptr inbounds double, ptr %output, i32 %store.output.index
%store.bias.base = mul i32 %out.channels, %terms %store.bias.index = add i32 %store.bias.base, %store.channel %store.bias.ptr = getelementptr inbounds double, ptr %weights, i32 %store.bias.index %store.bias = load double, ptr %store.bias.ptr, align 8 %store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %store.register %store.sum.wide = load double, ptr %store.sum.ptr, align 8 %store.sum = call double @recipe.encode(double %store.sum.wide)
%store.biased = call double @recipe.add(double %store.sum, double %store.bias) %store.raw = select i1 %has.bias, double %store.biased, double %store.sum %store.forward = xor i1 %reverse, true %store.activate = and i1 %relu, %store.forward %store.positive = call i1 @recipe.ogt(double %store.raw, double 0.0) %store.activated = select i1 %store.positive, double %store.raw, double 0.0 %store.result = select i1 %store.activate, double %store.activated, double %store.raw %store.prior = load double, ptr %store.output.ptr, align 2 %store.accumulated = call double @recipe.add(double %store.prior, double %store.result) %store.value = select i1 %accumulate, double %store.accumulated, double %store.result store double %store.value, ptr %store.output.ptr, align 8 br label %store.next
...
%input.ptr = getelementptr inbounds double, ptr %input, i32 %index
%value = load double, ptr %input.ptr, align 8 %greater = call i1 @recipe.ogt(double %value, double %maximum)
...
%output.ptr = getelementptr inbounds double, ptr %output, i32 %p
%context.ptr = getelementptr inbounds i64, ptr %context, i32 %p
%maximum.index.wide = zext i32 %maximum.index to i64
store double %maximum, ptr %output.ptr, align 8
store i64 %maximum.index.wide, ptr %context.ptr, align 8 ret void }
...
%left.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %left.index
...
%right.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %right.index
...
%delta.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %delta.index
%delta = load double, ptr %delta.ptr, align 8
...
%output.ptr = getelementptr inbounds double, ptr %output, i32 %output.index
%output.value = load double, ptr %output.ptr, align 8
...
%product.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %product.index
store double %sum, ptr %product.ptr, align 8
...
%maximum.ptr = getelementptr inbounds double, ptr %context, i32 %statistics.index
%maximum = load double, ptr %maximum.ptr, align 8
%denominator.index = add i32 %statistics.denominator.base, %statistics.index
%denominator.ptr = getelementptr inbounds double, ptr %context, i32 %denominator.index
%denominator = load double, ptr %denominator.ptr, align 8
...
%product.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %product.index
%product = load double, ptr %product.ptr, align 8
...
%probability.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %probability.index
store double %probability.value, ptr %probability.ptr, align 8
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %derivative.index
store double %derivative.value, ptr %derivative.ptr, align 8
...
%query.input.ptr = getelementptr inbounds double, ptr %input, i32 %query.input.index
%query.value = load double, ptr %query.input.ptr, align 8
%query.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %query.p
store double %query.value, ptr %query.shared.ptr, align 8
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %accumulator.index
store double 0.0, ptr %accumulator.ptr, align 8
...
%maximum.ptr.init = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %maximum.index.init
store double 0xFFF0000000000000, ptr %maximum.ptr.init, align 8
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %denominator.index.init
store double 0.0, ptr %denominator.ptr.init, align 8
...
%key.input.ptr = getelementptr inbounds double, ptr %input, i32 %key.input.index
%key.value = load double, ptr %key.input.ptr, align 8
%key.shared.index = add i32 %key.base.shared, %key.p
%key.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %key.shared.index
store double %key.value, ptr %key.shared.ptr, align 8
%value.plane = mul i32 %from, 2
%value.row = add i32 %row.base, %value.plane
%value.input.index = add i32 %value.row, %key.input.local
%value.input.ptr = getelementptr inbounds double, ptr %input, i32 %value.input.index
%value.value = load double, ptr %value.input.ptr, align 8
%value.shared.index = add i32 %value.base.shared, %key.p
%value.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %value.shared.index
store double %value.value, ptr %value.shared.ptr, align 8
...
%score.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %score.shared.index
store double %score.value, ptr %score.shared.ptr, align 8
...
%maximum.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %maximum.index
%maximum.old = load double, ptr %maximum.ptr, align 8
...
%maximum.score.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %maximum.score.index
%maximum.score = load double, ptr %maximum.score.ptr, align 8
...
%denominator.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %denominator.index
%denominator.old = load double, ptr %denominator.ptr, align 8
...
%probability.score.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %probability.score.index
%probability.score = load double, ptr %probability.score.ptr, align 8
...
br label %probability.loop
softmax.store:
store double %maximum.value, ptr %maximum.ptr, align 8
store double %denominator.value, ptr %denominator.ptr, align 8
%rescale.index = add i32 %rescale.base.shared, %softmax.query
%rescale.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %rescale.index
store double %old.rescale, ptr %rescale.ptr, align 8
...
%accumulate.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %accumulate.index
%accumulate.old = load double, ptr %accumulate.ptr, align 8
%accumulate.rescale.index = add i32 %rescale.base.shared, %accumulate.query
%accumulate.rescale.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %accumulate.rescale.index
%accumulate.rescale = load double, ptr %accumulate.rescale.ptr, align 8
...
%accumulate.probability.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %accumulate.probability.index
%accumulate.probability = load double, ptr %accumulate.probability.ptr, align 8
...
%accumulate.value.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %accumulate.value.index
%accumulate.v = load double, ptr %accumulate.value.ptr, align 8
...
br label %accumulate.key.loop
accumulate.store:
store double %accumulate.value, ptr %accumulate.ptr, align 8
...
%output.accumulator.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %output.accumulator.index
%output.accumulator = load double, ptr %output.accumulator.ptr, align 8
%output.denominator.index = add i32 %denominator.base.shared, %output.query.local
%output.denominator.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %output.denominator.index
%output.denominator = load double, ptr %output.denominator.ptr, align 8
...
%output.maximum.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %output.maximum.index
%output.maximum = load double, ptr %output.maximum.ptr, align 8
...
%output.statistics.maximum.ptr = getelementptr inbounds double, ptr %context, i32 %output.statistics.index
store double %output.maximum, ptr %output.statistics.maximum.ptr, align 8
%output.statistics.denominator.index = add i32 %statistics.plane, %output.statistics.index
%output.statistics.denominator.ptr = getelementptr inbounds double, ptr %context, i32 %output.statistics.denominator.index
store double %output.denominator, ptr %output.statistics.denominator.ptr, align 8
...
%output.ptr = getelementptr inbounds double, ptr %output, i32 %output.index
store double %attention, ptr %output.ptr, align 8
...
%stage.vector.ptr = getelementptr inbounds double, ptr %input, i32 %stage.vector.index
%stage.vector.value = load <16 x double>, ptr %stage.vector.ptr, align 8
...
%stage.scalar.ptr = getelementptr inbounds double, ptr %input, i32 %stage.scalar.index
%stage.scalar.value = load double, ptr %stage.scalar.ptr, align 8
...
%stage.scalar.ptr.shared = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %stage.scalar.index.shared
store double %stage.scalar.value, ptr %stage.scalar.ptr.shared, align 8
...
%matrix.accumulator = phi <8 x double> [ zeroinitializer, %attention.forward.matrix.score.job.step ], [ %matrix.accumulator.next, %attention.forward.matrix.score.width.step ]
...
%matrix.q.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.q.index
%matrix.q.fragment = load <16 x double>, ptr %matrix.q.ptr, align 2
...
%matrix.k.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.k.index
%matrix.k.fragment = load <16 x double>, ptr %matrix.k.ptr, align 2
%matrix.accumulator.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.q.fragment, <16 x double> %matrix.k.fragment, <8 x double> %matrix.accumulator)
...
%matrix.score.wide = extractelement <8 x double> %matrix.accumulator, i32 %matrix.output
%matrix.score.raw = call double @recipe.encode(double %matrix.score.wide)
...
%matrix.p.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.p.index
store double %matrix.score, ptr %matrix.p.ptr, align 8
...
%maximum.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %maximum.index
%maximum.score = load double, ptr %maximum.ptr, align 8
...
%probability.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %probability.index
%probability.score = load double, ptr %probability.ptr, align 8
...
%normalize.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %normalize.index
%normalize.value = load double, ptr %normalize.ptr, align 8
%normalized = call double @recipe.div(double %normalize.value, double %denominator)
store double %normalized, ptr %normalize.ptr, align 8
...
%maximum.context.ptr = getelementptr inbounds double, ptr %context, i32 %statistics.index
store double %maximum, ptr %maximum.context.ptr, align 8
%denominator.index = add i32 %statistics.rows, %statistics.index
%denominator.ptr = getelementptr inbounds double, ptr %context, i32 %denominator.index
store double %denominator, ptr %denominator.ptr, align 8
%softmax.query.next = add i32 %softmax.query, %block
br label %attention.forward.matrix.softmax.loop
attention.forward.matrix.softmax.done:

call void @attention_matrix_product(ptr %output, i32 3, i32 %p.base, i32 %v.base, i32 %output.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, double %scale, i32 %lid, i32 %block)
...
%accumulator = phi <8 x double> [ zeroinitializer, %attention.matrix.gradient.job.step ], [ %accumulator.next, %attention.matrix.gradient.fragment.done ]
...
%left.index = add i32 %left.base, %left.local
%left.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %left.index
%left.loaded = load double, ptr %left.ptr, align 8
%right.row = mul i32 %term.safe, %head.width
%right.local = add i32 %right.row, %n.safe
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %right.index
%right.loaded = load double, ptr %right.ptr, align 8
...
%accumulator.next = call <8 x double> @recipe.wmma(<16 x double> %left.fragment, <16 x double> %right.fragment, <8 x double> %accumulator)
...
%output.wide = extractelement <8 x double> %accumulator, i32 %output
%output.raw = call double @recipe.encode(double %output.wide)
...
%output.index = add i32 %output.row, %output.local
%output.ptr = getelementptr inbounds double, ptr %previous, i32 %output.index
store double %output.value, ptr %output.ptr, align 8
...
%stage.vector.input.ptr = getelementptr inbounds double, ptr %input, i32 %stage.vector.input.index
%stage.vector.input.value = load <16 x double>, ptr %stage.vector.input.ptr, align 8
...
%stage.vector.delta.ptr = getelementptr inbounds double, ptr %delta, i32 %stage.vector.delta.index
%stage.vector.delta.value = load <16 x double>, ptr %stage.vector.delta.ptr, align 8
br label %attention.matrix.stage.vector.store
...
%stage.scalar.input.ptr = getelementptr inbounds double, ptr %input, i32 %stage.scalar.input.index
%stage.scalar.input.value = load double, ptr %stage.scalar.input.ptr, align 8
...
%stage.scalar.delta.ptr = getelementptr inbounds double, ptr %delta, i32 %stage.scalar.delta.index
%stage.scalar.delta.value = load double, ptr %stage.scalar.delta.ptr, align 8
br label %attention.matrix.stage.scalar.store
...
%d.do.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %d.do.index
%d.do = load double, ptr %d.do.ptr, align 8
...
%d.output.ptr = getelementptr inbounds double, ptr %output, i32 %d.output.index
%d.output = load double, ptr %d.output.ptr, align 8
...
%d.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %d.index
store double %d.sum, ptr %d.ptr, align 8
...
%matrix.score.accumulator = phi <8 x double> [ zeroinitializer, %attention.matrix.score.job.step ], [ %matrix.score.accumulator.next, %attention.matrix.score.width.step ]
%matrix.dp.accumulator = phi <8 x double> [ zeroinitializer, %attention.matrix.score.job.step ], [ %matrix.dp.accumulator.next, %attention.matrix.score.width.step ]
%matrix.width.more = icmp ult i32 %matrix.width, %head.width
...
%matrix.do.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x double>, ptr %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.v.index
%matrix.v.fragment = load <16 x double>, ptr %matrix.v.ptr, align 2
%matrix.score.accumulator.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.q.fragment, <16 x double> %matrix.k.fragment, <8 x double> %matrix.score.accumulator)
%matrix.dp.accumulator.next = call <8 x double> @recipe.wmma(<16 x double> %matrix.do.fragment, <16 x double> %matrix.v.fragment, <8 x double> %matrix.dp.accumulator)
%matrix.width.next = add i32 %matrix.width, 16
br label %attention.matrix.score.width.loop
...
%matrix.score.wide = extractelement <8 x double> %matrix.score.accumulator, i32 %matrix.output
%matrix.score.raw = call double @recipe.encode(double %matrix.score.wide)
%matrix.score = call double @recipe.div(double %matrix.score.raw, double %scale)
%matrix.dp.wide = extractelement <8 x double> %matrix.dp.accumulator, i32 %matrix.output
%matrix.dp = call double @recipe.encode(double %matrix.dp.wide)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.statistics.base = mul i32 %head.job, %length
%matrix.statistics.index = add i32 %matrix.statistics.base, %matrix.query
%matrix.maximum.ptr = getelementptr inbounds double, ptr %context, i32 %matrix.statistics.index
%matrix.maximum = load double, ptr %matrix.maximum.ptr, align 8
%matrix.denominator.index = add i32 %statistics.rows, %matrix.statistics.index
%matrix.denominator.ptr = getelementptr inbounds double, ptr %context, i32 %matrix.denominator.index
%matrix.denominator = load double, ptr %matrix.denominator.ptr, align 8
...
%matrix.d.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.d.index
%matrix.d = load double, ptr %matrix.d.ptr, align 8
...
%matrix.p.index = add i32 %p.base, %matrix.pair.local
%matrix.p.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.p.index
store double %matrix.probability, ptr %matrix.p.ptr, align 8
%matrix.ds.index = add i32 %ds.base, %matrix.pair.local
%matrix.ds.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %matrix.ds.index
store double %matrix.derivative, ptr %matrix.ds.ptr, align 8
...
call void @attention_matrix_product(ptr %previous, i32 0, i32 %ds.base, i32 %k.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, double %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr %previous, i32 1, i32 %ds.base, i32 %q.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, double %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr %previous, i32 2, i32 %p.base, i32 %do.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, double %scale, i32 %lid, i32 %block)
...
%dq.input.ptr = getelementptr inbounds double, ptr %input, i32 %dq.input.index
%dq.query.value = load double, ptr %dq.input.ptr, align 8
%dq.query.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.query.p
store double %dq.query.value, ptr %dq.query.shared.ptr, align 8
%dq.delta.index = add i32 %dq.output.row, %dq.local
%dq.delta.ptr = getelementptr inbounds double, ptr %delta, i32 %dq.delta.index
%dq.delta.value = load double, ptr %dq.delta.ptr, align 8
%dq.delta.shared.index = add i32 %dq.delta.base.shared, %dq.query.p
%dq.delta.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.delta.shared.index
store double %dq.delta.value, ptr %dq.delta.shared.ptr, align 8
%dq.gradient.shared.index = add i32 %dq.gradient.base.shared, %dq.query.p
%dq.gradient.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.gradient.shared.index
store double 0.0, ptr %dq.gradient.shared.ptr, align 8
...
%dq.key.input.ptr = getelementptr inbounds double, ptr %input, i32 %dq.key.input.index
%dq.key.value = load double, ptr %dq.key.input.ptr, align 8
%dq.key.shared.index = add i32 %dq.key.base.shared, %dq.key.p
%dq.key.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.key.shared.index
store double %dq.key.value, ptr %dq.key.shared.ptr, align 8
...
%dq.value.input.ptr = getelementptr inbounds double, ptr %input, i32 %dq.value.input.index
%dq.value.value = load double, ptr %dq.value.input.ptr, align 8
%dq.value.shared.index = add i32 %dq.value.base.shared, %dq.key.p
%dq.value.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.value.shared.index
store double %dq.value.value, ptr %dq.value.shared.ptr, align 8
...
%dq.accumulate.gradient.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.accumulate.gradient.index
%dq.accumulate.initial = load double, ptr %dq.accumulate.gradient.ptr, align 8
...
%dq.accumulate.pair.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.accumulate.pair.index
%dq.accumulate.ds = load double, ptr %dq.accumulate.pair.ptr, align 8
...
%dq.accumulate.key.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.accumulate.key.index
%dq.accumulate.key.value = load double, ptr %dq.accumulate.key.ptr, align 8
...
br label %dq.accumulate.key.loop
dq.accumulate.store:
store double %dq.accumulate.value, ptr %dq.accumulate.gradient.ptr, align 8
...
%dq.store.ptr = getelementptr inbounds double, ptr %previous, i32 %dq.store.index
%dq.store.shared.index = add i32 %dq.gradient.base.shared, %dq.store.p
%dq.store.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dq.store.shared.index
%dq.store.value = load double, ptr %dq.store.shared.ptr, align 8
store double %dq.store.value, ptr %dq.store.ptr, align 8
...
%dkv.key.input.ptr = getelementptr inbounds double, ptr %input, i32 %dkv.key.input.index
%dkv.key.value = load double, ptr %dkv.key.input.ptr, align 8
%dkv.key.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.key.p
store double %dkv.key.value, ptr %dkv.key.shared.ptr, align 8
...
%dkv.value.input.ptr = getelementptr inbounds double, ptr %input, i32 %dkv.value.input.index
%dkv.value.value = load double, ptr %dkv.value.input.ptr, align 8
%dkv.value.shared.index = add i32 %dkv.value.base.shared, %dkv.key.p
%dkv.value.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.value.shared.index
store double %dkv.value.value, ptr %dkv.value.shared.ptr, align 8
%dkv.key.gradient.index = add i32 %dkv.key.gradient.base.shared, %dkv.key.p
%dkv.key.gradient.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.key.gradient.index
store double 0.0, ptr %dkv.key.gradient.ptr, align 8
%dkv.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.key.p
%dkv.value.gradient.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.value.gradient.index
store double 0.0, ptr %dkv.value.gradient.ptr, align 8
...
%dkv.query.input.ptr = getelementptr inbounds double, ptr %input, i32 %dkv.query.input.index
%dkv.query.value = load double, ptr %dkv.query.input.ptr, align 8
%dkv.query.shared.index = add i32 %dkv.query.base.shared, %dkv.query.p
%dkv.query.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.query.shared.index
store double %dkv.query.value, ptr %dkv.query.shared.ptr, align 8
%dkv.delta.input.index = add i32 %dkv.output.row, %dkv.query.input.local
%dkv.delta.input.ptr = getelementptr inbounds double, ptr %delta, i32 %dkv.delta.input.index
%dkv.delta.value = load double, ptr %dkv.delta.input.ptr, align 8
%dkv.delta.shared.index = add i32 %dkv.delta.base.shared, %dkv.query.p
%dkv.delta.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.delta.shared.index
store double %dkv.delta.value, ptr %dkv.delta.shared.ptr, align 8
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.accumulate.key.gradient.index
%dkv.accumulate.key.initial = load double, ptr %dkv.accumulate.key.gradient.ptr, align 8
%dkv.accumulate.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.accumulate.p
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.accumulate.value.gradient.index
%dkv.accumulate.value.initial = load double, ptr %dkv.accumulate.value.gradient.ptr, align 8
...
%dkv.accumulate.probability.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.accumulate.probability.index
%dkv.accumulate.probability = load double, ptr %dkv.accumulate.probability.ptr, align 8
%dkv.accumulate.derivative.index = add i32 %dkv.derivative.base.shared, %dkv.accumulate.pair.local
%dkv.accumulate.derivative.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.accumulate.derivative.index
%dkv.accumulate.derivative = load double, ptr %dkv.accumulate.derivative.ptr, align 8
...
%dkv.accumulate.query.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.accumulate.query.index
%dkv.accumulate.query.value = load double, ptr %dkv.accumulate.query.ptr, align 8
%dkv.accumulate.delta.index = add i32 %dkv.delta.base.shared, %dkv.accumulate.query.local
%dkv.accumulate.delta.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.accumulate.delta.index
%dkv.accumulate.delta = load double, ptr %dkv.accumulate.delta.ptr, align 8
...
store double %dkv.accumulate.key.value, ptr %dkv.accumulate.key.gradient.ptr, align 8
store double %dkv.accumulate.value.value, ptr %dkv.accumulate.value.gradient.ptr, align 8
...
%dkv.store.key.ptr = getelementptr inbounds double, ptr %previous, i32 %dkv.store.key.index
%dkv.store.key.shared.index = add i32 %dkv.key.gradient.base.shared, %dkv.store.p
%dkv.store.key.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.store.key.shared.index
%dkv.store.key.value = load double, ptr %dkv.store.key.shared.ptr, align 8
store double %dkv.store.key.value, ptr %dkv.store.key.ptr, align 8
...
%dkv.store.value.ptr = getelementptr inbounds double, ptr %previous, i32 %dkv.store.value.index
%dkv.store.value.shared.index = add i32 %dkv.value.gradient.base.shared, %dkv.store.p
%dkv.store.value.shared.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %dkv.store.value.shared.index
%dkv.store.value.value = load double, ptr %dkv.store.value.shared.ptr, align 8
store double %dkv.store.value.value, ptr %dkv.store.value.ptr, align 8
...
%precompute.weights = getelementptr inbounds double, ptr %weights, i32 %precompute.weight.offset
%precompute.context.offset = mul i32 %precompute.gate, %gate.batch
%precompute.context = getelementptr inbounds double, ptr %context, i32 %precompute.context.offset
...
%input.ptr = getelementptr inbounds double, ptr %context, i32 %input.index
%input.sum = load double, ptr %input.ptr, align 8 br label %state.sum.loop state.sum.loop:
...
%previous.ptr = getelementptr inbounds double, ptr %output, i32 %previous.index
%previous.loaded = load double, ptr %previous.ptr, align 8
...
%reset.ptr = getelementptr inbounds double, ptr %context, i32 %reset.base
%reset = load double, ptr %reset.ptr, align 8 %reset.state = call double @recipe.mul(double %reset, double %previous)
...
%state.weight.ptr = getelementptr inbounds double, ptr %weights, i32 %state.weight.index
%state.weight = load double, ptr %state.weight.ptr, align 8
...
%bias.ptr = getelementptr inbounds double, ptr %weights, i32 %bias.index
%bias = load double, ptr %bias.ptr, align 8 %linear = call double @recipe.add(double %state.sum, double %bias)
...
%gate.ptr = getelementptr inbounds double, ptr %context, i32 %gate.index
store double %gate.value, ptr %gate.ptr, align 8 %hidden.next = add nuw i32 %hidden, 1
...
%output.index = add i32 %output.row.base, %output.local
%gate0.ptr = getelementptr inbounds double, ptr %context, i32 %output.index
%gate0 = load double, ptr %gate0.ptr, align 8
...
%gate1.ptr = getelementptr inbounds double, ptr %context, i32 %gate1.index
%gate1 = load double, ptr %gate1.ptr, align 8 %gate2.base = mul i32 %gate.batch, 2
...
%gate2.ptr = getelementptr inbounds double, ptr %context, i32 %gate2.index
%gate2 = load double, ptr %gate2.ptr, align 8 %gate3.base = mul i32 %gate.batch, 3
%gate3.raw = add i32 %gate3.base, %output.index %gate3.index = select i1 %is.lstm, i32 %gate3.raw, i32 %output.index
%gate3.ptr = getelementptr inbounds double, ptr %context, i32 %gate3.index
%gate3 = load double, ptr %gate3.ptr, align 8 %output.previous.time = sub i32 %time, 1
...
%output.previous.ptr = getelementptr inbounds double, ptr %output, i32 %output.previous.index
%output.previous.loaded = load double, ptr %output.previous.ptr, align 8
...
%cell.previous.ptr = getelementptr inbounds double, ptr %context, i32 %cell.previous.index
%cell.previous.loaded = load double, ptr %cell.previous.ptr, align 8
...
%cell.ptr = getelementptr inbounds double, ptr %context, i32 %cell.index
store double %cell, ptr %cell.ptr, align 8 %cell.tanh = call double @recipe.tanh(double %cell)
...
%output.ptr = getelementptr inbounds double, ptr %output, i32 %output.index
store double %output.value, ptr %output.ptr, align 8 %output.next = add nuw i32 %output.hidden, 1
...
%sums = alloca [RECIPE_REGISTER_COUNT x double], align 8
%bias.sums = alloca [RECIPE_REGISTER_N x double], align 8
%state.zero = call double @recipe.state.from.u1(i1 false) %lid = add i32 0, 0 %group = call i32 @recipe.cpu.thread.id() %block = add i32 1, 0 %groups = udiv i32 %threads, %block
...
%gradient.scratch = getelementptr inbounds double, ptr %gradient, i32 RECIPE_GRADIENT_SCRATCH_BASE
...
gradient.sum.init.step: %gradient.sum.init.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %gradient.sum.init store double %state.zero, ptr %gradient.sum.init.ptr, align 8 %gradient.sum.init.next = add i32 %gradient.sum.init, 1 br label %gradient.sum.init.loop gradient.tile.loop:
...
%gradient.a.vector.source = getelementptr inbounds double, ptr %input, i32 %gradient.a.vector.index
%gradient.a.vector.value = load <RECIPE_FRAGMENT_K x double>, ptr %gradient.a.vector.source, align 8
...
%gradient.a.value = call double @contraction_input( ptr %input, i32 %gradient.a.row.base, i32 %gradient.a.position, i32 %gradient.a.term, i32 %span, i32 %in.length, i1 %is.conv )
...
%gradient.b.vector.value = call <RECIPE_FRAGMENT_K x double> @contraction_delta_vector16(ptr %delta, ptr %output, i32 %gradient.b.index, i1 %relu)
...
%gradient.b.value = call double @contraction_delta(ptr %delta, ptr %output, i32 %gradient.b.index, i1 %relu)
br label %gradient.load.store
...
%gradient.load.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %gradient.load.index store double %gradient.load.value, ptr %gradient.load.ptr, align 8
br label %gradient.load.advance
...
%gradient.store.ptr = getelementptr inbounds double, ptr %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load double, ptr %gradient.store.sum.ptr, align 8 %gradient.store.sum = call double @recipe.encode(double %gradient.store.sum.wide) store double %gradient.store.sum, ptr %gradient.store.ptr, align 8
...
previous.sum.init.step: %previous.sum.init.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %previous.sum.init store double %state.zero, ptr %previous.sum.init.ptr, align 8 %previous.sum.init.next = add i32 %previous.sum.init, 1 br label %previous.sum.init.loop previous.tile.loop:
...
%previous.a.vector.delta = getelementptr inbounds double, ptr %delta, i32 %previous.a.index
%previous.a.vector.output = getelementptr inbounds double, ptr %output, i32 %previous.a.index
%previous.a.vector.delta.value = load <RECIPE_FRAGMENT_K x double>, ptr %previous.a.vector.delta, align 8
%previous.a.vector.output.value = load <RECIPE_FRAGMENT_K x double>, ptr %previous.a.vector.output, align 8
...
%previous.a.raw = call double @contraction_delta(ptr %delta, ptr %output, i32 %previous.a.index, i1 %relu)
...
%previous.b.vector.source = getelementptr inbounds double, ptr %weights, i32 %previous.b.index
%previous.b.vector.value = load <RECIPE_FRAGMENT_K x double>, ptr %previous.b.vector.source, align 8
...
%previous.b.ptr = getelementptr inbounds double, ptr %weights, i32 %previous.b.index
%previous.b.value = load double, ptr %previous.b.ptr, align 8
br label %previous.load.store
...
%previous.load.ptr = getelementptr [0 x double], ptr @contraction_tile_f, i32 0, i32 %previous.load.index store double %previous.load.value, ptr %previous.load.ptr, align 8
br label %previous.load.advance
...
%previous.store.row.base = mul i32 %previous.store.row, %in.elements %previous.store.channel.base = mul i32 %previous.store.channel, %in.length %previous.store.local = add i32 %previous.store.channel.base, %previous.store.position %previous.store.index = add i32 %previous.store.row.base, %previous.store.local %previous.store.ptr = getelementptr inbounds double, ptr %previous, i32 %previous.store.index
%previous.store.old = load double, ptr %previous.store.ptr, align 8 %previous.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr %sums, i32 0, i32 %previous.store.register %previous.store.sum.wide = load double, ptr %previous.store.sum.ptr, align 8 %previous.store.sum = call double @recipe.encode(double %previous.store.sum.wide) %previous.store.value = call double @recipe.add(double %previous.store.old, double %previous.store.sum) store double %previous.store.value, ptr %previous.store.ptr, align 8 br label %previous.store.next
...
%clear.ptr = getelementptr inbounds double, ptr %context, i32 %clear.index
store double 0.0, ptr %clear.ptr, align 8 %clear.next = add nuw i32 %clear.p, 1
...
%clear.dh.ptr = getelementptr inbounds double, ptr %context, i32 %clear.dh.index
%clear.dc.ptr = getelementptr inbounds double, ptr %context, i32 %clear.dc.index
store double 0.0, ptr %clear.dh.ptr, align 8 store double 0.0, ptr %clear.dc.ptr, align 8
...
%rnn.future.ptr = getelementptr inbounds double, ptr %context, i32 %rnn.future.index
%rnn.gate.ptr = getelementptr inbounds double, ptr %context, i32 %rnn.index
%rnn.dy = load double, ptr %rnn.dy.ptr, align 8
%rnn.future = load double, ptr %rnn.future.ptr, align 8
%rnn.gate = load double, ptr %rnn.gate.ptr, align 8 %rnn.dh = call double @recipe.add(double %rnn.dy, double %rnn.future)
...
%rnn.delta.ptr = getelementptr inbounds double, ptr %context, i32 %rnn.delta.index
store double %rnn.delta, ptr %rnn.delta.ptr, align 8 %rnn.next = add i32 %rnn.hidden, 1
...
%gru.dy.ptr = getelementptr inbounds double, ptr %delta, i32 %gru.index
%gru.future.index = add i32 %dh.start, %gru.hidden
%gru.future.ptr = getelementptr inbounds double, ptr %context, i32 %gru.future.index
%gru.previous.ptr = getelementptr inbounds double, ptr %output, i32 %gru.previous.index
%gru.z.ptr = getelementptr inbounds double, ptr %context, i32 %gru.index
%gru.n.index = add i32 %gru.index, %gate2.batch
%gru.n.ptr = getelementptr inbounds double, ptr %context, i32 %gru.n.index
%gru.dy = load double, ptr %gru.dy.ptr, align 8
%gru.future = load double, ptr %gru.future.ptr, align 8
%gru.previous.loaded = load double, ptr %gru.previous.ptr, align 8
%gru.previous = select i1 %previous.exists, double %gru.previous.loaded, double 0.0
%gru.z = load double, ptr %gru.z.ptr, align 8
%gru.n = load double, ptr %gru.n.ptr, align 8 %gru.dh = call double @recipe.add(double %gru.dy, double %gru.future)
...
%gru.dz.ptr = getelementptr inbounds double, ptr %context, i32 %gru.dz.index
%gru.dn.ptr = getelementptr inbounds double, ptr %context, i32 %gru.dn.index
store double %gru.dz, ptr %gru.dz.ptr, align 8
store double %gru.dn, ptr %gru.dn.ptr, align 8 %gru.next = add i32 %gru.hidden, 1
...
%gru.weight.ptr = getelementptr inbounds double, ptr %weights, i32 %gru.weight.index
...
%gru.target.delta.ptr = getelementptr inbounds double, ptr %context, i32 %gru.target.delta.index
%gru.weight = load double, ptr %gru.weight.ptr, align 8
%gru.target.delta = load double, ptr %gru.target.delta.ptr, align 8
...
%gru.source.previous.ptr = getelementptr inbounds double, ptr %output, i32 %gru.source.previous.index
%gru.r.index = add i32 %batch, %gru.source.index
%gru.r.ptr = getelementptr inbounds double, ptr %context, i32 %gru.r.index
%gru.source.previous.loaded = load double, ptr %gru.source.previous.ptr, align 8
%gru.source.previous = select i1 %previous.exists, double %gru.source.previous.loaded, double 0.0
%gru.r = load double, ptr %gru.r.ptr, align 8
...
%gru.dr.ptr = getelementptr inbounds double, ptr %context, i32 %gru.dr.index
store double %gru.dr.1, ptr %gru.dr.ptr, align 8 %gru.source.next = add i32 %gru.source, 1
...
%dy.ptr = getelementptr inbounds double, ptr %delta, i32 %index %dh.index = add i32 %dh.start, %hidden
%dc.index = add i32 %dc.start, %hidden %dh.ptr = getelementptr inbounds double, ptr %context, i32 %dh.index
%dc.ptr = getelementptr inbounds double, ptr %context, i32 %dc.index
%cell.ptr = getelementptr inbounds double, ptr %context, i32 %cell.index
%cell.previous.ptr = getelementptr inbounds double, ptr %context, i32 %cell.previous.index
%dy = load double, ptr %dy.ptr, align 8 %dh.future = load double, ptr %dh.ptr, align 8
%dc.future = load double, ptr %dc.ptr, align 8 %cell = load double, ptr %cell.ptr, align 8
%cell.previous.loaded = load double, ptr %cell.previous.ptr, align 8
%cell.previous = select i1 %previous.exists, double %cell.previous.loaded, double 0.0
%i.ptr = getelementptr inbounds double, ptr %context, i32 %index %f.index = add i32 %batch, %index
%o.index = add i32 %f.index, %batch %g.index = add i32 %o.index, %batch
%f.ptr = getelementptr inbounds double, ptr %context, i32 %f.index
%o.ptr = getelementptr inbounds double, ptr %context, i32 %o.index
%g.ptr = getelementptr inbounds double, ptr %context, i32 %g.index
%i = load double, ptr %i.ptr, align 8 %f = load double, ptr %f.ptr, align 8
%o = load double, ptr %o.ptr, align 8 %g = load double, ptr %g.ptr, align 8
...
store double %dc.previous, ptr %dc.ptr, align 8 %delta0.index = add i32 %delta.base, %index
%delta1.index = add i32 %delta0.index, %batch %delta2.index = add i32 %delta1.index, %batch
%delta3.index = add i32 %delta2.index, %batch
%delta0.ptr = getelementptr inbounds double, ptr %context, i32 %delta0.index
%delta1.ptr = getelementptr inbounds double, ptr %context, i32 %delta1.index
%delta2.ptr = getelementptr inbounds double, ptr %context, i32 %delta2.index
%delta3.ptr = getelementptr inbounds double, ptr %context, i32 %delta3.index
store double %di, ptr %delta0.ptr, align 8 store double %df, ptr %delta1.ptr, align 8
store double %do, ptr %delta2.ptr, align 8 store double %dg, ptr %delta3.ptr, align 8
...
%gate.delta.ptr = getelementptr inbounds double, ptr %context, i32 %delta.index
%gate.delta = load double, ptr %gate.delta.ptr, align 8
...
%state.ptr = getelementptr inbounds double, ptr %output, i32 %state.index.value
%state.loaded = load double, ptr %state.ptr, align 8
...
%parameter.reset.ptr = getelementptr inbounds double, ptr %context, i32 %parameter.reset.index
%parameter.reset = load double, ptr %parameter.reset.ptr, align 8
...
%row.gradient.ptr = getelementptr inbounds double, ptr %context, i32 %row.gradient.index
%row.gradient.old = load double, ptr %row.gradient.ptr, align 8
%row.gradient.new = call double @recipe.add(double %row.gradient.old, double %contribution)
store double %row.gradient.new, ptr %row.gradient.ptr, align 8
...
%state.delta.ptr = getelementptr inbounds double, ptr %context, i32 %state.delta.index
%state.weight.value = load double, ptr %state.weight.ptr, align 8
%state.delta.value = load double, ptr %state.delta.ptr, align 8
...
%state.reset.ptr = getelementptr inbounds double, ptr %context, i32 %state.reset.index
%state.reset = load double, ptr %state.reset.ptr, align 8
...
%state.dh.ptr = getelementptr inbounds double, ptr %context, i32 %state.dh.index
...
%state.direct.delta.ptr = getelementptr inbounds double, ptr %delta, i32 %state.direct.index
%state.direct.z.ptr = getelementptr inbounds double, ptr %context, i32 %state.direct.index
%state.direct.dy = load double, ptr %state.direct.delta.ptr, align 8
%state.direct.future = load double, ptr %state.dh.ptr, align 8
%state.direct.z = load double, ptr %state.direct.z.ptr, align 8
...
store double %state.total, ptr %state.dh.ptr, align 8 %state.channel.next = add nuw i32 %state.channel, 1
...
%projection.weights = getelementptr inbounds double, ptr %weights, i32 %projection.weight.offset
%projection.delta.gate = mul i32 %projection.gate, %batch
%projection.delta.offset = add i32 %delta.base, %projection.delta.gate
%projection.delta = getelementptr inbounds double, ptr %context, i32 %projection.delta.offset
