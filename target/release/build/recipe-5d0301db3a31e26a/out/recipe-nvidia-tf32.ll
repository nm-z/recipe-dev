...
%lane = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() %group = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x()
%width = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() %base = mul i32 %group, %width %id = add i32 %base, %lane ret i32 %id }
@grid.count = internal addrspace(1) global i32 0, align 4
@grid.phase = internal addrspace(1) global i32 0, align 4
define internal void @grid_barrier(i32 %threads) #1 { entry:
call void @llvm.nvvm.barrier0() %lane = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
%leader = icmp eq i32 %lane, 0 br i1 %leader, label %arrive, label %joined arrive:
%width = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() %groups = udiv i32 %threads, %width
...
fence acquire br label %joined joined: call void @llvm.nvvm.barrier0() ret void }
; NUMERIC BEGIN
...
define internal float @recipe.decode(float %value) #1 { entry: %result = call float @recipe.round(float %value) ret float %result }
define internal float @recipe.encode(float %value) #1 { entry: %result = call float @recipe.round(float %value) ret float %result }
...
define internal float @recipe.add(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %wide = fadd float %left.wide, %right.wide %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.sub(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %wide = fsub float %left.wide, %right.wide %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.mul(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %wide = fmul float %left.wide, %right.wide %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.div(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %wide = fdiv float %left.wide, %right.wide %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.madd(float %sum, float %left, float %right) #1 { entry: %sum.wide = call float @recipe.decode(float %sum) %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %wide = call float @llvm.fma.f32(float %left.wide, float %right.wide, float %sum.wide) %result = call float @recipe.encode(float %wide) ret float %result }
...
define internal <RECIPE_REGISTER_M x float> @recipe.madd.vector(<RECIPE_REGISTER_M x float> %sum, <RECIPE_REGISTER_M x float> %left, <RECIPE_REGISTER_M x float> %right) #1 {
entry:
...
define internal float @recipe.neg(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %negative = fneg float %wide %result = call float @recipe.encode(float %negative) ret float %result }
define internal i1 @recipe.oeq(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp oeq float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.oge(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp oge float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ogt(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp ogt float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ole(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp ole float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.olt(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp olt float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.one(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp one float %left.wide, %right.wide ret i1 %result }
define internal i1 @recipe.ord(float %left, float %right) #1 { entry: %left.wide = call float @recipe.decode(float %left) %right.wide = call float @recipe.decode(float %right) %result = fcmp ord float %left.wide, %right.wide ret i1 %result }
define internal float @recipe.from.u1(i1 %value) #1 { entry: %wide = uitofp i1 %value to float %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.from.u32(i32 %value) #1 { entry: %wide = uitofp i32 %value to float %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.from.s32(i32 %value) #1 { entry: %wide = sitofp i32 %value to float %result = call float @recipe.encode(float %wide) ret float %result }
define internal i32 @recipe.to.u32(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %result = fptoui float %wide to i32 ret i32 %result }
define internal i32 @recipe.to.s32(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %result = fptosi float %wide to i32 ret i32 %result }
define internal float @recipe.from.f32(float %value) #1 { entry: %wide = fadd float %value, 0.0 %result = call float @recipe.encode(float %wide) ret float %result }
define internal float @recipe.from.f16(half %value) #1 { entry: %wide = fpext half %value to float %result = call float @recipe.encode(float %wide) ret float %result }
define internal half @recipe.to.f16(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %result = fptrunc float %wide to half ret half %result }
define internal float @recipe.abs(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @llvm.fabs.f32(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.floor(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @llvm.floor.f32(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.sqrt(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @llvm.sqrt.f32(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.exp(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @recipe.math.exp(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.tanh(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @recipe.math.tanh(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.cos(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @recipe.math.cos(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.sin(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @recipe.math.sin(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.log(float %value) #1 { entry: %wide = call float @recipe.decode(float %value) %computed = call float @recipe.math.log(float %wide) %result = call float @recipe.encode(float %computed) ret float %result }
define internal float @recipe.sigmoid(float %value) #1 { entry: %negative = call float @recipe.neg(float %value) %exponential = call float @recipe.exp(float %negative) %one = call float @recipe.from.u1(i1 true) %denominator = call float @recipe.add(float %exponential, float %one) %result = call float @recipe.div(float %one, float %denominator) ret float %result }
...
define internal float @recipe.state.from.model(float %value) #1 { entry: %result = call float @recipe.decode(float %value) ret float %result }
define internal float @recipe.model.from.state(float %value) #1 { entry: %result = call float @recipe.encode(float %value) ret float %result }
; NUMERIC END
declare i32 @llvm.nvvm.read.ptx.sreg.tid.x()
declare void @llvm.nvvm.barrier0() declare i64 @__ockl_steadyctr_u64()
declare void @llvm.trap() @contraction_tile_tf32 = external addrspace(3) global [0 x float], align 16
define internal float @contraction_input(
...
%index = add i32 %row.base, %local %ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %index
%value = load float, ptr addrspace(1) %ptr, align 4 ret float %value }
define internal float @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %index
%delta.value = load float, ptr addrspace(1) %delta.ptr, align 4
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %index
%output.value = load float, ptr addrspace(1) %output.ptr, align 4
%positive = call i1 @recipe.ogt(float %output.value, float 0.0)
%activated = select i1 %positive, float %delta.value, float 0.0
br label %done
done:
%value = phi float [ %delta.value, %entry ], [ %activated, %activation ]
ret float %value
}
define internal <16 x float> @contraction_delta_vector16(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %index, i1 %relu) #1 {
entry:
%delta.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %index
%delta.value = load <16 x float>, ptr addrspace(1) %delta.ptr, align 4
br i1 %relu, label %activation, label %done
activation:
%output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %index
%output.value = load <16 x float>, ptr addrspace(1) %output.ptr, align 4
br label %activation.loop
activation.loop:
%activation.index = phi i32 [ 0, %activation ], [ %activation.next, %activation.step ]
%activation.values = phi <16 x float> [ zeroinitializer, %activation ], [ %activation.values.next, %activation.step ]
%activation.more = icmp ult i32 %activation.index, 16
br i1 %activation.more, label %activation.step, label %done
activation.step:
%activation.output = extractelement <16 x float> %output.value, i32 %activation.index
%activation.delta = extractelement <16 x float> %delta.value, i32 %activation.index
%activation.positive = call i1 @recipe.ogt(float %activation.output, float 0.0)
%activation.value = select i1 %activation.positive, float %activation.delta, float 0.0
%activation.values.next = insertelement <16 x float> %activation.values, float %activation.value, i32 %activation.index
%activation.next = add i32 %activation.index, 1
br label %activation.loop
done:
%value = phi <16 x float> [ %delta.value, %entry ], [ %activation.values, %activation.loop ]
...
entry:
%reduce.lid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
%reduce.group = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x()
%reduce.block = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x()
...
%target.ptr = getelementptr inbounds float, ptr addrspace(1) %target, i32 %target.index
%source.first.index = add i32 %source.offset, %parameter
%source.first.ptr = getelementptr inbounds float, ptr addrspace(1) %source, i32 %source.first.index
%source.first = load float, ptr addrspace(1) %source.first.ptr, align 4
br label %row.loop
row.loop:
%row = phi i32 [ 1, %seed.load ], [ %row.next, %row.step ]
%sum = phi float [ %source.first, %seed.load ], [ %sum.next, %row.step ]
...
%source.ptr = getelementptr inbounds float, ptr addrspace(1) %source, i32 %source.index
%source.value = load float, ptr addrspace(1) %source.ptr, align 4
%sum.next = call float @recipe.add(float %sum, float %source.value)
%row.next = add i32 %row, 1
br label %row.loop
store:
store float %sum, ptr addrspace(1) %target.ptr, align 4
...
define internal void @contraction_stage_column16(<16 x float> %values, i32 %base, i32 %r, i32 %column, i32 %stride) #1 {
entry:
br label %loop
loop:
...
step:
%value = extractelement <16 x float> %values, i32 %j
%row.local = add i32 %r, %j
%row = mul i32 %row.local, %stride
%local = add i32 %row, %column
%index = add i32 %base, %local
%ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
store float %value, ptr addrspace(3) %ptr, align 4
%j.next = add i32 %j, 1
br label %loop
done:
ret void
...
%ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
store float 0.0, ptr addrspace(3) %ptr, align 4
%next = add i32 %p, %block
br label %loop
exit:
ret void
}
define internal <RECIPE_REGISTER_M x float> @contraction_a_fragment(i32 %k, i32 %output.m.base, i32 %tile.m, i32 %tile.k) #1 {
entry:
%index = call i32 @contraction_vector_a_index(i32 %k, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_M x float>, ptr addrspace(3) %ptr, align 4
ret <RECIPE_REGISTER_M x float> %fragment
}
define internal <RECIPE_REGISTER_N x float> @contraction_b_fragment(i32 %k, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
%local = call i32 @contraction_vector_b_index(i32 %k, i32 %output.n.base, i32 %tile.n, i32 %tile.k)
%index = add i32 %base, %local
%ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
%fragment = load <RECIPE_REGISTER_N x float>, ptr addrspace(3) %ptr, align 4
ret <RECIPE_REGISTER_N x float> %fragment
}
define internal void @contraction_stage_a_fragment(<RECIPE_FRAGMENT_K x float> %fragment, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
...
%value = extractelement <RECIPE_FRAGMENT_K x float> %fragment, i32 %element
%target = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
store float %value, ptr addrspace(3) %target, align 4
%next = add i32 %element, 1
br label %loop
exit:
ret void
}
define internal void @contraction_stage_a_columns(<RECIPE_FRAGMENT_K x float> %fragment, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
%element = phi i32 [ 0, %entry ], [ %next, %step ]
...
%index = call i32 @contraction_vector_a_index(i32 %k, i32 %local.m, i32 %tile.m, i32 %tile.k)
%value = extractelement <RECIPE_FRAGMENT_K x float> %fragment, i32 %element
%target = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
store float %value, ptr addrspace(3) %target, align 4
%next = add i32 %element, 1
...
define internal void @contraction_stage_b_terms(<RECIPE_FRAGMENT_K x float> %fragment, i32 %k, i32 %n, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
br label %loop
loop:
...
step:
%local.k = add i32 %k, %element
%local = call i32 @contraction_vector_b_index(i32 %local.k, i32 %n, i32 %tile.n, i32 %tile.k)
%index = add i32 %base, %local
%value = extractelement <RECIPE_FRAGMENT_K x float> %fragment, i32 %element
%target = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
store float %value, ptr addrspace(3) %target, align 4
...
define internal void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x float> %fragment, i32 %k, i32 %n, i32 %tile.m, i32 %tile.n, i32 %tile.k) #1 {
entry:
%base = mul i32 %tile.m, %tile.k
br label %loop
loop:
...
define internal void @contraction_stage_delta_a_fragment(<RECIPE_FRAGMENT_K x float> %delta, <RECIPE_FRAGMENT_K x float> %output, i1 %relu, i32 %k, i32 %m, i32 %tile.m, i32 %tile.k) #1 {
entry:
br label %loop
loop:
%element = phi i32 [ 0, %entry ], [ %next, %step ]
...
br i1 %more, label %step, label %exit
step:
%delta.value = extractelement <RECIPE_FRAGMENT_K x float> %delta, i32 %element
%output.value = extractelement <RECIPE_FRAGMENT_K x float> %output, i32 %element
%positive = call i1 @recipe.ogt(float %output.value, float 0.0)
%active = select i1 %positive, float %delta.value, float 0.0
%value = select i1 %relu, float %active, float %delta.value
%local.k = add i32 %k, %element
%index = call i32 @contraction_vector_a_index(i32 %local.k, i32 %m, i32 %tile.m, i32 %tile.k)
%target = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
store float %value, ptr addrspace(3) %target, align 4
...
ptr %sums, i1 %lane.active, i1 %lane.store, i32 %lid,
...
entry:
%chunk.sums = alloca [RECIPE_CHUNK_VALUES x float], align 4
...
local.k.begin:
%local.sums.initial = load <RECIPE_REGISTER_COUNT x float>, ptr %sums, align 4
%local.a.initial = call <RECIPE_REGISTER_M x float> @contraction_a_fragment(i32 0, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%local.b.initial = call <RECIPE_REGISTER_N x float> @contraction_b_fragment(i32 0, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
...
%local.a.fragment = phi <RECIPE_REGISTER_M x float> [ %local.a.initial, %local.k.begin ], [ %local.a.next, %local.product.done ]
%local.b.fragment = phi <RECIPE_REGISTER_N x float> [ %local.b.initial, %local.k.begin ], [ %local.b.next, %local.product.done ]
...
%local.a.next = call <RECIPE_REGISTER_M x float> @contraction_a_fragment(i32 %local.k.prefetch, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%local.b.next = call <RECIPE_REGISTER_N x float> @contraction_b_fragment(i32 %local.k.prefetch, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
%local.a.wide = call <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x float> %local.a.fragment)
...
%local.b = extractelement <RECIPE_REGISTER_N x float> %local.b.fragment, i32 %local.b.index
%local.b.wide = call float @recipe.decode(float %local.b)
...
local.store:
store <RECIPE_REGISTER_COUNT x float> %local.sums.current, ptr %sums, align 4
br label %exit
shared.chunk.loop:
...
%zero.ptr = getelementptr float, ptr %chunk.sums, i32 %zero.index
store float %state.zero, ptr %zero.ptr, align 4
...
%a.initial = call <RECIPE_REGISTER_M x float> @contraction_a_fragment(i32 %k.first, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%b.initial = call <RECIPE_REGISTER_N x float> @contraction_b_fragment(i32 %k.first, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
br label %k.loop
k.loop:
%k = phi i32 [ %k.first, %k.begin ], [ %k.next, %register.done ]
%a.fragment = phi <RECIPE_REGISTER_M x float> [ %a.initial, %k.begin ], [ %a.next, %register.done ]
%b.fragment = phi <RECIPE_REGISTER_N x float> [ %b.initial, %k.begin ], [ %b.next, %register.done ]
%k.next = add i32 %k, 1
%k.more = icmp ult i32 %k.next, %k.limit
%k.prefetch = select i1 %k.more, i32 %k.next, i32 %k
%a.next = call <RECIPE_REGISTER_M x float> @contraction_a_fragment(i32 %k.prefetch, i32 %output.m.base, i32 %tile.m, i32 %tile.k)
%b.next = call <RECIPE_REGISTER_N x float> @contraction_b_fragment(i32 %k.prefetch, i32 %output.n.base, i32 %tile.m, i32 %tile.n, i32 %tile.k)
%a.wide = call <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x float> %a.fragment)
...
%b = extractelement <RECIPE_REGISTER_N x float> %b.fragment, i32 %register.n
%b.wide = call float @recipe.decode(float %b)
...
%sum.ptr = getelementptr float, ptr %chunk.sums, i32 %sum.index
%sum = load <RECIPE_REGISTER_M x float>, ptr %sum.ptr, align 4
...
store <RECIPE_REGISTER_M x float> %candidate, ptr %sum.ptr, align 4
...
%publish.source = getelementptr float, ptr %chunk.sums, i32 %publish.source.index
%publish.value = load float, ptr %publish.source, align 4
...
%publish.target = getelementptr float, ptr addrspace(3) @contraction_tile_tf32, i32 %publish.target.index
...
%fold.source = getelementptr float, ptr addrspace(3) @contraction_tile_tf32, i32 %fold.source.index
%fold.value = load float, ptr addrspace(3) %fold.source, align 4
%fold.target = getelementptr float, ptr %sums, i32 %fold.r
%fold.current = load float, ptr %fold.target, align 4
%fold.next = call float @recipe.state.add(float %fold.current, float %fold.value)
store float %fold.next, ptr %fold.target, align 4
...
ptr %sums, ptr addrspace(1) %destination,
...
channel.begin:
%sum.ptr = getelementptr [RECIPE_REGISTER_N x float], ptr %sums, i32 0, i32 %slot
%previous = load float, ptr %sum.ptr, align 4 %initial = select i1 %first, float %zero, float %previous br label %r.loop
r.loop:
...
r.step:
%base = mul i32 %tile.m, %tile.k %local = call i32 @contraction_vector_b_index(i32 %r, i32 %channel, i32 %tile.n, i32 %tile.k) %index = add i32 %base, %local
%ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %index
%raw = load float, ptr addrspace(3) %ptr, align 4 %value = call float @recipe.decode(float %raw) %sum.next = call float @recipe.state.add(float %sum, float %value)
%r.next = add i32 %r, 1 br label %r.loop
sum.store:
store float %sum, ptr %sum.ptr, align 4 br i1 %last, label %destination.store, label %channel.done
destination.store:
...
%bias.ptr = getelementptr inbounds float, ptr addrspace(1) %destination, i32 %bias.index
%bias = call float @recipe.encode(float %sum) store float %bias, ptr addrspace(1) %bias.ptr, align 4 br label %channel.done
channel.done:
...
define internal <RECIPE_REGISTER_M x float> @contraction_widen_m(<RECIPE_REGISTER_M x float> %source) #1 {
entry:
br label %loop
loop:
...
br i1 %more, label %step, label %done
step:
%value = extractelement <RECIPE_REGISTER_M x float> %source, i32 %p
%wide = call float @recipe.decode(float %value)
...
declare <8 x float> @recipe.wmma(<16 x float>, <16 x float>, <8 x float>)
...
matrix.full:
%matrix.a.index = call i32 @contraction_vector_a_index(i32 %matrix.k, i32 %m.safe, i32 %tile.m, i32 %tile.k)
%matrix.a.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.a.index
%matrix.a.loaded = load <16 x float>, ptr addrspace(3) %matrix.a.ptr, align 16
%matrix.a.full = select i1 %m.valid, <16 x float> %matrix.a.loaded, <16 x float> zeroinitializer
%matrix.b.base = mul i32 %tile.m, %tile.k
%matrix.b.first.local = call i32 @contraction_vector_b_index(i32 %matrix.k, i32 %n.first.safe, i32 %tile.n, i32 %tile.k)
%matrix.b.first.index = add i32 %matrix.b.base, %matrix.b.first.local
%matrix.b.first.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.b.first.index
%matrix.b.first.loaded = load <16 x float>, ptr addrspace(3) %matrix.b.first.ptr, align 16
%matrix.b.first.full = select i1 %n.first.valid, <16 x float> %matrix.b.first.loaded, <16 x float> zeroinitializer
%matrix.b.second.local = call i32 @contraction_vector_b_index(i32 %matrix.k, i32 %n.second.safe, i32 %tile.n, i32 %tile.k)
%matrix.b.second.index = add i32 %matrix.b.base, %matrix.b.second.local
%matrix.b.second.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.b.second.index
%matrix.b.second.loaded = load <16 x float>, ptr addrspace(3) %matrix.b.second.ptr, align 16
%matrix.b.second.full = select i1 %n.second.valid, <16 x float> %matrix.b.second.loaded, <16 x float> zeroinitializer
%matrix.b.third.local = call i32 @contraction_vector_b_index(i32 %matrix.k, i32 %n.third.safe, i32 %tile.n, i32 %tile.k)
%matrix.b.third.index = add i32 %matrix.b.base, %matrix.b.third.local
%matrix.b.third.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.b.third.index
%matrix.b.third.loaded = load <16 x float>, ptr addrspace(3) %matrix.b.third.ptr, align 16
%matrix.b.third.full = select i1 %n.third.valid, <16 x float> %matrix.b.third.loaded, <16 x float> zeroinitializer
%matrix.b.fourth.local = call i32 @contraction_vector_b_index(i32 %matrix.k, i32 %n.fourth.safe, i32 %tile.n, i32 %tile.k)
%matrix.b.fourth.index = add i32 %matrix.b.base, %matrix.b.fourth.local
%matrix.b.fourth.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.b.fourth.index
%matrix.b.fourth.loaded = load <16 x float>, ptr addrspace(3) %matrix.b.fourth.ptr, align 16
%matrix.b.fourth.full = select i1 %n.fourth.valid, <16 x float> %matrix.b.fourth.loaded, <16 x float> zeroinitializer
%matrix.first.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.a.full, <16 x float> %matrix.b.first.full, <8 x float> %matrix.first)
%matrix.second.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.a.full, <16 x float> %matrix.b.second.full, <8 x float> %matrix.second)
%matrix.third.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.a.full, <16 x float> %matrix.b.third.full, <8 x float> %matrix.third)
%matrix.fourth.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.a.full, <16 x float> %matrix.b.fourth.full, <8 x float> %matrix.fourth)
...
%matrix.first.target = getelementptr float, ptr %sums, i32 %matrix.register
%matrix.first.current = load float, ptr %matrix.first.target, align 4
%matrix.first.sum = call float @recipe.state.add(float %matrix.first.current, float %matrix.first.value)
store float %matrix.first.sum, ptr %matrix.first.target, align 4
...
%matrix.second.target = getelementptr float, ptr %sums, i32 %matrix.second.register
%matrix.second.current = load float, ptr %matrix.second.target, align 4
%matrix.second.sum = call float @recipe.state.add(float %matrix.second.current, float %matrix.second.value)
store float %matrix.second.sum, ptr %matrix.second.target, align 4
...
%matrix.third.target = getelementptr float, ptr %sums, i32 %matrix.third.register
%matrix.third.current = load float, ptr %matrix.third.target, align 4
%matrix.third.sum = call float @recipe.state.add(float %matrix.third.current, float %matrix.third.value)
store float %matrix.third.sum, ptr %matrix.third.target, align 4
...
%matrix.fourth.target = getelementptr float, ptr %sums, i32 %matrix.fourth.register
%matrix.fourth.current = load float, ptr %matrix.fourth.target, align 4
%matrix.fourth.sum = call float @recipe.state.add(float %matrix.fourth.current, float %matrix.fourth.value)
store float %matrix.fourth.sum, ptr %matrix.fourth.target, align 4
...
%sums = alloca [RECIPE_REGISTER_COUNT x float], align 4 %state.zero = call float @recipe.state.from.u1(i1 false) %lid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() %group = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() %block = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() %groups = udiv i32 %threads, %block
...
%method.store = call i1 @contraction_vector_store_lane(i1 %lane.store, i32 %output.id)
...
sum.init.step: %sum.init.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %sum.init store float %state.zero, ptr %sum.init.ptr, align 4 %sum.init.next = add i32 %sum.init, 1 br label %sum.init.loop sum.init.done: br label %tile.loop tile.loop:
...
%a.tile.index = call i32 @contraction_vector_a_index(i32 %a.k, i32 %a.m, i32 %tile.m, i32 %tile.k)
br i1 %a.vector, label %load.a.vector, label %load.a.scalar
load.a.vector:
%a.vector.index = add i32 %a.row.base, %a.term
%a.vector.source = getelementptr inbounds float, ptr addrspace(1) %input, i32 %a.vector.index
%a.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr addrspace(1) %a.vector.source, align 4
call void @contraction_stage_a_fragment(<RECIPE_FRAGMENT_K x float> %a.vector.value, i32 %a.k, i32 %a.m, i32 %tile.m, i32 %tile.k)
br label %load.advance
load.a.scalar:
%a.loaded = call float @contraction_input( ptr addrspace(1) %input, i32 %a.row.base, i32 %a.position, i32 %a.term, i32 %span, i32 %in.length, i1 %is.conv )
br i1 %a.gate, label %load.a.activation, label %load.a.ready
load.a.activation:
%a.activation.channel = mul i32 %a.term, %in.length %a.activation.local = add i32 %a.activation.channel, %a.position %a.activation.index = add i32 %a.row.base, %a.activation.local %a.activation.ptr = getelementptr inbounds float, ptr addrspace(1) %activation, i32 %a.activation.index %a.activation.value = load float, ptr addrspace(1) %a.activation.ptr, align 2 %a.activation.positive = call i1 @recipe.ogt(float %a.activation.value, float 0.0) %a.gated = select i1 %a.activation.positive, float %a.loaded, float 0.0
br label %load.a.ready
load.a.ready:
%a.value = phi float [ %a.loaded, %load.a.scalar ], [ %a.gated, %load.a.activation ]
br label %load.store
...
%b.direct.index = add i32 %b.channel.base, %b.term %b.transpose.base = mul i32 %b.term, %out.channels %b.transpose.index = add i32 %b.transpose.base, %b.channel %b.index = select i1 %transpose, i32 %b.transpose.index, i32 %b.direct.index %b.tile.base = mul i32 %tile.m, %tile.k %b.tile.local = call i32 @contraction_vector_b_index(i32 %b.k, i32 %b.n, i32 %tile.n, i32 %tile.k) %b.tile.index = add i32 %b.tile.base, %b.tile.local
br i1 %b.vector, label %load.b.vector, label %load.b.scalar
load.b.vector:
%b.vector.source = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %b.index
%b.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr addrspace(1) %b.vector.source, align 4
call void @contraction_stage_b_terms(<RECIPE_FRAGMENT_K x float> %b.vector.value, i32 %b.k, i32 %b.n, i32 %tile.m, i32 %tile.n, i32 %tile.k)
br label %load.advance
load.b.scalar:
%b.ptr = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %b.index
%b.value = load float, ptr addrspace(1) %b.ptr, align 4
br label %load.store
load.store: %load.value = phi float [ %a.value, %load.a.ready ], [ %b.value, %load.b.scalar ] %load.tile.index = phi i32 [ %a.tile.index, %load.a.ready ], [ %b.tile.index, %load.b.scalar ] %load.tile.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %load.tile.index store float %load.value, ptr addrspace(3) %load.tile.ptr, align 4
br label %load.advance
load.advance:
...
load.ready:
call void @llvm.nvvm.barrier0()
call void @contraction_vector_accumulate(ptr %sums, i1 %lane.active, i1 %method.store, i32 %output.id, i32 %lane.k, i32 %k.lanes, i32 %output.lane, i32 %lanes, i32 %output.m.base, i32 %output.n.base, i32 %m.count, i32 %n.count, i32 %k.count, i32 %tile.m, i32 %tile.n, i32 %tile.k)
...
store.test: %store.output.m.raw = call i32 @contraction_vector_output_m(i32 %output.id, i32 %store.register, i32 %m.lanes) %store.output.n.raw = call i32 @contraction_vector_output_n(i32 %output.id, i32 %store.register, i32 %m.lanes) %store.register.valid = call i1 @contraction_output_register_valid(i32 %store.register)
...
%store.output.channel.base = mul i32 %store.channel, %out.length %store.output.local = add i32 %store.output.channel.base, %store.position %store.output.index = add i32 %store.output.row.base, %store.output.local %store.output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %store.output.index
%store.bias.base = mul i32 %out.channels, %terms %store.bias.index = add i32 %store.bias.base, %store.channel %store.bias.ptr = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %store.bias.index %store.bias = load float, ptr addrspace(1) %store.bias.ptr, align 4 %store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %store.register %store.sum.wide = load float, ptr %store.sum.ptr, align 4 %store.sum = call float @recipe.encode(float %store.sum.wide)
%store.biased = call float @recipe.add(float %store.sum, float %store.bias) %store.raw = select i1 %has.bias, float %store.biased, float %store.sum %store.forward = xor i1 %reverse, true %store.activate = and i1 %relu, %store.forward %store.positive = call i1 @recipe.ogt(float %store.raw, float 0.0) %store.activated = select i1 %store.positive, float %store.raw, float 0.0 %store.result = select i1 %store.activate, float %store.activated, float %store.raw %store.prior = load float, ptr addrspace(1) %store.output.ptr, align 2 %store.accumulated = call float @recipe.add(float %store.prior, float %store.result) %store.value = select i1 %accumulate, float %store.accumulated, float %store.result store float %store.value, ptr addrspace(1) %store.output.ptr, align 4 br label %store.next
...
%maximum = phi float [ 0xFFF0000000000000, %entry ], [ %maximum.next, %step ]
...
%input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %index
%value = load float, ptr addrspace(1) %input.ptr, align 4 %greater = call i1 @recipe.ogt(float %value, float %maximum)
%maximum.next = select i1 %greater, float %value, float %maximum
...
store float %maximum, ptr addrspace(1) %output.ptr, align 4
store i64 %maximum.index.wide, ptr addrspace(1) %context.ptr, align 4 ret void }
define internal float @sigmoid(float %x) #1 { entry: %negative = call float @recipe.neg(float %x)
%exponential = call float @recipe.exp(float %negative) %denominator = call float @recipe.add(float 1.0, float %exponential)
%value = call float @recipe.div(float 1.0, float %denominator) ret float %value }
define internal float @attention_tile_dot(i32 %left, i32 %right, i32 %width, i32 %left.base, i32 %right.base) #1 { entry:
br label %channel.loop
channel.loop:
%channel = phi i32 [ 0, %entry ], [ %channel.next, %channel.step ]
%sum = phi float [ 0.0, %entry ], [ %sum.next, %channel.step ]
...
%left.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %left.index
%left.value = load float, ptr addrspace(3) %left.ptr, align 4
%right.row = mul i32 %right, %width
%right.local = add i32 %right.row, %channel
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %right.index
%right.value = load float, ptr addrspace(3) %right.ptr, align 4
%product = call float @recipe.mul(float %left.value, float %right.value)
%sum.next = call float @recipe.add(float %sum, float %product)
%channel.next = add i32 %channel, 1
br label %channel.loop
done:
ret float %sum
}
define internal float @attention_tile_score(i32 %query, i32 %key, i32 %width, i32 %key.base, float %scale) #1 { entry:
%sum = call float @attention_tile_dot(i32 %query, i32 %key, i32 %width, i32 0, i32 %key.base)
%score = call float @recipe.div(float %sum, float %scale)
ret float %score
}
...
%sum = phi float [ 0.0, %prepare ], [ %sum.next, %channel.step ]
...
%delta.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %delta.index
%delta = load float, ptr addrspace(3) %delta.ptr, align 4
...
%output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %output.index
%output.value = load float, ptr addrspace(1) %output.ptr, align 4
%term = call float @recipe.mul(float %delta, float %output.value)
%sum.next = call float @recipe.add(float %sum, float %term)
%channel.next = add i32 %channel, 1
br label %channel.loop
store:
%product.index = add i32 %product.base, %query
%product.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %product.index
store float %sum, ptr addrspace(3) %product.ptr, align 4
...
float %scale, i32 %lid, i32 %block) #1 { entry:
...
complete:
%score.raw = call float @attention_tile_dot(i32 %query.local, i32 %key.local, i32 %head.width, i32 %query.shared, i32 %key.shared)
%score = call float @recipe.div(float %score.raw, float %scale)
%dp = call float @attention_tile_dot(i32 %query.local, i32 %key.local, i32 %head.width, i32 %delta.shared, i32 %value.shared)
%statistics.base = mul i32 %head.job, %length
%statistics.index = add i32 %statistics.base, %query
%maximum.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %statistics.index
%maximum = load float, ptr addrspace(1) %maximum.ptr, align 4
%denominator.index = add i32 %statistics.denominator.base, %statistics.index
%denominator.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %denominator.index
%denominator = load float, ptr addrspace(1) %denominator.ptr, align 4
%centered = call float @recipe.sub(float %score, float %maximum)
%exponential = call float @recipe.exp(float %centered)
%probability = call float @recipe.div(float %exponential, float %denominator)
%product.index = add i32 %product.shared, %query.local
%product.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %product.index
%product = load float, ptr addrspace(3) %product.ptr, align 4
%dp.centered = call float @recipe.sub(float %dp, float %product)
%derivative = call float @recipe.mul(float %probability, float %dp.centered)
br label %store
invalid:
br label %store
store:
%probability.value = phi float [ %probability, %complete ], [ 0.0, %invalid ]
%derivative.value = phi float [ %derivative, %complete ], [ 0.0, %invalid ]
...
%probability.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %probability.index
store float %probability.value, ptr addrspace(3) %probability.ptr, align 4
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %derivative.index
store float %derivative.value, ptr addrspace(3) %derivative.ptr, align 4
...
%head.width.double = call float @recipe.from.u32(i32 %head.width)
%scale = call float @recipe.sqrt(float %head.width.double)
...
%query.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %query.input.index
%query.value = load float, ptr addrspace(1) %query.input.ptr, align 4
%query.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %query.p
store float %query.value, ptr addrspace(3) %query.shared.ptr, align 4
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %accumulator.index
store float 0.0, ptr addrspace(3) %accumulator.ptr, align 4
...
%maximum.ptr.init = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %maximum.index.init
store float 0xFFF0000000000000, ptr addrspace(3) %maximum.ptr.init, align 4
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %denominator.index.init
store float 0.0, ptr addrspace(3) %denominator.ptr.init, align 4
...
%key.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %key.input.index
%key.value = load float, ptr addrspace(1) %key.input.ptr, align 4
%key.shared.index = add i32 %key.base.shared, %key.p
%key.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %key.shared.index
store float %key.value, ptr addrspace(3) %key.shared.ptr, align 4
%value.plane = mul i32 %from, 2
%value.row = add i32 %row.base, %value.plane
%value.input.index = add i32 %value.row, %key.input.local
%value.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %value.input.index
%value.value = load float, ptr addrspace(1) %value.input.ptr, align 4
%value.shared.index = add i32 %value.base.shared, %key.p
%value.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %value.shared.index
store float %value.value, ptr addrspace(3) %value.shared.ptr, align 4
...
score.complete:
%score.scaled = call float @attention_tile_score(i32 %score.query.local, i32 %score.key.local, i32 %head.width, i32 %key.base.shared, float %scale)
br label %score.store
score.invalid:
br label %score.store
score.store:
%score.value = phi float [ %score.scaled, %score.complete ], [ 0xFFF0000000000000, %score.invalid ]
...
%score.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %score.shared.index
store float %score.value, ptr addrspace(3) %score.shared.ptr, align 4
...
%maximum.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %maximum.index
%maximum.old = load float, ptr addrspace(3) %maximum.ptr, align 4
br label %maximum.loop
maximum.loop:
%maximum.key = phi i32 [ 0, %maximum.load ], [ %maximum.key.next, %maximum.step ]
%maximum.value = phi float [ %maximum.old, %maximum.load ], [ %maximum.next, %maximum.step ]
...
%maximum.score.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %maximum.score.index
%maximum.score = load float, ptr addrspace(3) %maximum.score.ptr, align 4
%maximum.larger = call i1 @recipe.ogt(float %maximum.score, float %maximum.value)
...
%denominator.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %denominator.index
%denominator.old = load float, ptr addrspace(3) %denominator.ptr, align 4
%maximum.old.centered = call float @recipe.sub(float %maximum.old, float %maximum.value)
%old.rescale = call float @recipe.exp(float %maximum.old.centered)
%denominator.rescaled = call float @recipe.mul(float %denominator.old, float %old.rescale)
br label %probability.loop
probability.loop:
%probability.key = phi i32 [ 0, %probability.prepare ], [ %probability.key.next, %probability.step ]
%denominator.value = phi float [ %denominator.rescaled, %probability.prepare ], [ %denominator.next, %probability.step ]
...
%probability.score.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %probability.score.index
%probability.score = load float, ptr addrspace(3) %probability.score.ptr, align 4
%probability.centered = call float @recipe.sub(float %probability.score, float %maximum.value)
%probability.value = call float @recipe.exp(float %probability.centered)
%probability.index = add i32 %probability.base.shared, %probability.local
%probability.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %probability.index
store float %probability.value, ptr addrspace(3) %probability.ptr, align 4
%denominator.next = call float @recipe.add(float %denominator.value, float %probability.value)
%probability.key.next = add i32 %probability.key, 1
br label %probability.loop
softmax.store:
store float %maximum.value, ptr addrspace(3) %maximum.ptr, align 4
store float %denominator.value, ptr addrspace(3) %denominator.ptr, align 4
%rescale.index = add i32 %rescale.base.shared, %softmax.query
%rescale.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %rescale.index
store float %old.rescale, ptr addrspace(3) %rescale.ptr, align 4
...
%accumulate.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %accumulate.index
%accumulate.old = load float, ptr addrspace(3) %accumulate.ptr, align 4
%accumulate.rescale.index = add i32 %rescale.base.shared, %accumulate.query
%accumulate.rescale.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %accumulate.rescale.index
%accumulate.rescale = load float, ptr addrspace(3) %accumulate.rescale.ptr, align 4
%accumulate.initial = call float @recipe.mul(float %accumulate.old, float %accumulate.rescale)
br label %accumulate.key.loop
accumulate.key.loop:
%accumulate.key = phi i32 [ 0, %accumulate.prepare ], [ %accumulate.key.next, %accumulate.key.step ]
%accumulate.value = phi float [ %accumulate.initial, %accumulate.prepare ], [ %accumulate.next, %accumulate.key.step ]
...
%accumulate.probability.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %accumulate.probability.index
%accumulate.probability = load float, ptr addrspace(3) %accumulate.probability.ptr, align 4
...
%accumulate.value.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %accumulate.value.index
%accumulate.v = load float, ptr addrspace(3) %accumulate.value.ptr, align 4
%accumulate.weighted = call float @recipe.mul(float %accumulate.probability, float %accumulate.v)
%accumulate.next = call float @recipe.add(float %accumulate.value, float %accumulate.weighted)
%accumulate.key.next = add i32 %accumulate.key, 1
br label %accumulate.key.loop
accumulate.store:
store float %accumulate.value, ptr addrspace(3) %accumulate.ptr, align 4
...
%output.accumulator.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %output.accumulator.index
%output.accumulator = load float, ptr addrspace(3) %output.accumulator.ptr, align 4
%output.denominator.index = add i32 %denominator.base.shared, %output.query.local
%output.denominator.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %output.denominator.index
%output.denominator = load float, ptr addrspace(3) %output.denominator.ptr, align 4
%attention = call float @recipe.div(float %output.accumulator, float %output.denominator)
...
%output.maximum.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %output.maximum.index
%output.maximum = load float, ptr addrspace(3) %output.maximum.ptr, align 4
...
%output.statistics.maximum.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %output.statistics.index
store float %output.maximum, ptr addrspace(1) %output.statistics.maximum.ptr, align 4
%output.statistics.denominator.index = add i32 %statistics.plane, %output.statistics.index
%output.statistics.denominator.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %output.statistics.denominator.index
store float %output.denominator, ptr addrspace(1) %output.statistics.denominator.ptr, align 4
...
%output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %output.index
store float %attention, ptr addrspace(1) %output.ptr, align 4
...
%length = udiv i32 %from, %channels
%head.width = udiv i32 %channels, %heads
%width.double = call float @recipe.from.u32(i32 %head.width)
%scale = call float @recipe.sqrt(float %width.double)
%head.jobs = mul i32 %rows, %heads
...
%stage.vector.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %stage.vector.index
%stage.vector.value = load <16 x float>, ptr addrspace(1) %stage.vector.ptr, align 4
call void @contraction_stage_column16(<16 x float> %stage.vector.value, i32 %stage.shared.base, i32 %stage.position, i32 %stage.channel.local, i32 %head.width)
...
%stage.scalar.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %stage.scalar.index
%stage.scalar.value = load float, ptr addrspace(1) %stage.scalar.ptr, align 4
...
%stage.scalar.ptr.shared = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %stage.scalar.index.shared
store float %stage.scalar.value, ptr addrspace(3) %stage.scalar.ptr.shared, align 4
...
%matrix.q.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.q.index
%matrix.q.fragment = load <16 x float>, ptr addrspace(3) %matrix.q.ptr, align 2
...
%matrix.k.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.k.index
%matrix.k.fragment = load <16 x float>, ptr addrspace(3) %matrix.k.ptr, align 2
%matrix.accumulator.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.q.fragment, <16 x float> %matrix.k.fragment, <8 x float> %matrix.accumulator)
...
%matrix.score.raw = call float @recipe.encode(float %matrix.score.wide)
%matrix.score.scaled = call float @recipe.div(float %matrix.score.raw, float %scale)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.score = select i1 %matrix.causal, float %matrix.score.scaled, float 0xFFF0000000000000
...
%matrix.p.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.p.index
store float %matrix.score, ptr addrspace(3) %matrix.p.ptr, align 4
...
%maximum = phi float [ 0xFFF0000000000000, %attention.forward.matrix.softmax.loop ], [ %maximum.next, %attention.forward.matrix.maximum.step ]
...
%maximum.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %maximum.index
%maximum.score = load float, ptr addrspace(3) %maximum.ptr, align 4
%maximum.larger = call i1 @recipe.ogt(float %maximum.score, float %maximum)
%maximum.next = select i1 %maximum.larger, float %maximum.score, float %maximum
%maximum.key.next = add i32 %maximum.key, 1
...
%denominator = phi float [ 0.0, %attention.forward.matrix.maximum.loop ], [ %denominator.next, %attention.forward.matrix.probability.step ]
...
%probability.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %probability.index
%probability.score = load float, ptr addrspace(3) %probability.ptr, align 4
%probability.centered = call float @recipe.sub(float %probability.score, float %maximum)
%probability.value = call float @recipe.exp(float %probability.centered)
store float %probability.value, ptr addrspace(3) %probability.ptr, align 4
%denominator.next = call float @recipe.add(float %denominator, float %probability.value)
%probability.key.next = add i32 %probability.key, 1
...
%normalize.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %normalize.index
%normalize.value = load float, ptr addrspace(3) %normalize.ptr, align 4
%normalized = call float @recipe.div(float %normalize.value, float %denominator)
store float %normalized, ptr addrspace(3) %normalize.ptr, align 4
...
%maximum.context.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %statistics.index
store float %maximum, ptr addrspace(1) %maximum.context.ptr, align 4
%denominator.index = add i32 %statistics.rows, %statistics.index
%denominator.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %denominator.index
store float %denominator, ptr addrspace(1) %denominator.ptr, align 4
%softmax.query.next = add i32 %softmax.query, %block
br label %attention.forward.matrix.softmax.loop
attention.forward.matrix.softmax.done:
call void @llvm.nvvm.barrier0()
call void @attention_matrix_product(ptr addrspace(1) %output, i32 3, i32 %p.base, i32 %v.base, i32 %output.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
call void @llvm.nvvm.barrier0()
...
%left.fragment = phi <16 x float> [ zeroinitializer, %attention.matrix.gradient.k.loop ], [ %left.fragment.next, %attention.matrix.gradient.fragment.step ]
%right.fragment = phi <16 x float> [ zeroinitializer, %attention.matrix.gradient.k.loop ], [ %right.fragment.next, %attention.matrix.gradient.fragment.step ]
...
%left.index = add i32 %left.base, %left.local
%left.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %left.index
%left.loaded = load float, ptr addrspace(3) %left.ptr, align 4
%right.row = mul i32 %term.safe, %head.width
%right.local = add i32 %right.row, %n.safe
%right.index = add i32 %right.base, %right.local
%right.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %right.index
%right.loaded = load float, ptr addrspace(3) %right.ptr, align 4
%left.valid = and i1 %m.valid, %term.valid
%right.valid = and i1 %n.valid, %term.valid
%left.value = select i1 %left.valid, float %left.loaded, float 0.0
%right.value = select i1 %right.valid, float %right.loaded, float 0.0
%left.fragment.next = insertelement <16 x float> %left.fragment, float %left.value, i32 %fragment
%right.fragment.next = insertelement <16 x float> %right.fragment, float %right.value, i32 %fragment
%fragment.next = add i32 %fragment, 1
br label %attention.matrix.gradient.fragment.loop
attention.matrix.gradient.fragment.done:
%accumulator.next = call <8 x float> @recipe.wmma(<16 x float> %left.fragment, <16 x float> %right.fragment, <8 x float> %accumulator)
...
%output.raw = call float @recipe.encode(float %output.wide)
%output.scaled = call float @recipe.div(float %output.raw, float %scale)
%output.value = select i1 %unscaled, float %output.raw, float %output.scaled
...
%output.index = add i32 %output.row, %output.local
%output.ptr = getelementptr inbounds float, ptr addrspace(1) %previous, i32 %output.index
store float %output.value, ptr addrspace(1) %output.ptr, align 4
...
%stage.vector.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %stage.vector.input.index
%stage.vector.input.value = load <16 x float>, ptr addrspace(1) %stage.vector.input.ptr, align 4
...
%stage.vector.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %stage.vector.delta.index
%stage.vector.delta.value = load <16 x float>, ptr addrspace(1) %stage.vector.delta.ptr, align 4
br label %attention.matrix.stage.vector.store
attention.matrix.stage.vector.store:
%stage.vector.value = phi <16 x float> [ %stage.vector.input.value, %attention.matrix.stage.vector.input ], [ %stage.vector.delta.value, %attention.matrix.stage.vector.delta ]
call void @contraction_stage_column16(<16 x float> %stage.vector.value, i32 %stage.shared.base, i32 %stage.position, i32 %stage.channel.local, i32 %head.width)
%stage.vector.position.next = add i32 %stage.position, 16
...
%stage.scalar.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %stage.scalar.input.index
%stage.scalar.input.value = load float, ptr addrspace(1) %stage.scalar.input.ptr, align 4
...
%stage.scalar.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %stage.scalar.delta.index
%stage.scalar.delta.value = load float, ptr addrspace(1) %stage.scalar.delta.ptr, align 4
br label %attention.matrix.stage.scalar.store
attention.matrix.stage.scalar.store:
%stage.scalar.value = phi float [ %stage.scalar.input.value, %attention.matrix.stage.scalar.input ], [ %stage.scalar.delta.value, %attention.matrix.stage.scalar.delta ]
%stage.scalar.row = mul i32 %stage.position, %head.width
%stage.scalar.local = add i32 %stage.scalar.row, %stage.channel.local
%stage.scalar.index.shared = add i32 %stage.shared.base, %stage.scalar.local
%stage.scalar.ptr.shared = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %stage.scalar.index.shared
...
%d.sum = phi float [ 0.0, %attention.matrix.d.loop ], [ %d.sum.next, %attention.matrix.d.sum.step ]
...
%d.do.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %d.do.index
%d.do = load float, ptr addrspace(3) %d.do.ptr, align 4
...
%d.output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %d.output.index
%d.output = load float, ptr addrspace(1) %d.output.ptr, align 4
%d.term = call float @recipe.mul(float %d.do, float %d.output)
%d.sum.next = call float @recipe.add(float %d.sum, float %d.term)
...
%d.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %d.index
store float %d.sum, ptr addrspace(3) %d.ptr, align 4
...
%matrix.do.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x float>, ptr addrspace(3) %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.v.index
%matrix.v.fragment = load <16 x float>, ptr addrspace(3) %matrix.v.ptr, align 2
%matrix.score.accumulator.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.q.fragment, <16 x float> %matrix.k.fragment, <8 x float> %matrix.score.accumulator)
%matrix.dp.accumulator.next = call <8 x float> @recipe.wmma(<16 x float> %matrix.do.fragment, <16 x float> %matrix.v.fragment, <8 x float> %matrix.dp.accumulator)
%matrix.width.next = add i32 %matrix.width, 16
br label %attention.matrix.score.width.loop
...
%matrix.score.raw = call float @recipe.encode(float %matrix.score.wide)
%matrix.score = call float @recipe.div(float %matrix.score.raw, float %scale)
%matrix.dp.wide = extractelement <8 x float> %matrix.dp.accumulator, i32 %matrix.output
%matrix.dp = call float @recipe.encode(float %matrix.dp.wide)
%matrix.causal = icmp ule i32 %matrix.k, %matrix.query
%matrix.statistics.base = mul i32 %head.job, %length
%matrix.statistics.index = add i32 %matrix.statistics.base, %matrix.query
%matrix.maximum.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %matrix.statistics.index
%matrix.maximum = load float, ptr addrspace(1) %matrix.maximum.ptr, align 4
%matrix.denominator.index = add i32 %statistics.rows, %matrix.statistics.index
%matrix.denominator.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %matrix.denominator.index
%matrix.denominator = load float, ptr addrspace(1) %matrix.denominator.ptr, align 4
%matrix.centered = call float @recipe.sub(float %matrix.score, float %matrix.maximum)
%matrix.exponential = call float @recipe.exp(float %matrix.centered)
%matrix.probability.raw = call float @recipe.div(float %matrix.exponential, float %matrix.denominator)
%matrix.probability = select i1 %matrix.causal, float %matrix.probability.raw, float 0.0
%matrix.d.index = add i32 %d.base, %matrix.query
%matrix.d.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.d.index
%matrix.d = load float, ptr addrspace(3) %matrix.d.ptr, align 4
%matrix.dp.centered = call float @recipe.sub(float %matrix.dp, float %matrix.d)
%matrix.derivative = call float @recipe.mul(float %matrix.probability, float %matrix.dp.centered)
%matrix.pair.row = mul i32 %matrix.query, %length
%matrix.pair.local = add i32 %matrix.pair.row, %matrix.k
%matrix.p.index = add i32 %p.base, %matrix.pair.local
%matrix.p.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.p.index
store float %matrix.probability, ptr addrspace(3) %matrix.p.ptr, align 4
%matrix.ds.index = add i32 %ds.base, %matrix.pair.local
%matrix.ds.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %matrix.ds.index
store float %matrix.derivative, ptr addrspace(3) %matrix.ds.ptr, align 4
...
call void @llvm.nvvm.barrier0()
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 0, i32 %ds.base, i32 %k.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 1, i32 %ds.base, i32 %q.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
call void @attention_matrix_product(ptr addrspace(1) %previous, i32 2, i32 %p.base, i32 %do.base, i32 %input.row, i32 %from, i32 %head.start, i32 %length, i32 %head.width, float %scale, i32 %lid, i32 %block)
call void @llvm.nvvm.barrier0()
...
%dq.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %dq.input.index
%dq.query.value = load float, ptr addrspace(1) %dq.input.ptr, align 4
%dq.query.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.query.p
store float %dq.query.value, ptr addrspace(3) %dq.query.shared.ptr, align 4
%dq.delta.index = add i32 %dq.output.row, %dq.local
%dq.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %dq.delta.index
%dq.delta.value = load float, ptr addrspace(1) %dq.delta.ptr, align 4
%dq.delta.shared.index = add i32 %dq.delta.base.shared, %dq.query.p
%dq.delta.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.delta.shared.index
store float %dq.delta.value, ptr addrspace(3) %dq.delta.shared.ptr, align 4
%dq.gradient.shared.index = add i32 %dq.gradient.base.shared, %dq.query.p
%dq.gradient.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.gradient.shared.index
store float 0.0, ptr addrspace(3) %dq.gradient.shared.ptr, align 4
...
%dq.key.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %dq.key.input.index
%dq.key.value = load float, ptr addrspace(1) %dq.key.input.ptr, align 4
%dq.key.shared.index = add i32 %dq.key.base.shared, %dq.key.p
%dq.key.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.key.shared.index
store float %dq.key.value, ptr addrspace(3) %dq.key.shared.ptr, align 4
...
%dq.value.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %dq.value.input.index
%dq.value.value = load float, ptr addrspace(1) %dq.value.input.ptr, align 4
%dq.value.shared.index = add i32 %dq.value.base.shared, %dq.key.p
%dq.value.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.value.shared.index
store float %dq.value.value, ptr addrspace(3) %dq.value.shared.ptr, align 4
...
%dq.accumulate.gradient.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.accumulate.gradient.index
%dq.accumulate.initial = load float, ptr addrspace(3) %dq.accumulate.gradient.ptr, align 4
...
%dq.accumulate.value = phi float [ %dq.accumulate.initial, %dq.accumulate.prepare ], [ %dq.accumulate.next, %dq.accumulate.key.step ]
...
%dq.accumulate.pair.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.accumulate.pair.index
%dq.accumulate.ds = load float, ptr addrspace(3) %dq.accumulate.pair.ptr, align 4
...
%dq.accumulate.key.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.accumulate.key.index
%dq.accumulate.key.value = load float, ptr addrspace(3) %dq.accumulate.key.ptr, align 4
%dq.accumulate.raw = call float @recipe.mul(float %dq.accumulate.ds, float %dq.accumulate.key.value)
%dq.accumulate.term = call float @recipe.div(float %dq.accumulate.raw, float %scale)
%dq.accumulate.next = call float @recipe.add(float %dq.accumulate.value, float %dq.accumulate.term)
%dq.accumulate.key.next = add i32 %dq.accumulate.key, 1
br label %dq.accumulate.key.loop
dq.accumulate.store:
store float %dq.accumulate.value, ptr addrspace(3) %dq.accumulate.gradient.ptr, align 4
...
%dq.store.ptr = getelementptr inbounds float, ptr addrspace(1) %previous, i32 %dq.store.index
%dq.store.shared.index = add i32 %dq.gradient.base.shared, %dq.store.p
%dq.store.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dq.store.shared.index
%dq.store.value = load float, ptr addrspace(3) %dq.store.shared.ptr, align 4
store float %dq.store.value, ptr addrspace(1) %dq.store.ptr, align 4
...
%dkv.key.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %dkv.key.input.index
%dkv.key.value = load float, ptr addrspace(1) %dkv.key.input.ptr, align 4
%dkv.key.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.key.p
store float %dkv.key.value, ptr addrspace(3) %dkv.key.shared.ptr, align 4
...
%dkv.value.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %dkv.value.input.index
%dkv.value.value = load float, ptr addrspace(1) %dkv.value.input.ptr, align 4
%dkv.value.shared.index = add i32 %dkv.value.base.shared, %dkv.key.p
%dkv.value.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.value.shared.index
store float %dkv.value.value, ptr addrspace(3) %dkv.value.shared.ptr, align 4
%dkv.key.gradient.index = add i32 %dkv.key.gradient.base.shared, %dkv.key.p
%dkv.key.gradient.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.key.gradient.index
store float 0.0, ptr addrspace(3) %dkv.key.gradient.ptr, align 4
%dkv.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.key.p
%dkv.value.gradient.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.value.gradient.index
store float 0.0, ptr addrspace(3) %dkv.value.gradient.ptr, align 4
...
%dkv.query.input.ptr = getelementptr inbounds float, ptr addrspace(1) %input, i32 %dkv.query.input.index
%dkv.query.value = load float, ptr addrspace(1) %dkv.query.input.ptr, align 4
%dkv.query.shared.index = add i32 %dkv.query.base.shared, %dkv.query.p
%dkv.query.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.query.shared.index
store float %dkv.query.value, ptr addrspace(3) %dkv.query.shared.ptr, align 4
%dkv.delta.input.index = add i32 %dkv.output.row, %dkv.query.input.local
%dkv.delta.input.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %dkv.delta.input.index
%dkv.delta.value = load float, ptr addrspace(1) %dkv.delta.input.ptr, align 4
%dkv.delta.shared.index = add i32 %dkv.delta.base.shared, %dkv.query.p
%dkv.delta.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.delta.shared.index
store float %dkv.delta.value, ptr addrspace(3) %dkv.delta.shared.ptr, align 4
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.key.gradient.index
%dkv.accumulate.key.initial = load float, ptr addrspace(3) %dkv.accumulate.key.gradient.ptr, align 4
%dkv.accumulate.value.gradient.index = add i32 %dkv.value.gradient.base.shared, %dkv.accumulate.p
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.value.gradient.index
%dkv.accumulate.value.initial = load float, ptr addrspace(3) %dkv.accumulate.value.gradient.ptr, align 4
...
%dkv.accumulate.key.value = phi float [ %dkv.accumulate.key.initial, %dkv.accumulate.prepare ], [ %dkv.accumulate.key.next, %dkv.accumulate.query.step ]
%dkv.accumulate.value.value = phi float [ %dkv.accumulate.value.initial, %dkv.accumulate.prepare ], [ %dkv.accumulate.value.next, %dkv.accumulate.query.step ]
...
%dkv.accumulate.probability.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.probability.index
%dkv.accumulate.probability = load float, ptr addrspace(3) %dkv.accumulate.probability.ptr, align 4
%dkv.accumulate.derivative.index = add i32 %dkv.derivative.base.shared, %dkv.accumulate.pair.local
%dkv.accumulate.derivative.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.derivative.index
%dkv.accumulate.derivative = load float, ptr addrspace(3) %dkv.accumulate.derivative.ptr, align 4
...
%dkv.accumulate.query.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.query.index
%dkv.accumulate.query.value = load float, ptr addrspace(3) %dkv.accumulate.query.ptr, align 4
%dkv.accumulate.delta.index = add i32 %dkv.delta.base.shared, %dkv.accumulate.query.local
%dkv.accumulate.delta.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.accumulate.delta.index
%dkv.accumulate.delta = load float, ptr addrspace(3) %dkv.accumulate.delta.ptr, align 4
%dkv.accumulate.key.raw = call float @recipe.mul(float %dkv.accumulate.derivative, float %dkv.accumulate.query.value)
%dkv.accumulate.key.term = call float @recipe.div(float %dkv.accumulate.key.raw, float %scale)
%dkv.accumulate.key.next = call float @recipe.add(float %dkv.accumulate.key.value, float %dkv.accumulate.key.term)
%dkv.accumulate.value.term = call float @recipe.mul(float %dkv.accumulate.probability, float %dkv.accumulate.delta)
%dkv.accumulate.value.next = call float @recipe.add(float %dkv.accumulate.value.value, float %dkv.accumulate.value.term)
%dkv.accumulate.query.next = add i32 %dkv.accumulate.query, 1
br label %dkv.accumulate.query.loop
dkv.accumulate.store:
store float %dkv.accumulate.key.value, ptr addrspace(3) %dkv.accumulate.key.gradient.ptr, align 4
store float %dkv.accumulate.value.value, ptr addrspace(3) %dkv.accumulate.value.gradient.ptr, align 4
...
%dkv.store.key.ptr = getelementptr inbounds float, ptr addrspace(1) %previous, i32 %dkv.store.key.index
%dkv.store.key.shared.index = add i32 %dkv.key.gradient.base.shared, %dkv.store.p
%dkv.store.key.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.store.key.shared.index
%dkv.store.key.value = load float, ptr addrspace(3) %dkv.store.key.shared.ptr, align 4
store float %dkv.store.key.value, ptr addrspace(1) %dkv.store.key.ptr, align 4
...
%dkv.store.value.ptr = getelementptr inbounds float, ptr addrspace(1) %previous, i32 %dkv.store.value.index
%dkv.store.value.shared.index = add i32 %dkv.value.gradient.base.shared, %dkv.store.p
%dkv.store.value.shared.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %dkv.store.value.shared.index
%dkv.store.value.value = load float, ptr addrspace(3) %dkv.store.value.shared.ptr, align 4
store float %dkv.store.value.value, ptr addrspace(1) %dkv.store.value.ptr, align 4
...
%precompute.weights = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %precompute.weight.offset
%precompute.context.offset = mul i32 %precompute.gate, %gate.batch
%precompute.context = getelementptr inbounds float, ptr addrspace(1) %context, i32 %precompute.context.offset
...
%input.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %input.index
%input.sum = load float, ptr addrspace(1) %input.ptr, align 4 br label %state.sum.loop state.sum.loop:
%state.channel = phi i32 [ 0, %input.load ], [ %state.next, %state.sum.step ]
%state.sum = phi float [ %input.sum, %input.load ], [ %state.sum.next, %state.sum.step ]
...
%previous.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %previous.index
%previous.loaded = load float, ptr addrspace(1) %previous.ptr, align 4
%previous = select i1 %previous.exists, float %previous.loaded, float 0.0 %candidate.gate = icmp eq i32 %gate, 2
...
%reset.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %reset.base
%reset = load float, ptr addrspace(1) %reset.ptr, align 4 %reset.state = call float @recipe.mul(float %reset, float %previous)
%state.value = select i1 %reset.candidate, float %reset.state, float %previous
...
%state.weight.ptr = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %state.weight.index
%state.weight = load float, ptr addrspace(1) %state.weight.ptr, align 4
%state.product = call float @recipe.mul(float %state.value, float %state.weight) %state.sum.next = call float @recipe.add(float %state.sum, float %state.product)
...
%bias.ptr = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %bias.index
%bias = load float, ptr addrspace(1) %bias.ptr, align 4 %linear = call float @recipe.add(float %state.sum, float %bias)
%rnn = icmp eq i32 %gates, 1 %last.gate = sub i32 %gates, 1 %candidate = icmp eq i32 %gate, %last.gate
%use.tanh = or i1 %rnn, %candidate %tanh.value = call float @recipe.tanh(float %linear)
%sigmoid.value = call float @sigmoid(float %linear)
%gate.value = select i1 %use.tanh, float %tanh.value, float %sigmoid.value br label %gate.store gate.store:
...
%gate.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gate.index
store float %gate.value, ptr addrspace(1) %gate.ptr, align 4 %hidden.next = add nuw i32 %hidden, 1
...
%output.index = add i32 %output.row.base, %output.local
%gate0.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %output.index
%gate0 = load float, ptr addrspace(1) %gate0.ptr, align 4
...
%gate1.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gate1.index
%gate1 = load float, ptr addrspace(1) %gate1.ptr, align 4 %gate2.base = mul i32 %gate.batch, 2
...
%gate2.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gate2.index
%gate2 = load float, ptr addrspace(1) %gate2.ptr, align 4 %gate3.base = mul i32 %gate.batch, 3
%gate3.raw = add i32 %gate3.base, %output.index %gate3.index = select i1 %is.lstm, i32 %gate3.raw, i32 %output.index
%gate3.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gate3.index
%gate3 = load float, ptr addrspace(1) %gate3.ptr, align 4 %output.previous.time = sub i32 %time, 1
...
%output.previous.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %output.previous.index
%output.previous.loaded = load float, ptr addrspace(1) %output.previous.ptr, align 4
%output.previous = select i1 %previous.exists, float %output.previous.loaded, float 0.0
%one.update = call float @recipe.sub(float 1.0, float %gate0) %gru.old = call float @recipe.mul(float %gate0, float %output.previous)
%gru.new = call float @recipe.mul(float %one.update, float %gate2) %gru.value = call float @recipe.add(float %gru.old, float %gru.new)
...
%cell.previous.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %cell.previous.index
%cell.previous.loaded = load float, ptr addrspace(1) %cell.previous.ptr, align 4
%cell.previous = select i1 %previous.exists, float %cell.previous.loaded, float 0.0
%cell.old = call float @recipe.mul(float %gate1, float %cell.previous) %cell.new = call float @recipe.mul(float %gate0, float %gate3)
%cell = call float @recipe.add(float %cell.old, float %cell.new)
%cell.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %cell.index
store float %cell, ptr addrspace(1) %cell.ptr, align 4 %cell.tanh = call float @recipe.tanh(float %cell)
%lstm.value = call float @recipe.mul(float %gate2, float %cell.tanh)
%rnn.or.gru = select i1 %is.gru, float %gru.value, float %gate0
%output.value = select i1 %is.lstm, float %lstm.value, float %rnn.or.gru br label %output.store output.store:
%output.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %output.index
store float %output.value, ptr addrspace(1) %output.ptr, align 4 %output.next = add nuw i32 %output.hidden, 1
...
%sums = alloca [RECIPE_REGISTER_COUNT x float], align 4
%bias.sums = alloca [RECIPE_REGISTER_N x float], align 4
%state.zero = call float @recipe.state.from.u1(i1 false) %lid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() %group = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() %block = call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() %groups = udiv i32 %threads, %block
...
%gradient.scratch = getelementptr inbounds float, ptr addrspace(1) %gradient, i32 RECIPE_GRADIENT_SCRATCH_BASE
...
%gradient.method.store = call i1 @contraction_vector_store_lane(i1 %gradient.lane.store, i32 %gradient.output.id)
...
gradient.sum.init.step: %gradient.sum.init.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %gradient.sum.init store float %state.zero, ptr %gradient.sum.init.ptr, align 4 %gradient.sum.init.next = add i32 %gradient.sum.init, 1 br label %gradient.sum.init.loop gradient.tile.loop:
...
%gradient.a.vector.source = getelementptr inbounds float, ptr addrspace(1) %input, i32 %gradient.a.vector.index
%gradient.a.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr addrspace(1) %gradient.a.vector.source, align 4
call void @contraction_stage_a_columns(<RECIPE_FRAGMENT_K x float> %gradient.a.vector.value, i32 %gradient.a.r, i32 %gradient.a.m, i32 %gradient.tile.m, i32 %gradient.tile.k)
br label %gradient.load.advance
gradient.load.a.scalar:
%gradient.a.value = call float @contraction_input( ptr addrspace(1) %input, i32 %gradient.a.row.base, i32 %gradient.a.position, i32 %gradient.a.term, i32 %span, i32 %in.length, i1 %is.conv )
...
%gradient.b.vector.value = call <RECIPE_FRAGMENT_K x float> @contraction_delta_vector16(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %gradient.b.index, i1 %relu)
call void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x float> %gradient.b.vector.value, i32 %gradient.b.r, i32 %gradient.b.n, i32 %gradient.tile.m, i32 %gradient.tile.n, i32 %gradient.tile.k)
br label %gradient.load.advance
gradient.load.b.scalar:
%gradient.b.value = call float @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %gradient.b.index, i1 %relu)
br label %gradient.load.store
gradient.load.store: %gradient.load.value = phi float [ %gradient.a.value, %gradient.load.a.scalar ], [ %gradient.b.value, %gradient.load.b.scalar ] %gradient.load.index = phi i32 [ %gradient.a.tile.index, %gradient.load.a.scalar ], [ %gradient.b.tile.index, %gradient.load.b.scalar ]
%gradient.load.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %gradient.load.index store float %gradient.load.value, ptr addrspace(3) %gradient.load.ptr, align 4
br label %gradient.load.advance
...
%gradient.store.ptr = getelementptr inbounds float, ptr addrspace(1) %gradient.destination, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %gradient.store.register %gradient.store.sum.wide = load float, ptr %gradient.store.sum.ptr, align 4 %gradient.store.sum = call float @recipe.encode(float %gradient.store.sum.wide) store float %gradient.store.sum, ptr addrspace(1) %gradient.store.ptr, align 4
...
%previous.method.store = call i1 @contraction_vector_store_lane(i1 %previous.lane.store, i32 %previous.output.id)
...
previous.sum.init.step: %previous.sum.init.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %previous.sum.init store float %state.zero, ptr %previous.sum.init.ptr, align 4 %previous.sum.init.next = add i32 %previous.sum.init, 1 br label %previous.sum.init.loop previous.tile.loop:
...
%previous.a.local = add i32 %previous.a.filter.base, %previous.a.position.safe %previous.a.index = add i32 %previous.a.row.base, %previous.a.local %previous.a.tile.index = call i32 @contraction_vector_a_index(i32 %previous.a.r, i32 %previous.a.m, i32 %previous.tile.m, i32 %previous.tile.k)
br i1 %previous.a.vector, label %previous.load.a.vector, label %previous.load.a.scalar
previous.load.a.vector:
%previous.a.vector.delta = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %previous.a.index
%previous.a.vector.output = getelementptr inbounds float, ptr addrspace(1) %output, i32 %previous.a.index
%previous.a.vector.delta.value = load <RECIPE_FRAGMENT_K x float>, ptr addrspace(1) %previous.a.vector.delta, align 4
%previous.a.vector.output.value = load <RECIPE_FRAGMENT_K x float>, ptr addrspace(1) %previous.a.vector.output, align 4
call void @contraction_stage_delta_a_fragment(<RECIPE_FRAGMENT_K x float> %previous.a.vector.delta.value, <RECIPE_FRAGMENT_K x float> %previous.a.vector.output.value, i1 %relu, i32 %previous.a.r, i32 %previous.a.m, i32 %previous.tile.m, i32 %previous.tile.k)
br label %previous.load.advance
previous.load.a.scalar:
%previous.a.raw = call float @contraction_delta(ptr addrspace(1) %delta, ptr addrspace(1) %output, i32 %previous.a.index, i1 %relu)
%previous.a.value = select i1 %previous.a.valid, float %previous.a.raw, float 0.0
...
%previous.b.vector.source = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %previous.b.index
%previous.b.vector.value = load <RECIPE_FRAGMENT_K x float>, ptr addrspace(1) %previous.b.vector.source, align 4
call void @contraction_stage_b_fragment(<RECIPE_FRAGMENT_K x float> %previous.b.vector.value, i32 %previous.b.r, i32 %previous.b.n, i32 %previous.tile.m, i32 %previous.tile.n, i32 %previous.tile.k)
br label %previous.load.advance
previous.load.b.scalar:
%previous.b.ptr = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %previous.b.index
%previous.b.value = load float, ptr addrspace(1) %previous.b.ptr, align 4
br label %previous.load.store
previous.load.store: %previous.load.value = phi float [ %previous.a.value, %previous.load.a.scalar ], [ %previous.b.value, %previous.load.b.scalar ] %previous.load.index = phi i32 [ %previous.a.tile.index, %previous.load.a.scalar ], [ %previous.b.tile.index, %previous.load.b.scalar ]
%previous.load.ptr = getelementptr [0 x float], ptr addrspace(3) @contraction_tile_tf32, i32 0, i32 %previous.load.index store float %previous.load.value, ptr addrspace(3) %previous.load.ptr, align 4
br label %previous.load.advance
...
previous.store.test: %previous.store.output.m.raw = call i32 @contraction_vector_output_m(i32 %previous.output.id, i32 %previous.store.register, i32 %previous.m.lanes) %previous.store.output.n.raw = call i32 @contraction_vector_output_n(i32 %previous.output.id, i32 %previous.store.register, i32 %previous.m.lanes) %previous.store.register.valid = call i1 @contraction_output_register_valid(i32 %previous.store.register)
...
%previous.store.row.base = mul i32 %previous.store.row, %in.elements %previous.store.channel.base = mul i32 %previous.store.channel, %in.length %previous.store.local = add i32 %previous.store.channel.base, %previous.store.position %previous.store.index = add i32 %previous.store.row.base, %previous.store.local %previous.store.ptr = getelementptr inbounds float, ptr addrspace(1) %previous, i32 %previous.store.index
%previous.store.old = load float, ptr addrspace(1) %previous.store.ptr, align 4 %previous.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x float], ptr %sums, i32 0, i32 %previous.store.register %previous.store.sum.wide = load float, ptr %previous.store.sum.ptr, align 4 %previous.store.sum = call float @recipe.encode(float %previous.store.sum.wide) %previous.store.value = call float @recipe.add(float %previous.store.old, float %previous.store.sum) store float %previous.store.value, ptr addrspace(1) %previous.store.ptr, align 4 br label %previous.store.next
...
%clear.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %clear.index
store float 0.0, ptr addrspace(1) %clear.ptr, align 4 %clear.next = add nuw i32 %clear.p, 1
...
%clear.dh.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %clear.dh.index
%clear.dc.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %clear.dc.index
store float 0.0, ptr addrspace(1) %clear.dh.ptr, align 4 store float 0.0, ptr addrspace(1) %clear.dc.ptr, align 4
...
%rnn.index = add i32 %row.output.base, %rnn.local %rnn.dy.ptr = getelementptr inbounds float,
ptr addrspace(1) %delta, i32 %rnn.index %rnn.future.index = add i32 %dh.start, %rnn.hidden
%rnn.future.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %rnn.future.index
%rnn.gate.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %rnn.index
%rnn.dy = load float, ptr addrspace(1) %rnn.dy.ptr, align 4
%rnn.future = load float, ptr addrspace(1) %rnn.future.ptr, align 4
%rnn.gate = load float, ptr addrspace(1) %rnn.gate.ptr, align 4 %rnn.dh = call float @recipe.add(float %rnn.dy, float %rnn.future)
%rnn.square = call float @recipe.mul(float %rnn.gate, float %rnn.gate) %rnn.derivative = call float @recipe.sub(float 1.0, float %rnn.square)
%rnn.delta = call float @recipe.mul(float %rnn.dh, float %rnn.derivative) %rnn.delta.index = add i32 %delta.base, %rnn.index
%rnn.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %rnn.delta.index
store float %rnn.delta, ptr addrspace(1) %rnn.delta.ptr, align 4 %rnn.next = add i32 %rnn.hidden, 1
...
%gru.dy.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %gru.index
%gru.future.index = add i32 %dh.start, %gru.hidden
%gru.future.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.future.index
%gru.previous.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %gru.previous.index
%gru.z.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.index
%gru.n.index = add i32 %gru.index, %gate2.batch
%gru.n.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.n.index
%gru.dy = load float, ptr addrspace(1) %gru.dy.ptr, align 4
%gru.future = load float, ptr addrspace(1) %gru.future.ptr, align 4
%gru.previous.loaded = load float, ptr addrspace(1) %gru.previous.ptr, align 4
%gru.previous = select i1 %previous.exists, float %gru.previous.loaded, float 0.0
%gru.z = load float, ptr addrspace(1) %gru.z.ptr, align 4
%gru.n = load float, ptr addrspace(1) %gru.n.ptr, align 4 %gru.dh = call float @recipe.add(float %gru.dy, float %gru.future)
%gru.one.z = call float @recipe.sub(float 1.0, float %gru.z) %gru.z.difference = call float @recipe.sub(float %gru.previous, float %gru.n)
%gru.dz.0 = call float @recipe.mul(float %gru.dh, float %gru.z.difference) %gru.dz.1 = call float @recipe.mul(float %gru.dz.0, float %gru.z)
%gru.dz = call float @recipe.mul(float %gru.dz.1, float %gru.one.z) %gru.n.square = call float @recipe.mul(float %gru.n, float %gru.n)
%gru.n.derivative = call float @recipe.sub(float 1.0, float %gru.n.square) %gru.dn.0 = call float @recipe.mul(float %gru.dh, float %gru.one.z)
%gru.dn = call float @recipe.mul(float %gru.dn.0, float %gru.n.derivative) %gru.dz.index = add i32 %delta.base, %gru.index
%gru.dn.index.0 = add i32 %delta.base, %gate2.batch %gru.dn.index = add i32 %gru.dn.index.0, %gru.index
%gru.dz.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.dz.index
%gru.dn.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.dn.index
store float %gru.dz, ptr addrspace(1) %gru.dz.ptr, align 4
store float %gru.dn, ptr addrspace(1) %gru.dn.ptr, align 4 %gru.next = add i32 %gru.hidden, 1
...
%gru.reset.sum = phi float [ 0.0, %gru.reset.loop ], [ %gru.reset.sum.next, %gru.reset.sum.step ]
...
%gru.weight.ptr = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %gru.weight.index
...
%gru.target.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.target.delta.index
%gru.weight = load float, ptr addrspace(1) %gru.weight.ptr, align 4
%gru.target.delta = load float, ptr addrspace(1) %gru.target.delta.ptr, align 4
%gru.reset.product = call float @recipe.mul(float %gru.weight, float %gru.target.delta)
%gru.reset.sum.next = call float @recipe.add(float %gru.reset.sum, float %gru.reset.product)
...
%gru.source.previous.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %gru.source.previous.index
%gru.r.index = add i32 %batch, %gru.source.index
%gru.r.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.r.index
%gru.source.previous.loaded = load float, ptr addrspace(1) %gru.source.previous.ptr, align 4
%gru.source.previous = select i1 %previous.exists, float %gru.source.previous.loaded, float 0.0
%gru.r = load float, ptr addrspace(1) %gru.r.ptr, align 4
%gru.dr = call float @recipe.mul(float %gru.reset.sum, float %gru.source.previous) %gru.one.r = call float @recipe.sub(float 1.0, float %gru.r)
%gru.dr.0 = call float @recipe.mul(float %gru.dr, float %gru.r) %gru.dr.1 = call float @recipe.mul(float %gru.dr.0, float %gru.one.r)
%gru.dr.base = add i32 %delta.base, %batch %gru.dr.index = add i32 %gru.dr.base, %gru.source.index
%gru.dr.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %gru.dr.index
store float %gru.dr.1, ptr addrspace(1) %gru.dr.ptr, align 4 %gru.source.next = add i32 %gru.source, 1
...
%dy.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %index %dh.index = add i32 %dh.start, %hidden
%dc.index = add i32 %dc.start, %hidden %dh.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %dh.index
%dc.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %dc.index
%cell.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %cell.index
%cell.previous.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %cell.previous.index
%dy = load float, ptr addrspace(1) %dy.ptr, align 4 %dh.future = load float, ptr addrspace(1) %dh.ptr, align 4
%dc.future = load float, ptr addrspace(1) %dc.ptr, align 4 %cell = load float, ptr addrspace(1) %cell.ptr, align 4
%cell.previous.loaded = load float, ptr addrspace(1) %cell.previous.ptr, align 4
%cell.previous = select i1 %previous.exists, float %cell.previous.loaded, float 0.0
%i.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %index %f.index = add i32 %batch, %index
%o.index = add i32 %f.index, %batch %g.index = add i32 %o.index, %batch
%f.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %f.index
%o.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %o.index
%g.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %g.index
%i = load float, ptr addrspace(1) %i.ptr, align 4 %f = load float, ptr addrspace(1) %f.ptr, align 4
%o = load float, ptr addrspace(1) %o.ptr, align 4 %g = load float, ptr addrspace(1) %g.ptr, align 4
%dh = call float @recipe.add(float %dy, float %dh.future) %cell.tanh = call float @recipe.tanh(float %cell)
%cell.tanh.square = call float @recipe.mul(float %cell.tanh, float %cell.tanh) %cell.tanh.derivative = call float @recipe.sub(float 1.0, float %cell.tanh.square)
%cell.chain.0 = call float @recipe.mul(float %dh, float %o) %cell.chain = call float @recipe.mul(float %cell.chain.0, float %cell.tanh.derivative)
%dc = call float @recipe.add(float %dc.future, float %cell.chain) %one.o = call float @recipe.sub(float 1.0, float %o) %do.0 = call float @recipe.mul(float %dh, float %cell.tanh)
%do.1 = call float @recipe.mul(float %do.0, float %o) %do = call float @recipe.mul(float %do.1, float %one.o) %one.i = call float @recipe.sub(float 1.0, float %i) %di.0 = call float @recipe.mul(float %dc, float %g)
%di.1 = call float @recipe.mul(float %di.0, float %i) %di = call float @recipe.mul(float %di.1, float %one.i) %one.f = call float @recipe.sub(float 1.0, float %f)
%df.0 = call float @recipe.mul(float %dc, float %cell.previous) %df.1 = call float @recipe.mul(float %df.0, float %f) %df = call float @recipe.mul(float %df.1, float %one.f)
%g.square = call float @recipe.mul(float %g, float %g) %one.g.square = call float @recipe.sub(float 1.0, float %g.square) %dg.0 = call float @recipe.mul(float %dc, float %i)
%dg = call float @recipe.mul(float %dg.0, float %one.g.square) %dc.previous = call float @recipe.mul(float %dc, float %f)
store float %dc.previous, ptr addrspace(1) %dc.ptr, align 4 %delta0.index = add i32 %delta.base, %index
%delta1.index = add i32 %delta0.index, %batch %delta2.index = add i32 %delta1.index, %batch
%delta3.index = add i32 %delta2.index, %batch
%delta0.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %delta0.index
%delta1.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %delta1.index
%delta2.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %delta2.index
%delta3.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %delta3.index
store float %di, ptr addrspace(1) %delta0.ptr, align 4 store float %df, ptr addrspace(1) %delta1.ptr, align 4
store float %do, ptr addrspace(1) %delta2.ptr, align 4 store float %dg, ptr addrspace(1) %delta3.ptr, align 4
...
%gate.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %delta.index
%gate.delta = load float, ptr addrspace(1) %gate.delta.ptr, align 4
...
%state.ptr = getelementptr inbounds float, ptr addrspace(1) %output, i32 %state.index.value
%state.loaded = load float, ptr addrspace(1) %state.ptr, align 4
%state.value = select i1 %previous.exists, float %state.loaded, float 0.0
...
%parameter.reset.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %parameter.reset.index
%parameter.reset = load float, ptr addrspace(1) %parameter.reset.ptr, align 4
%parameter.reset.state = call float @recipe.mul(float %parameter.reset, float %state.value)
%parameter.state = select i1 %gru.candidate, float %parameter.reset.state, float %state.value
%source.value = select i1 %state.weight, float %parameter.state, float 1.0
%contribution = call float @recipe.mul(float %source.value, float %gate.delta) %row.gradient.index = add i32 %row.gradient.start, %p
%row.gradient.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %row.gradient.index
%row.gradient.old = load float, ptr addrspace(1) %row.gradient.ptr, align 4
%row.gradient.new = call float @recipe.add(float %row.gradient.old, float %contribution)
store float %row.gradient.new, ptr addrspace(1) %row.gradient.ptr, align 4
...
%state.sum = phi float [ 0.0, %hidden.gradient.loop ], [ %state.sum.next, %hidden.gradient.sum.step ]
...
%state.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %state.delta.index
%state.weight.value = load float, ptr addrspace(1) %state.weight.ptr, align 4
%state.delta.value = load float, ptr addrspace(1) %state.delta.ptr, align 4
%state.product = call float @recipe.mul(float %state.weight.value, float %state.delta.value) %state.candidate = icmp eq i32 %state.gate, 2
...
%state.reset.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %state.reset.index
%state.reset = load float, ptr addrspace(1) %state.reset.ptr, align 4
%state.reset.product = call float @recipe.mul(float %state.product, float %state.reset)
%state.contribution = select i1 %state.gru.candidate, float %state.reset.product, float %state.product
%state.sum.next = call float @recipe.add(float %state.sum, float %state.contribution) %state.term.next = add nuw i32 %state.term, 1
br label %hidden.gradient.sum.loop hidden.gradient.store: %state.dh.index = add i32 %dh.start, %state.channel
%state.dh.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %state.dh.index
...
%state.direct.delta.ptr = getelementptr inbounds float, ptr addrspace(1) %delta, i32 %state.direct.index
%state.direct.z.ptr = getelementptr inbounds float, ptr addrspace(1) %context, i32 %state.direct.index
%state.direct.dy = load float, ptr addrspace(1) %state.direct.delta.ptr, align 4
%state.direct.future = load float, ptr addrspace(1) %state.dh.ptr, align 4
%state.direct.z = load float, ptr addrspace(1) %state.direct.z.ptr, align 4
%state.direct.dh = call float @recipe.add(float %state.direct.dy, float %state.direct.future)
%state.direct.raw = call float @recipe.mul(float %state.direct.z, float %state.direct.dh)
%state.direct = select i1 %gru, float %state.direct.raw, float 0.0
%state.total = call float @recipe.add(float %state.sum, float %state.direct)
store float %state.total, ptr addrspace(1) %state.dh.ptr, align 4 %state.channel.next = add nuw i32 %state.channel, 1
...
%projection.weights = getelementptr inbounds float, ptr addrspace(1) %weights, i32 %projection.weight.offset
%projection.delta.gate = mul i32 %projection.gate, %batch
%projection.delta.offset = add i32 %delta.base, %projection.delta.gate
%projection.delta = getelementptr inbounds float, ptr addrspace(1) %context, i32 %projection.delta.offset
...
invalid: call void @llvm.trap() br label %exit exit: ret void } attributes #0 = { nounwind } attributes #1 = { alwaysinline nounwind } attributes #3 = { noinline nounwind }
