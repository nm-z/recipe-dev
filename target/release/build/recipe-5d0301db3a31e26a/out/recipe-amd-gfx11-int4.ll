...
define internal float @recipe.decode(i8 %value) #1 { entry: %wide = zext i8 %value to i32 %masked = and i32 %wide, 15 %shifted = shl i32 %masked, 28 %signed = ashr i32 %shifted, 28 %result = sitofp i32 %signed to float ret float %result }
define internal i8 @recipe.encode(float %value) #1 { entry: %nan = fcmp uno float %value, %value %rounded = call float @llvm.roundeven.f32(float %value) %below = fcmp olt float %rounded, -8.0 %above = fcmp ogt float %rounded, 7.0 %lowered = select i1 %below, float -8.0, float %rounded %clamped = select i1 %above, float 7.0, float %lowered %finite = select i1 %nan, float 0.0, float %clamped %integer = fptosi float %finite to i32 %masked = and i32 %integer, 15 %result = trunc i32 %masked to i8 ret i8 %result }
...
declare void @llvm.trap() @contraction_tile_int4 = external addrspace(3) global [0 x i8], align 16
...
%ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %index
...
%target = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %index
...
%publish.target = getelementptr float, ptr addrspace(3) @contraction_tile_int4, i32 %publish.target.index
...
%fold.source = getelementptr float, ptr addrspace(3) @contraction_tile_int4, i32 %fold.source.index
...
%matrix.a.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.a.index
...
%matrix.b.first.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.b.first.index
...
%matrix.b.second.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.b.second.index
...
%matrix.b.third.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.b.third.index
...
%matrix.b.fourth.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.b.fourth.index
...
%maximum = phi i8 [ 8, %entry ], [ %maximum.next, %step ]
...
%left.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %left.index
...
%right.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %right.index
...
%delta.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %delta.index
...
%product.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %product.index
...
%probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %probability.index
store i8 %probability.value, ptr addrspace(3) %probability.ptr, align 1
%derivative.index = add i32 %derivative.shared, %pair.local
%derivative.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %derivative.index
...
%query.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %query.p
store i8 %query.value, ptr addrspace(3) %query.shared.ptr, align 1
%accumulator.index = add i32 %accumulator.base.shared, %query.p
%accumulator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %accumulator.index
...
%maximum.ptr.init = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %maximum.index.init
store i8 8, ptr addrspace(3) %maximum.ptr.init, align 1
%denominator.index.init = add i32 %denominator.base.shared, %statistics.q
%denominator.ptr.init = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %denominator.index.init
...
%key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %key.shared.index
...
%value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %value.shared.index
...
br label %score.store
score.store:
%score.value = phi i8 [ %score.scaled, %score.complete ], [ 8, %score.invalid ]
...
%score.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %score.shared.index
...
%maximum.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %maximum.index
...
%maximum.score.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %maximum.score.index
...
%denominator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %denominator.index
...
%probability.score.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %probability.score.index
...
%rescale.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %rescale.index
...
%accumulate.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %accumulate.index
...
%accumulate.rescale.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %accumulate.rescale.index
...
%accumulate.probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %accumulate.probability.index
...
%accumulate.value.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %accumulate.value.index
...
%output.accumulator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %output.accumulator.index
...
%output.denominator.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %output.denominator.index
...
%output.maximum.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %output.maximum.index
...
%stage.scalar.ptr.shared = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %stage.scalar.index.shared
...
%matrix.q.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.q.index
...
%matrix.k.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.k.index
...
%matrix.score = select i1 %matrix.causal, i8 %matrix.score.scaled, i8 8
...
%matrix.p.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.p.index
...
%maximum = phi i8 [ 8, %attention.forward.matrix.softmax.loop ], [ %maximum.next, %attention.forward.matrix.maximum.step ]
...
%normalize.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %normalize.index
...
%d.do.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %d.do.index
...
%d.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %d.index
...
%matrix.do.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.do.index
%matrix.do.fragment = load <16 x i8>, ptr addrspace(3) %matrix.do.ptr, align 2
%matrix.v.index = add i32 %v.base, %matrix.k.local
%matrix.v.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.v.index
...
%matrix.d.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.d.index
...
%matrix.ds.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %matrix.ds.index
...
%dq.query.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.query.p
...
%dq.delta.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.delta.shared.index
...
%dq.gradient.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.gradient.shared.index
...
%dq.key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.key.shared.index
...
%dq.value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.value.shared.index
...
%dq.accumulate.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.accumulate.gradient.index
...
%dq.accumulate.pair.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.accumulate.pair.index
...
%dq.accumulate.key.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.accumulate.key.index
...
%dq.store.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dq.store.shared.index
...
%dkv.key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.key.p
...
%dkv.value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.value.shared.index
...
%dkv.key.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.key.gradient.index
...
%dkv.value.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.value.gradient.index
...
%dkv.query.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.query.shared.index
...
%dkv.delta.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.delta.shared.index
...
%dkv.accumulate.key.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.accumulate.key.gradient.index
...
%dkv.accumulate.value.gradient.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.accumulate.value.gradient.index
...
%dkv.accumulate.probability.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.accumulate.probability.index
...
%dkv.accumulate.derivative.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.accumulate.derivative.index
...
%dkv.accumulate.query.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.accumulate.query.index
...
%dkv.accumulate.delta.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.accumulate.delta.index
...
%dkv.store.key.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.store.key.shared.index
...
%dkv.store.value.shared.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %dkv.store.value.shared.index
...
%gradient.load.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %gradient.load.index store i8 %gradient.load.value, ptr addrspace(3) %gradient.load.ptr, align 1
br label %gradient.load.advance
...
%previous.load.ptr = getelementptr [0 x i8], ptr addrspace(3) @contraction_tile_int4, i32 0, i32 %previous.load.index store i8 %previous.load.value, ptr addrspace(3) %previous.load.ptr, align 1
br label %previous.load.advance
